...
CkSsh_setProgressInfo(HCkSsh cHandle, void (*fnProgressInfo)(const char *name, const char *value));
...
CK_C_VISIBLE_PUBLIC void
CkSsh_setProgressInfo2(HCkSsh cHandle, void (*fnProgressInfo2)(const char *name, const char *value, void *pContext));

CK_C_VISIBLE_PUBLIC void
CkSsh_setTaskCompleted2(HCkSsh cHandle, void (*fnTaskCompleted2)(HCkTask hTask, void *pContext));
...
CkSsh_AuthenticatePwPk(HCkSsh cHandle, const char *username, const char *password, HCkSshKey privateKey);

CK_C_VISIBLE_PUBLIC HCkTask
CkSsh_AuthenticatePwPkAsync(HCkSsh cHandle, const char *username, const char *password, HCkSshKey privateKey);

CK_C_VISIBLE_PUBLIC BOOL CkSsh_AuthenticateSecPw(HCkSsh cHandle, HCkSecureString login, HCkSecureString password);

CK_C_VISIBLE_PUBLIC HCkTask
CkSsh_AuthenticateSecPwAsync(HCkSsh cHandle, HCkSecureString login, HCkSecureString password);

CK_C_VISIBLE_PUBLIC BOOL
CkSsh_AuthenticateSecPwPk(HCkSsh cHandle, HCkSecureString username, HCkSecureString password, HCkSshKey privateKey);

CK_C_VISIBLE_PUBLIC HCkTask
CkSsh_AuthenticateSecPwPkAsync(HCkSsh cHandle, HCkSecureString username, HCkSecureString password,
...
CK_C_VISIBLE_PUBLIC HCkTask
CkSsh_ChannelReadAndPoll2Async(HCkSsh cHandle, int channelNum, int pollTimeoutMs, int maxNumBytes);
...
CK_C_VISIBLE_PUBLIC BOOL
CkSsh_ChannelReceiveUntilMatch(HCkSsh cHandle, int channelNum, const char *matchPattern, const char *charset,
                               BOOL caseSensitive);

CK_C_VISIBLE_PUBLIC HCkTask
CkSsh_ChannelReceiveUntilMatchAsync(HCkSsh cHandle, int channelNum, const char *matchPattern, const char *charset,
                                    BOOL caseSensitive);

CK_C_VISIBLE_PUBLIC BOOL
CkSsh_ChannelReceiveUntilMatchN(HCkSsh cHandle, int channelNum, HCkStringArray matchPatterns, const char *charset,
                                BOOL caseSensitive);

CK_C_VISIBLE_PUBLIC HCkTask
CkSsh_ChannelReceiveUntilMatchNAsync(HCkSsh cHandle, int channelNum, HCkStringArray matchPatterns, const char *charset,
                                     BOOL caseSensitive);
...
CK_C_VISIBLE_PUBLIC BOOL
CkSsh_ChannelSendString(HCkSsh cHandle, int channelNum, const char *textData, const char *charset);

CK_C_VISIBLE_PUBLIC HCkTask
CkSsh_ChannelSendStringAsync(HCkSsh cHandle, int channelNum, const char *textData, const char *charset);
...
CK_C_VISIBLE_PUBLIC BOOL
CkSsh_GetReceivedStderrText(HCkSsh cHandle, int channelNum, const char *charset, HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkSsh_GetReceivedTextS(HCkSsh cHandle, int channelNum, const char *substr, const char *charset, HCkString outStr);

CK_C_VISIBLE_PUBLIC const char *
CkSsh_getReceivedTextS(HCkSsh cHandle, int channelNum, const char *substr, const char *charset);
...
CK_C_VISIBLE_PUBLIC HCkTask
CkSsh_OpenDirectTcpIpChannelAsync(HCkSsh cHandle, const char *targetHostname, int targetPort);
...
CK_C_VISIBLE_PUBLIC BOOL
CkSsh_SendReqPty(HCkSsh cHandle, int channelNum, const char *termType, int widthInChars, int heightInChars,
                 int widthInPixels, int heightInPixels);

CK_C_VISIBLE_PUBLIC HCkTask
CkSsh_SendReqPtyAsync(HCkSsh cHandle, int channelNum, const char *termType, int widthInChars, int heightInChars,
                      int widthInPixels, int heightInPixels);

CK_C_VISIBLE_PUBLIC BOOL CkSsh_SendReqSetEnv(HCkSsh cHandle, int channelNum, const char *name, const char *value);

CK_C_VISIBLE_PUBLIC HCkTask
CkSsh_SendReqSetEnvAsync(HCkSsh cHandle, int channelNum, const char *name, const char *value);
...
CK_C_VISIBLE_PUBLIC BOOL
CkSsh_SendReqWindowChange(HCkSsh cHandle, int channelNum, int widthInChars, int heightInRows, int pixWidth,
                          int pixHeight);

CK_C_VISIBLE_PUBLIC HCkTask
CkSsh_SendReqWindowChangeAsync(HCkSsh cHandle, int channelNum, int widthInChars, int heightInRows, int pixWidth,
                               int pixHeight);

CK_C_VISIBLE_PUBLIC BOOL
CkSsh_SendReqX11Forwarding(HCkSsh cHandle, int channelNum, BOOL singleConnection, const char *authProt,
                           const char *authCookie, int screenNum);

CK_C_VISIBLE_PUBLIC HCkTask
CkSsh_SendReqX11ForwardingAsync(HCkSsh cHandle, int channelNum, BOOL singleConnection, const char *authProt,
                                const char *authCookie, int screenNum);
