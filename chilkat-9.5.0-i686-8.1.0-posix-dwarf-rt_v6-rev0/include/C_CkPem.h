...
CkPem_setProgressInfo(HCkPem cHandle, void (*fnProgressInfo)(const char *name, const char *value));
...
CK_C_VISIBLE_PUBLIC void
CkPem_setProgressInfo2(HCkPem cHandle, void (*fnProgressInfo2)(const char *name, const char *value, void *pContext));

CK_C_VISIBLE_PUBLIC void
CkPem_setTaskCompleted2(HCkPem cHandle, void (*fnTaskCompleted2)(HCkTask hTask, void *pContext));
...
CkPem_AddItem(HCkPem cHandle, const char *itemType, const char *encoding, const char *itemData);
...
CK_C_VISIBLE_PUBLIC BOOL
CkPem_GetEncodedItem(HCkPem cHandle, const char *itemType, const char *itemSubType, const char *encoding, int index,
                     HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkPem_ToPemEx(HCkPem cHandle, BOOL extendedAttrs, BOOL noKeys, BOOL noCerts, BOOL noCaCerts, const char *encryptAlg,
              const char *password, HCkString outStr);
