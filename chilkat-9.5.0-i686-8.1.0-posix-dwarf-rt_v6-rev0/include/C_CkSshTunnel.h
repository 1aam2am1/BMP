...
CkSshTunnel_setProgressInfo(HCkSshTunnel cHandle, void (*fnProgressInfo)(const char *name, const char *value));
...
CK_C_VISIBLE_PUBLIC void
CkSshTunnel_setPercentDone2(HCkSshTunnel cHandle, BOOL (*fnPercentDone2)(int pctDone, void *pContext));

CK_C_VISIBLE_PUBLIC void CkSshTunnel_setProgressInfo2(HCkSshTunnel cHandle,
                                                      void (*fnProgressInfo2)(const char *name, const char *value,
                                                                              void *pContext));

CK_C_VISIBLE_PUBLIC void
CkSshTunnel_setTaskCompleted2(HCkSshTunnel cHandle, void (*fnTaskCompleted2)(HCkTask hTask, void *pContext));
...
CkSshTunnel_AuthenticatePkAsync(HCkSshTunnel cHandle, const char *username, HCkSshKey privateKey);

CK_C_VISIBLE_PUBLIC BOOL CkSshTunnel_AuthenticatePw(HCkSshTunnel cHandle, const char *login, const char *password);

CK_C_VISIBLE_PUBLIC HCkTask
CkSshTunnel_AuthenticatePwAsync(HCkSshTunnel cHandle, const char *login, const char *password);

CK_C_VISIBLE_PUBLIC BOOL
CkSshTunnel_AuthenticatePwPk(HCkSshTunnel cHandle, const char *username, const char *password, HCkSshKey privateKey);

CK_C_VISIBLE_PUBLIC HCkTask
CkSshTunnel_AuthenticatePwPkAsync(HCkSshTunnel cHandle, const char *username, const char *password,
                                  HCkSshKey privateKey);

CK_C_VISIBLE_PUBLIC BOOL
CkSshTunnel_AuthenticateSecPw(HCkSshTunnel cHandle, HCkSecureString login, HCkSecureString password);

CK_C_VISIBLE_PUBLIC HCkTask
CkSshTunnel_AuthenticateSecPwAsync(HCkSshTunnel cHandle, HCkSecureString login, HCkSecureString password);

CK_C_VISIBLE_PUBLIC BOOL
CkSshTunnel_AuthenticateSecPwPk(HCkSshTunnel cHandle, HCkSecureString username, HCkSecureString password,
                                HCkSshKey privateKey);

CK_C_VISIBLE_PUBLIC HCkTask
CkSshTunnel_AuthenticateSecPwPkAsync(HCkSshTunnel cHandle, HCkSecureString username, HCkSecureString password,
                                     HCkSshKey privateKey);
...
CK_C_VISIBLE_PUBLIC BOOL
CkSshTunnel_ConnectThroughSsh(HCkSshTunnel cHandle, HCkSsh ssh, const char *hostname, int port);

CK_C_VISIBLE_PUBLIC HCkTask
CkSshTunnel_ConnectThroughSshAsync(HCkSshTunnel cHandle, HCkSsh ssh, const char *hostname, int port);
