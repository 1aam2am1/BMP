...
public:
    ...
    //
    bool CanonicalizeFragment(const wchar_t *xml, const wchar_t *fragmentId, const wchar_t *version,
                              const wchar_t *prefixList, bool withComments, CkString &outStr);
    ...
    // false, then XML comments are excluded from the output.
    //
    const wchar_t *canonicalizeFragment(const wchar_t *xml, const wchar_t *fragmentId, const wchar_t *version,
                                        const wchar_t *prefixList, bool withComments);
