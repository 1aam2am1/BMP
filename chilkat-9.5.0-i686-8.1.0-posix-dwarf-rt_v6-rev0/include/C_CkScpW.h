...
CkScpW_setProgressInfo(HCkScpW cHandle, void (*fnProgressInfo)(const wchar_t *name, const wchar_t *value));
...
CkScpW_DownloadBinaryEncoded(HCkScpW cHandle, const wchar_t *remotePath, const wchar_t *encoding, HCkString outStr);

CK_C_VISIBLE_PUBLIC const wchar_t *
CkScpW_downloadBinaryEncoded(HCkScpW cHandle, const wchar_t *remotePath, const wchar_t *encoding);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkScpW_DownloadBinaryEncodedAsync(HCkScpW cHandle, const wchar_t *remotePath, const wchar_t *encoding);

CK_C_VISIBLE_PUBLIC BOOL CkScpW_DownloadFile(HCkScpW cHandle, const wchar_t *remotePath, const wchar_t *localPath);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkScpW_DownloadFileAsync(HCkScpW cHandle, const wchar_t *remotePath, const wchar_t *localPath);

CK_C_VISIBLE_PUBLIC BOOL
CkScpW_DownloadString(HCkScpW cHandle, const wchar_t *remotePath, const wchar_t *charset, HCkString outStr);

CK_C_VISIBLE_PUBLIC const wchar_t *
CkScpW_downloadString(HCkScpW cHandle, const wchar_t *remotePath, const wchar_t *charset);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkScpW_DownloadStringAsync(HCkScpW cHandle, const wchar_t *remotePath, const wchar_t *charset);
...
CK_C_VISIBLE_PUBLIC BOOL
CkScpW_SyncTreeDownload(HCkScpW cHandle, const wchar_t *remoteRoot, const wchar_t *localRoot, int mode, BOOL bRecurse);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkScpW_SyncTreeDownloadAsync(HCkScpW cHandle, const wchar_t *remoteRoot, const wchar_t *localRoot, int mode,
                             BOOL bRecurse);

CK_C_VISIBLE_PUBLIC BOOL
CkScpW_SyncTreeUpload(HCkScpW cHandle, const wchar_t *localBaseDir, const wchar_t *remoteBaseDir, int mode,
                      BOOL bRecurse);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkScpW_SyncTreeUploadAsync(HCkScpW cHandle, const wchar_t *localBaseDir, const wchar_t *remoteBaseDir, int mode,
                           BOOL bRecurse);
...
CK_C_VISIBLE_PUBLIC BOOL
CkScpW_UploadBinaryEncoded(HCkScpW cHandle, const wchar_t *remotePath, const wchar_t *encodedData,
                           const wchar_t *encoding);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkScpW_UploadBinaryEncodedAsync(HCkScpW cHandle, const wchar_t *remotePath, const wchar_t *encodedData,
                                const wchar_t *encoding);

CK_C_VISIBLE_PUBLIC BOOL CkScpW_UploadFile(HCkScpW cHandle, const wchar_t *localPath, const wchar_t *remotePath);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkScpW_UploadFileAsync(HCkScpW cHandle, const wchar_t *localPath, const wchar_t *remotePath);

CK_C_VISIBLE_PUBLIC BOOL
CkScpW_UploadString(HCkScpW cHandle, const wchar_t *remotePath, const wchar_t *textData, const wchar_t *charset);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkScpW_UploadStringAsync(HCkScpW cHandle, const wchar_t *remotePath, const wchar_t *textData, const wchar_t *charset);
