...
CK_C_VISIBLE_PUBLIC void CkUnixCompressW_setProgressInfo(HCkUnixCompressW cHandle,
                                                         void (*fnProgressInfo)(const wchar_t *name,
                                                                                const wchar_t *value));

CK_C_VISIBLE_PUBLIC void
CkUnixCompressW_setTaskCompleted(HCkUnixCompressW cHandle, void (*fnTaskCompleted)(HCkTaskW hTask));
...
CkUnixCompressW_CompressFile(HCkUnixCompressW cHandle, const wchar_t *inFilename, const wchar_t *destPath);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkUnixCompressW_CompressFileAsync(HCkUnixCompressW cHandle, const wchar_t *inFilename, const wchar_t *destPath);

CK_C_VISIBLE_PUBLIC BOOL
CkUnixCompressW_CompressFileToMem(HCkUnixCompressW cHandle, const wchar_t *inFilename, HCkByteData outData);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkUnixCompressW_CompressFileToMemAsync(HCkUnixCompressW cHandle, const wchar_t *inFilename);

CK_C_VISIBLE_PUBLIC BOOL
CkUnixCompressW_CompressMemory(HCkUnixCompressW cHandle, HCkByteData inData, HCkByteData outData);

CK_C_VISIBLE_PUBLIC BOOL
CkUnixCompressW_CompressMemToFile(HCkUnixCompressW cHandle, HCkByteData inData, const wchar_t *destPath);

CK_C_VISIBLE_PUBLIC BOOL
CkUnixCompressW_CompressString(HCkUnixCompressW cHandle, const wchar_t *inStr, const wchar_t *charset,
                               HCkByteData outBytes);

CK_C_VISIBLE_PUBLIC BOOL
CkUnixCompressW_CompressStringToFile(HCkUnixCompressW cHandle, const wchar_t *inStr, const wchar_t *charset,
...
CK_C_VISIBLE_PUBLIC BOOL
CkUnixCompressW_UncompressFile(HCkUnixCompressW cHandle, const wchar_t *inFilename, const wchar_t *destPath);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkUnixCompressW_UncompressFileAsync(HCkUnixCompressW cHandle, const wchar_t *inFilename, const wchar_t *destPath);

CK_C_VISIBLE_PUBLIC BOOL
CkUnixCompressW_UncompressFileToMem(HCkUnixCompressW cHandle, const wchar_t *inFilename, HCkByteData outData);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkUnixCompressW_UncompressFileToMemAsync(HCkUnixCompressW cHandle, const wchar_t *inFilename);

CK_C_VISIBLE_PUBLIC BOOL
CkUnixCompressW_UncompressFileToString(HCkUnixCompressW cHandle, const wchar_t *zFilename, const wchar_t *charset,
                                       HCkString outStr);
...
CK_C_VISIBLE_PUBLIC HCkTaskW
CkUnixCompressW_UncompressFileToStringAsync(HCkUnixCompressW cHandle, const wchar_t *zFilename, const wchar_t *charset);

CK_C_VISIBLE_PUBLIC BOOL
CkUnixCompressW_UncompressMemory(HCkUnixCompressW cHandle, HCkByteData inData, HCkByteData outData);

CK_C_VISIBLE_PUBLIC BOOL
CkUnixCompressW_UncompressMemToFile(HCkUnixCompressW cHandle, HCkByteData inData, const wchar_t *destPath);

CK_C_VISIBLE_PUBLIC BOOL
CkUnixCompressW_UncompressString(HCkUnixCompressW cHandle, HCkByteData inCompressedData, const wchar_t *charset,
                                 HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkUnixCompressW_UnTarZ(HCkUnixCompressW cHandle, const wchar_t *zFilename, const wchar_t *destDir, BOOL bNoAbsolute);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkUnixCompressW_UnTarZAsync(HCkUnixCompressW cHandle, const wchar_t *zFilename, const wchar_t *destDir,
                            BOOL bNoAbsolute);
