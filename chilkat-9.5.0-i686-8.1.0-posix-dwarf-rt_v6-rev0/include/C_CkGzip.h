...
CkGzip_setProgressInfo(HCkGzip cHandle, void (*fnProgressInfo)(const char *name, const char *value));
...
CK_C_VISIBLE_PUBLIC void
CkGzip_setProgressInfo2(HCkGzip cHandle, void (*fnProgressInfo2)(const char *name, const char *value, void *pContext));

CK_C_VISIBLE_PUBLIC void
CkGzip_setTaskCompleted2(HCkGzip cHandle, void (*fnTaskCompleted2)(HCkTask hTask, void *pContext));
...
CkGzip_CompressFile2(HCkGzip cHandle, const char *inFilename, const char *embeddedFilename, const char *destPath);

CK_C_VISIBLE_PUBLIC HCkTask
CkGzip_CompressFile2Async(HCkGzip cHandle, const char *inFilename, const char *embeddedFilename, const char *destPath);
...
CK_C_VISIBLE_PUBLIC BOOL
CkGzip_CompressString(HCkGzip cHandle, const char *inStr, const char *destCharset, HCkByteData outBytes);

CK_C_VISIBLE_PUBLIC HCkTask CkGzip_CompressStringAsync(HCkGzip cHandle, const char *inStr, const char *destCharset);

CK_C_VISIBLE_PUBLIC BOOL
CkGzip_CompressStringENC(HCkGzip cHandle, const char *inStr, const char *charset, const char *encoding,
                         HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkGzip_CompressStringToFile(HCkGzip cHandle, const char *inStr, const char *destCharset, const char *destPath);

CK_C_VISIBLE_PUBLIC HCkTask
CkGzip_CompressStringToFileAsync(HCkGzip cHandle, const char *inStr, const char *destCharset, const char *destPath);

CK_C_VISIBLE_PUBLIC BOOL
CkGzip_Decode(HCkGzip cHandle, const char *encodedStr, const char *encoding, HCkByteData outBytes);

CK_C_VISIBLE_PUBLIC BOOL
CkGzip_DeflateStringENC(HCkGzip cHandle, const char *inString, const char *charsetName, const char *outputEncoding,
                        HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL CkGzip_InflateStringENC(HCkGzip cHandle, const char *inString, const char *convertFromCharset,
                                                 const char *inputEncoding, HCkString outStr);

CK_C_VISIBLE_PUBLIC const char *
CkGzip_inflateStringENC(HCkGzip cHandle, const char *inString, const char *convertFromCharset,
...
CK_C_VISIBLE_PUBLIC BOOL
CkGzip_UncompressFileToString(HCkGzip cHandle, const char *gzFilename, const char *charset, HCkString outStr);

CK_C_VISIBLE_PUBLIC const char *
CkGzip_uncompressFileToString(HCkGzip cHandle, const char *gzFilename, const char *charset);

CK_C_VISIBLE_PUBLIC HCkTask
CkGzip_UncompressFileToStringAsync(HCkGzip cHandle, const char *gzFilename, const char *charset);
...
CK_C_VISIBLE_PUBLIC BOOL
CkGzip_UncompressString(HCkGzip cHandle, HCkByteData inData, const char *inCharset, HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkGzip_UncompressStringENC(HCkGzip cHandle, const char *inStr, const char *charset, const char *encoding,
                           HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkGzip_UnTarGz(HCkGzip cHandle, const char *tgzFilename, const char *destDir, BOOL bNoAbsolute);

CK_C_VISIBLE_PUBLIC HCkTask
CkGzip_UnTarGzAsync(HCkGzip cHandle, const char *tgzFilename, const char *destDir, BOOL bNoAbsolute);
