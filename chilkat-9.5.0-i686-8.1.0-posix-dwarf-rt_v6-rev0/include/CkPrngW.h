...
public:
    ...
    bool RandomPassword(int length, bool mustIncludeDigit, bool upperAndLowercase, const wchar_t *mustHaveOneOf,
                        const wchar_t *excludeChars, CkString &outStr);
    ...
    // be to exclude chars that appear similar to others, such as i, l, 1, L, o, 0, O.
    const wchar_t *
    randomPassword(int length, bool mustIncludeDigit, bool upperAndLowercase, const wchar_t *mustHaveOneOf,
