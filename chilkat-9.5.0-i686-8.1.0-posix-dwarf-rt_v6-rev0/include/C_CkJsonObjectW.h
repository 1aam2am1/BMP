...
CkJsonObjectW_AddArrayCopyAt(HCkJsonObjectW cHandle, int index, const wchar_t *name, HCkJsonArrayW jarr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkJsonObjectW_AddNumberAt(HCkJsonObjectW cHandle, int index, const wchar_t *name, const wchar_t *numericStr);

CK_C_VISIBLE_PUBLIC BOOL CkJsonObjectW_AddObjectAt(HCkJsonObjectW cHandle, int index, const wchar_t *name);

CK_C_VISIBLE_PUBLIC BOOL
CkJsonObjectW_AddObjectCopyAt(HCkJsonObjectW cHandle, int index, const wchar_t *name, HCkJsonObjectW jsonObj);

CK_C_VISIBLE_PUBLIC BOOL
CkJsonObjectW_AddStringAt(HCkJsonObjectW cHandle, int index, const wchar_t *name, const wchar_t *value);
...
CK_C_VISIBLE_PUBLIC BOOL
CkJsonObjectW_AppendObjectCopy(HCkJsonObjectW cHandle, const wchar_t *name, HCkJsonObjectW jsonObj);

CK_C_VISIBLE_PUBLIC BOOL CkJsonObjectW_AppendString(HCkJsonObjectW cHandle, const wchar_t *name, const wchar_t *value);

CK_C_VISIBLE_PUBLIC BOOL
CkJsonObjectW_AppendStringArray(HCkJsonObjectW cHandle, const wchar_t *name, HCkStringTableW values);
...
CK_C_VISIBLE_PUBLIC BOOL
CkJsonObjectW_BytesOf(HCkJsonObjectW cHandle, const wchar_t *jsonPath, const wchar_t *encoding, HCkBinDataW bd);
...
CK_C_VISIBLE_PUBLIC BOOL
CkJsonObjectW_EmitWithSubs(HCkJsonObjectW cHandle, HCkHashtableW subs, BOOL omitEmpty, HCkString outStr);

CK_C_VISIBLE_PUBLIC const wchar_t *
CkJsonObjectW_emitWithSubs(HCkJsonObjectW cHandle, HCkHashtableW subs, BOOL omitEmpty);
...
CkJsonObjectW_FindRecord(HCkJsonObjectW cHandle, const wchar_t *arrayPath, const wchar_t *relPath, const wchar_t *value,
                         BOOL caseSensitive);

CK_C_VISIBLE_PUBLIC BOOL
CkJsonObjectW_FindRecordString(HCkJsonObjectW cHandle, const wchar_t *arrayPath, const wchar_t *relPath,
                               const wchar_t *value, BOOL caseSensitive, const wchar_t *retRelPath, HCkString outStr);

CK_C_VISIBLE_PUBLIC const wchar_t *
CkJsonObjectW_findRecordString(HCkJsonObjectW cHandle, const wchar_t *arrayPath, const wchar_t *relPath,
                               const wchar_t *value, BOOL caseSensitive, const wchar_t *retRelPath);

CK_C_VISIBLE_PUBLIC BOOL
CkJsonObjectW_FirebaseApplyEvent(HCkJsonObjectW cHandle, const wchar_t *name, const wchar_t *data);

CK_C_VISIBLE_PUBLIC BOOL
CkJsonObjectW_FirebasePatch(HCkJsonObjectW cHandle, const wchar_t *jsonPath, const wchar_t *jsonData);

CK_C_VISIBLE_PUBLIC BOOL
CkJsonObjectW_FirebasePut(HCkJsonObjectW cHandle, const wchar_t *jsonPath, const wchar_t *value);
...
CK_C_VISIBLE_PUBLIC BOOL
CkJsonObjectW_SetNumberOf(HCkJsonObjectW cHandle, const wchar_t *jsonPath, const wchar_t *value);

CK_C_VISIBLE_PUBLIC BOOL CkJsonObjectW_SetStringAt(HCkJsonObjectW cHandle, int index, const wchar_t *value);

CK_C_VISIBLE_PUBLIC BOOL
CkJsonObjectW_SetStringOf(HCkJsonObjectW cHandle, const wchar_t *jsonPath, const wchar_t *value);
...
CK_C_VISIBLE_PUBLIC BOOL
CkJsonObjectW_StringOfSb(HCkJsonObjectW cHandle, const wchar_t *jsonPath, HCkStringBuilderW sb);
...
CK_C_VISIBLE_PUBLIC BOOL
CkJsonObjectW_UpdateBd(HCkJsonObjectW cHandle, const wchar_t *jsonPath, const wchar_t *encoding, HCkBinDataW bd);
...
CK_C_VISIBLE_PUBLIC BOOL
CkJsonObjectW_UpdateNumber(HCkJsonObjectW cHandle, const wchar_t *jsonPath, const wchar_t *numericStr);

CK_C_VISIBLE_PUBLIC BOOL CkJsonObjectW_UpdateSb(HCkJsonObjectW cHandle, const wchar_t *jsonPath, HCkStringBuilderW sb);

CK_C_VISIBLE_PUBLIC BOOL
CkJsonObjectW_UpdateString(HCkJsonObjectW cHandle, const wchar_t *jsonPath, const wchar_t *value);
