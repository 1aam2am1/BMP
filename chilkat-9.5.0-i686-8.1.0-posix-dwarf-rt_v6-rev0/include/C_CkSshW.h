...
CkSshW_setProgressInfo(HCkSshW cHandle, void (*fnProgressInfo)(const wchar_t *name, const wchar_t *value));
...
CkSshW_AuthenticatePkAsync(HCkSshW cHandle, const wchar_t *username, HCkSshKeyW privateKey);
...
CkSshW_AuthenticatePwPk(HCkSshW cHandle, const wchar_t *username, const wchar_t *password, HCkSshKeyW privateKey);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkSshW_AuthenticatePwPkAsync(HCkSshW cHandle, const wchar_t *username, const wchar_t *password, HCkSshKeyW privateKey);

CK_C_VISIBLE_PUBLIC BOOL CkSshW_AuthenticateSecPw(HCkSshW cHandle, HCkSecureStringW login, HCkSecureStringW password);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkSshW_AuthenticateSecPwAsync(HCkSshW cHandle, HCkSecureStringW login, HCkSecureStringW password);

CK_C_VISIBLE_PUBLIC BOOL
CkSshW_AuthenticateSecPwPk(HCkSshW cHandle, HCkSecureStringW username, HCkSecureStringW password,
                           HCkSshKeyW privateKey);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkSshW_AuthenticateSecPwPkAsync(HCkSshW cHandle, HCkSecureStringW username, HCkSecureStringW password,
                                HCkSshKeyW privateKey);
...
CK_C_VISIBLE_PUBLIC HCkTaskW
CkSshW_ChannelReadAndPoll2Async(HCkSshW cHandle, int channelNum, int pollTimeoutMs, int maxNumBytes);
...
CK_C_VISIBLE_PUBLIC BOOL
CkSshW_ChannelReceiveUntilMatch(HCkSshW cHandle, int channelNum, const wchar_t *matchPattern, const wchar_t *charset,
                                BOOL caseSensitive);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkSshW_ChannelReceiveUntilMatchAsync(HCkSshW cHandle, int channelNum, const wchar_t *matchPattern,
                                     const wchar_t *charset, BOOL caseSensitive);

CK_C_VISIBLE_PUBLIC BOOL
CkSshW_ChannelReceiveUntilMatchN(HCkSshW cHandle, int channelNum, HCkStringArrayW matchPatterns, const wchar_t *charset,
                                 BOOL caseSensitive);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkSshW_ChannelReceiveUntilMatchNAsync(HCkSshW cHandle, int channelNum, HCkStringArrayW matchPatterns,
                                      const wchar_t *charset, BOOL caseSensitive);
...
CK_C_VISIBLE_PUBLIC BOOL
CkSshW_ChannelSendString(HCkSshW cHandle, int channelNum, const wchar_t *textData, const wchar_t *charset);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkSshW_ChannelSendStringAsync(HCkSshW cHandle, int channelNum, const wchar_t *textData, const wchar_t *charset);
...
CK_C_VISIBLE_PUBLIC HCkTaskW
CkSshW_ConnectThroughSshAsync(HCkSshW cHandle, HCkSshW ssh, const wchar_t *hostname, int port);
...
CK_C_VISIBLE_PUBLIC BOOL
CkSshW_GetReceivedDataN(HCkSshW cHandle, int channelNum, int maxNumBytes, HCkByteData outBytes);
...
CK_C_VISIBLE_PUBLIC BOOL
CkSshW_GetReceivedStderrText(HCkSshW cHandle, int channelNum, const wchar_t *charset, HCkString outStr);

CK_C_VISIBLE_PUBLIC const wchar_t *
CkSshW_getReceivedStderrText(HCkSshW cHandle, int channelNum, const wchar_t *charset);

CK_C_VISIBLE_PUBLIC BOOL
CkSshW_GetReceivedText(HCkSshW cHandle, int channelNum, const wchar_t *charset, HCkString outStr);

CK_C_VISIBLE_PUBLIC const wchar_t *CkSshW_getReceivedText(HCkSshW cHandle, int channelNum, const wchar_t *charset);

CK_C_VISIBLE_PUBLIC BOOL
CkSshW_GetReceivedTextS(HCkSshW cHandle, int channelNum, const wchar_t *substr, const wchar_t *charset,
                        HCkString outStr);
...
CK_C_VISIBLE_PUBLIC HCkTaskW
CkSshW_OpenDirectTcpIpChannelAsync(HCkSshW cHandle, const wchar_t *targetHostname, int targetPort);
...
CK_C_VISIBLE_PUBLIC BOOL
CkSshW_PeekReceivedText(HCkSshW cHandle, int channelNum, const wchar_t *charset, HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkSshW_QuickCommand(HCkSshW cHandle, const wchar_t *command, const wchar_t *charset, HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkSshW_SendReqPty(HCkSshW cHandle, int channelNum, const wchar_t *termType, int widthInChars, int heightInChars,
                  int widthInPixels, int heightInPixels);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkSshW_SendReqPtyAsync(HCkSshW cHandle, int channelNum, const wchar_t *termType, int widthInChars, int heightInChars,
                       int widthInPixels, int heightInPixels);

CK_C_VISIBLE_PUBLIC BOOL
CkSshW_SendReqSetEnv(HCkSshW cHandle, int channelNum, const wchar_t *name, const wchar_t *value);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkSshW_SendReqSetEnvAsync(HCkSshW cHandle, int channelNum, const wchar_t *name, const wchar_t *value);
...
CK_C_VISIBLE_PUBLIC HCkTaskW
CkSshW_SendReqSubsystemAsync(HCkSshW cHandle, int channelNum, const wchar_t *subsystemName);

CK_C_VISIBLE_PUBLIC BOOL
CkSshW_SendReqWindowChange(HCkSshW cHandle, int channelNum, int widthInChars, int heightInRows, int pixWidth,
                           int pixHeight);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkSshW_SendReqWindowChangeAsync(HCkSshW cHandle, int channelNum, int widthInChars, int heightInRows, int pixWidth,
                                int pixHeight);

CK_C_VISIBLE_PUBLIC BOOL
CkSshW_SendReqX11Forwarding(HCkSshW cHandle, int channelNum, BOOL singleConnection, const wchar_t *authProt,
                            const wchar_t *authCookie, int screenNum);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkSshW_SendReqX11ForwardingAsync(HCkSshW cHandle, int channelNum, BOOL singleConnection, const wchar_t *authProt,
                                 const wchar_t *authCookie, int screenNum);
