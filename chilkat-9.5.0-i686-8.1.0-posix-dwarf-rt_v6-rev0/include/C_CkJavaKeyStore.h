...
CkJavaKeyStore_AddPfx(HCkJavaKeyStore cHandle, HCkPfx pfx, const char *alias, const char *password);

CK_C_VISIBLE_PUBLIC BOOL
CkJavaKeyStore_AddPrivateKey(HCkJavaKeyStore cHandle, HCkCert cert, const char *alias, const char *password);

CK_C_VISIBLE_PUBLIC BOOL
CkJavaKeyStore_AddSecretKey(HCkJavaKeyStore cHandle, const char *encodedKeyBytes, const char *encoding,
                            const char *algorithm, const char *alias, const char *password);

CK_C_VISIBLE_PUBLIC BOOL CkJavaKeyStore_AddTrustedCert(HCkJavaKeyStore cHandle, HCkCert cert, const char *alias);

CK_C_VISIBLE_PUBLIC BOOL
CkJavaKeyStore_ChangePassword(HCkJavaKeyStore cHandle, int index, const char *oldPassword, const char *newPassword);

CK_C_VISIBLE_PUBLIC HCkCertChain
CkJavaKeyStore_FindCertChain(HCkJavaKeyStore cHandle, const char *alias, BOOL caseSensitive);

CK_C_VISIBLE_PUBLIC HCkPrivateKey
CkJavaKeyStore_FindPrivateKey(HCkJavaKeyStore cHandle, const char *password, const char *alias, BOOL caseSensitive);

CK_C_VISIBLE_PUBLIC HCkCert
CkJavaKeyStore_FindTrustedCert(HCkJavaKeyStore cHandle, const char *alias, BOOL caseSensitive);

CK_C_VISIBLE_PUBLIC HCkCertChain CkJavaKeyStore_GetCertChain(HCkJavaKeyStore cHandle, int index);

CK_C_VISIBLE_PUBLIC HCkPrivateKey
CkJavaKeyStore_GetPrivateKey(HCkJavaKeyStore cHandle, const char *password, int index);
...
CK_C_VISIBLE_PUBLIC BOOL
CkJavaKeyStore_GetSecretKey(HCkJavaKeyStore cHandle, const char *password, int index, const char *encoding,
                            HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkJavaKeyStore_LoadEncoded(HCkJavaKeyStore cHandle, const char *password, const char *jksEncData, const char *encoding);
...
CK_C_VISIBLE_PUBLIC BOOL
CkJavaKeyStore_ToEncodedString(HCkJavaKeyStore cHandle, const char *password, const char *encoding, HCkString outStr);

CK_C_VISIBLE_PUBLIC const char *
CkJavaKeyStore_toEncodedString(HCkJavaKeyStore cHandle, const char *password, const char *encoding);

CK_C_VISIBLE_PUBLIC BOOL CkJavaKeyStore_ToFile(HCkJavaKeyStore cHandle, const char *password, const char *path);

CK_C_VISIBLE_PUBLIC BOOL
CkJavaKeyStore_ToJwkSet(HCkJavaKeyStore cHandle, const char *password, HCkStringBuilder sbJwkSet);
