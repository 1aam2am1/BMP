...
CkEccW_GenEccKey2(HCkEccW cHandle, const wchar_t *curveName, const wchar_t *encodedK, const wchar_t *encoding);

CK_C_VISIBLE_PUBLIC BOOL CkEccW_SaveLastError(HCkEccW cHandle, const wchar_t *path);

CK_C_VISIBLE_PUBLIC BOOL
CkEccW_SharedSecretENC(HCkEccW cHandle, HCkPrivateKeyW privKey, HCkPublicKeyW pubKey, const wchar_t *encoding,
                       HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkEccW_SignHashENC(HCkEccW cHandle, const wchar_t *encodedHash, const wchar_t *encoding, HCkPrivateKeyW privkey,
                   HCkPrngW prng, HCkString outStr);
...
CkEccW_VerifyHashENC(HCkEccW cHandle, const wchar_t *encodedHash, const wchar_t *encodedSig, const wchar_t *encoding,
