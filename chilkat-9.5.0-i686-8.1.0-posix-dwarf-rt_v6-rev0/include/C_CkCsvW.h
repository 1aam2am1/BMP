...
CkCsvW_GetCellByName(HCkCsvW cHandle, int rowIndex, const wchar_t *columnName, HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkCsvW_RowMatches(HCkCsvW cHandle, int rowIndex, const wchar_t *matchPattern, BOOL caseSensitive);
...
CK_C_VISIBLE_PUBLIC BOOL
CkCsvW_SetCellByName(HCkCsvW cHandle, int rowIndex, const wchar_t *columnName, const wchar_t *contentStr);

CK_C_VISIBLE_PUBLIC BOOL CkCsvW_SetColumnName(HCkCsvW cHandle, int index, const wchar_t *columnName);

CK_C_VISIBLE_PUBLIC BOOL
CkCsvW_SortByColumn(HCkCsvW cHandle, const wchar_t *columnName, BOOL ascending, BOOL caseSensitive);
