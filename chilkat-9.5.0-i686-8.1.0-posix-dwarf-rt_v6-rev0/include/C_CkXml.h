...
CkXml_AccumulateTagContent(HCkXml cHandle, const char *tag, const char *skipTags, HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkXml_ChildContentMatches(HCkXml cHandle, const char *tagPath, const char *pattern, BOOL caseSensitive);
...
CK_C_VISIBLE_PUBLIC HCkXml
CkXml_ExtractChildByName(HCkXml cHandle, const char *tagPath, const char *attrName, const char *attrValue);
...
CK_C_VISIBLE_PUBLIC BOOL
CkXml_GetBinaryContent(HCkXml cHandle, BOOL unzipFlag, BOOL decryptFlag, const char *password, HCkByteData outData);
...
CK_C_VISIBLE_PUBLIC BOOL
CkXml_GetChildAttrValue(HCkXml cHandle, const char *tagPath, const char *attrName, HCkString outStr);
...
CK_C_VISIBLE_PUBLIC HCkXml
CkXml_GetChildWithAttr(HCkXml cHandle, const char *tagPath, const char *attrName, const char *attrValue);
...
CK_C_VISIBLE_PUBLIC BOOL
CkXml_SaveBinaryContent(HCkXml cHandle, const char *filename, BOOL unzipFlag, BOOL decryptFlag, const char *password);
...
CK_C_VISIBLE_PUBLIC HCkXml
CkXml_SearchForAttribute(HCkXml cHandle, HCkXml afterPtr, const char *tag, const char *attr, const char *valuePattern);

CK_C_VISIBLE_PUBLIC BOOL
CkXml_SearchForAttribute2(HCkXml cHandle, HCkXml afterPtr, const char *tag, const char *attr, const char *valuePattern);

CK_C_VISIBLE_PUBLIC HCkXml
CkXml_SearchForContent(HCkXml cHandle, HCkXml afterPtr, const char *tag, const char *contentPattern);

CK_C_VISIBLE_PUBLIC BOOL
CkXml_SearchForContent2(HCkXml cHandle, HCkXml afterPtr, const char *tag, const char *contentPattern);
...
CK_C_VISIBLE_PUBLIC BOOL
CkXml_SetBinaryContent(HCkXml cHandle, HCkByteData inData, BOOL zipFlag, BOOL encryptFlag, const char *password);

#if !defined(CHILKAT_MONO)

CK_C_VISIBLE_PUBLIC BOOL
CkXml_SetBinaryContent2(HCkXml cHandle, const void *pByteData, unsigned long szByteData, BOOL zipFlag, BOOL encryptFlag,
                        const char *password);

#endif

CK_C_VISIBLE_PUBLIC BOOL
CkXml_SetBinaryContentFromFile(HCkXml cHandle, const char *filename, BOOL zipFlag, BOOL encryptFlag,
                               const char *password);
...
CkXml_SortRecordsByAttribute(HCkXml cHandle, const char *sortTag, const char *attrName, BOOL ascending);
...
CK_C_VISIBLE_PUBLIC BOOL
CkXml_UpdateAttrAt(HCkXml cHandle, const char *tagPath, BOOL autoCreate, const char *attrName, const char *attrValue);
