...
CkAtom_setProgressInfo(HCkAtom cHandle, void (*fnProgressInfo)(const char *name, const char *value));
...
CK_C_VISIBLE_PUBLIC void
CkAtom_setProgressInfo2(HCkAtom cHandle, void (*fnProgressInfo2)(const char *name, const char *value, void *pContext));

CK_C_VISIBLE_PUBLIC void
CkAtom_setTaskCompleted2(HCkAtom cHandle, void (*fnTaskCompleted2)(HCkTask hTask, void *pContext));
...
CK_C_VISIBLE_PUBLIC void
CkAtom_AddLink(HCkAtom cHandle, const char *rel, const char *href, const char *title, const char *typ);

CK_C_VISIBLE_PUBLIC void
CkAtom_AddPerson(HCkAtom cHandle, const char *tag, const char *name, const char *uri, const char *email);
...
CkAtom_GetElementAttr(HCkAtom cHandle, const char *tag, int index, const char *attrName, HCkString outStr);

CK_C_VISIBLE_PUBLIC const char *
CkAtom_getElementAttr(HCkAtom cHandle, const char *tag, int index, const char *attrName);
...
CK_C_VISIBLE_PUBLIC BOOL
CkAtom_GetPersonInfo(HCkAtom cHandle, const char *tag, int index, const char *tag2, HCkString outStr);
...
CK_C_VISIBLE_PUBLIC void
CkAtom_SetElementAttr(HCkAtom cHandle, const char *tag, int index, const char *attrName, const char *attrValue);
...
CK_C_VISIBLE_PUBLIC void
CkAtom_UpdateElementDateStr(HCkAtom cHandle, const char *tag, int index, const char *dateTimeStr);
...
CK_C_VISIBLE_PUBLIC void
CkAtom_UpdatePerson(HCkAtom cHandle, const char *tag, int index, const char *name, const char *uri, const char *email);
