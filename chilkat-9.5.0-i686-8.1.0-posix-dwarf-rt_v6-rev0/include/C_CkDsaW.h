...
CkDsaW_SetEncodedSignature(HCkDsaW cHandle, const wchar_t *encoding, const wchar_t *encodedSig);

CK_C_VISIBLE_PUBLIC BOOL CkDsaW_SetEncodedSignatureRS(HCkDsaW cHandle, const wchar_t *encoding, const wchar_t *encodedR,
                                                      const wchar_t *encodedS);

CK_C_VISIBLE_PUBLIC BOOL
CkDsaW_SetKeyExplicit(HCkDsaW cHandle, int groupSizeInBytes, const wchar_t *pHex, const wchar_t *qHex,
                      const wchar_t *gHex, const wchar_t *xHex);

CK_C_VISIBLE_PUBLIC BOOL
CkDsaW_SetPubKeyExplicit(HCkDsaW cHandle, int groupSizeInBytes, const wchar_t *pHex, const wchar_t *qHex,
                         const wchar_t *gHex, const wchar_t *yHex);
