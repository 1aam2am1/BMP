...
CkUnixCompress_setProgressInfo(HCkUnixCompress cHandle, void (*fnProgressInfo)(const char *name, const char *value));

CK_C_VISIBLE_PUBLIC void
CkUnixCompress_setTaskCompleted(HCkUnixCompress cHandle, void (*fnTaskCompleted)(HCkTask hTask));

CK_C_VISIBLE_PUBLIC void CkUnixCompress_setAbortCheck2(HCkUnixCompress cHandle, BOOL (*fnAbortCheck2)(void *pContext));

CK_C_VISIBLE_PUBLIC void
CkUnixCompress_setPercentDone2(HCkUnixCompress cHandle, BOOL (*fnPercentDone2)(int pctDone, void *pContext));

CK_C_VISIBLE_PUBLIC void CkUnixCompress_setProgressInfo2(HCkUnixCompress cHandle,
                                                         void (*fnProgressInfo2)(const char *name, const char *value,
                                                                                 void *pContext));

CK_C_VISIBLE_PUBLIC void
CkUnixCompress_setTaskCompleted2(HCkUnixCompress cHandle, void (*fnTaskCompleted2)(HCkTask hTask, void *pContext));
...
CkUnixCompress_CompressFile(HCkUnixCompress cHandle, const char *inFilename, const char *destPath);

CK_C_VISIBLE_PUBLIC HCkTask
CkUnixCompress_CompressFileAsync(HCkUnixCompress cHandle, const char *inFilename, const char *destPath);

CK_C_VISIBLE_PUBLIC BOOL
CkUnixCompress_CompressFileToMem(HCkUnixCompress cHandle, const char *inFilename, HCkByteData outData);

CK_C_VISIBLE_PUBLIC HCkTask CkUnixCompress_CompressFileToMemAsync(HCkUnixCompress cHandle, const char *inFilename);

CK_C_VISIBLE_PUBLIC BOOL
CkUnixCompress_CompressMemory(HCkUnixCompress cHandle, HCkByteData inData, HCkByteData outData);

CK_C_VISIBLE_PUBLIC BOOL
CkUnixCompress_CompressMemToFile(HCkUnixCompress cHandle, HCkByteData inData, const char *destPath);

CK_C_VISIBLE_PUBLIC BOOL
CkUnixCompress_CompressString(HCkUnixCompress cHandle, const char *inStr, const char *charset, HCkByteData outBytes);

CK_C_VISIBLE_PUBLIC BOOL
CkUnixCompress_CompressStringToFile(HCkUnixCompress cHandle, const char *inStr, const char *charset,
                                    const char *destPath);
...
CK_C_VISIBLE_PUBLIC BOOL
CkUnixCompress_UncompressFile(HCkUnixCompress cHandle, const char *inFilename, const char *destPath);

CK_C_VISIBLE_PUBLIC HCkTask
CkUnixCompress_UncompressFileAsync(HCkUnixCompress cHandle, const char *inFilename, const char *destPath);

CK_C_VISIBLE_PUBLIC BOOL
CkUnixCompress_UncompressFileToMem(HCkUnixCompress cHandle, const char *inFilename, HCkByteData outData);

CK_C_VISIBLE_PUBLIC HCkTask CkUnixCompress_UncompressFileToMemAsync(HCkUnixCompress cHandle, const char *inFilename);

CK_C_VISIBLE_PUBLIC BOOL
CkUnixCompress_UncompressFileToString(HCkUnixCompress cHandle, const char *zFilename, const char *charset,
                                      HCkString outStr);
...
CK_C_VISIBLE_PUBLIC HCkTask
CkUnixCompress_UncompressFileToStringAsync(HCkUnixCompress cHandle, const char *zFilename, const char *charset);

CK_C_VISIBLE_PUBLIC BOOL
CkUnixCompress_UncompressMemory(HCkUnixCompress cHandle, HCkByteData inData, HCkByteData outData);

CK_C_VISIBLE_PUBLIC BOOL
CkUnixCompress_UncompressMemToFile(HCkUnixCompress cHandle, HCkByteData inData, const char *destPath);

CK_C_VISIBLE_PUBLIC BOOL
CkUnixCompress_UncompressString(HCkUnixCompress cHandle, HCkByteData inCompressedData, const char *charset,
                                HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkUnixCompress_UnTarZ(HCkUnixCompress cHandle, const char *zFilename, const char *destDir, BOOL bNoAbsolute);

CK_C_VISIBLE_PUBLIC HCkTask
CkUnixCompress_UnTarZAsync(HCkUnixCompress cHandle, const char *zFilename, const char *destDir, BOOL bNoAbsolute);
