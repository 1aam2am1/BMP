...
CkCertStoreW_CreateRegistryStore(HCkCertStoreW cHandle, const wchar_t *regRoot, const wchar_t *regPath);
...
CK_C_VISIBLE_PUBLIC BOOL
CkCertStoreW_LoadPfxData2(HCkCertStoreW cHandle, const void *pByteData, unsigned long szByteData,
                          const wchar_t *password);

#endif

CK_C_VISIBLE_PUBLIC BOOL
CkCertStoreW_LoadPfxFile(HCkCertStoreW cHandle, const wchar_t *pfxFilename, const wchar_t *password);
...
CK_C_VISIBLE_PUBLIC BOOL
CkCertStoreW_OpenRegistryStore(HCkCertStoreW cHandle, const wchar_t *regRoot, const wchar_t *regPath, BOOL readOnly);
...
CK_C_VISIBLE_PUBLIC BOOL
CkCertStoreW_OpenWindowsStore(HCkCertStoreW cHandle, const wchar_t *storeLocation, const wchar_t *storeName,
                              BOOL readOnly);
