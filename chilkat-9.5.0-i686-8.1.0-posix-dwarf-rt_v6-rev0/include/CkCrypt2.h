...
public:
    ...
    //     "sha256", "sha512", etc.
    bool Hotp(const char *secret, const char *secretEnc, const char *counterHex, int numDigits, int truncOffset,
              const char *hashAlg, CkString &outStr);
    ...
    //     hashAlg: Normally set to "sha1". Can be set to other hash algorithms such as
    //     "sha256", "sha512", etc.
    const char *hotp(const char *secret, const char *secretEnc, const char *counterHex, int numDigits, int truncOffset,
                     const char *hashAlg);
    ...
    // password.
    //
    bool Pbkdf1(const char *password, const char *charset, const char *hashAlg, const char *salt, int iterationCount,
                int outputKeyBitLen, const char *encoding, CkString &outStr);
    ...
    //
    const char *
    pbkdf1(const char *password, const char *charset, const char *hashAlg, const char *salt, int iterationCount,
           int outputKeyBitLen, const char *encoding);
    ...
    // password.
    //
    bool Pbkdf2(const char *password, const char *charset, const char *hashAlg, const char *salt, int iterationCount,
                int outputKeyBitLen, const char *encoding, CkString &outStr);
    ...
    //
    const char *
    pbkdf2(const char *password, const char *charset, const char *hashAlg, const char *salt, int iterationCount,
           int outputKeyBitLen, const char *encoding);
    ...
    //     hashAlg: Normally set to "sha1". Can be set to other hash algorithms such as
    //     "sha256", "sha512", etc.
    bool Totp(const char *secret, const char *secretEnc, const char *t0, const char *tNow, int tStep, int numDigits,
              int truncOffset, const char *hashAlg, CkString &outStr);
    ...
    //     "sha256", "sha512", etc.
    const char *
    totp(const char *secret, const char *secretEnc, const char *t0, const char *tNow, int tStep, int numDigits,
