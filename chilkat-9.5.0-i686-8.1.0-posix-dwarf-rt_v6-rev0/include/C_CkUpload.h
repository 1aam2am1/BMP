...
CkUpload_setProgressInfo(HCkUpload cHandle, void (*fnProgressInfo)(const char *name, const char *value));
...
CK_C_VISIBLE_PUBLIC void
CkUpload_setPercentDone2(HCkUpload cHandle, BOOL (*fnPercentDone2)(int pctDone, void *pContext));

CK_C_VISIBLE_PUBLIC void CkUpload_setProgressInfo2(HCkUpload cHandle,
                                                   void (*fnProgressInfo2)(const char *name, const char *value,
                                                                           void *pContext));

CK_C_VISIBLE_PUBLIC void
CkUpload_setTaskCompleted2(HCkUpload cHandle, void (*fnTaskCompleted2)(HCkTask hTask, void *pContext));
