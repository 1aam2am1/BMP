...
CkXmlDSig_CanonicalizeFragment(HCkXmlDSig cHandle, const char *xml, const char *fragmentId, const char *version,
                               const char *prefixList, BOOL withComments, HCkString outStr);

CK_C_VISIBLE_PUBLIC const char *
CkXmlDSig_canonicalizeFragment(HCkXmlDSig cHandle, const char *xml, const char *fragmentId, const char *version,
                               const char *prefixList, BOOL withComments);

CK_C_VISIBLE_PUBLIC BOOL
CkXmlDSig_CanonicalizeXml(HCkXmlDSig cHandle, const char *xml, const char *version, BOOL withComments,
                          HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkXmlDSig_SetRefDataSb(HCkXmlDSig cHandle, int index, HCkStringBuilder sb, const char *charset);
