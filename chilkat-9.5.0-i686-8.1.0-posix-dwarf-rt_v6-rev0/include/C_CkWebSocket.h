...
CkWebSocket_setProgressInfo(HCkWebSocket cHandle, void (*fnProgressInfo)(const char *name, const char *value));
...
CK_C_VISIBLE_PUBLIC void
CkWebSocket_setPercentDone2(HCkWebSocket cHandle, BOOL (*fnPercentDone2)(int pctDone, void *pContext));

CK_C_VISIBLE_PUBLIC void CkWebSocket_setProgressInfo2(HCkWebSocket cHandle,
                                                      void (*fnProgressInfo2)(const char *name, const char *value,
                                                                              void *pContext));

CK_C_VISIBLE_PUBLIC void
CkWebSocket_setTaskCompleted2(HCkWebSocket cHandle, void (*fnTaskCompleted2)(HCkTask hTask, void *pContext));
...
CkWebSocket_SendClose(HCkWebSocket cHandle, BOOL includeStatus, int statusCode, const char *reason);

CK_C_VISIBLE_PUBLIC HCkTask
CkWebSocket_SendCloseAsync(HCkWebSocket cHandle, BOOL includeStatus, int statusCode, const char *reason);
...
CK_C_VISIBLE_PUBLIC HCkTask
CkWebSocket_SendFrameSbAsync(HCkWebSocket cHandle, HCkStringBuilder sbToSend, BOOL finalFrame);
