...
CkImap_setProgressInfo(HCkImap cHandle, void (*fnProgressInfo)(const char *name, const char *value));
...
CK_C_VISIBLE_PUBLIC void
CkImap_setProgressInfo2(HCkImap cHandle, void (*fnProgressInfo2)(const char *name, const char *value, void *pContext));

CK_C_VISIBLE_PUBLIC void
CkImap_setTaskCompleted2(HCkImap cHandle, void (*fnTaskCompleted2)(HCkTask hTask, void *pContext));
...
CkImap_AppendMimeWithDate(HCkImap cHandle, const char *mailbox, const char *mimeText, SYSTEMTIME *internalDate);

CK_C_VISIBLE_PUBLIC BOOL
CkImap_AppendMimeWithDateStr(HCkImap cHandle, const char *mailbox, const char *mimeText, const char *internalDateStr);

CK_C_VISIBLE_PUBLIC HCkTask
CkImap_AppendMimeWithDateStrAsync(HCkImap cHandle, const char *mailbox, const char *mimeText,
                                  const char *internalDateStr);

CK_C_VISIBLE_PUBLIC BOOL
CkImap_AppendMimeWithFlags(HCkImap cHandle, const char *mailbox, const char *mimeText, BOOL seen, BOOL flagged,
                           BOOL answered, BOOL draft);

CK_C_VISIBLE_PUBLIC HCkTask
CkImap_AppendMimeWithFlagsAsync(HCkImap cHandle, const char *mailbox, const char *mimeText, BOOL seen, BOOL flagged,
                                BOOL answered, BOOL draft);

CK_C_VISIBLE_PUBLIC BOOL
CkImap_AppendMimeWithFlagsSb(HCkImap cHandle, const char *mailbox, HCkStringBuilder sbMime, BOOL seen, BOOL flagged,
                             BOOL answered, BOOL draft);

CK_C_VISIBLE_PUBLIC HCkTask
CkImap_AppendMimeWithFlagsSbAsync(HCkImap cHandle, const char *mailbox, HCkStringBuilder sbMime, BOOL seen,
...
CK_C_VISIBLE_PUBLIC HCkTask
CkImap_CopyMultipleAsync(HCkImap cHandle, HCkMessageSet messageSet, const char *copyToMailbox);

CK_C_VISIBLE_PUBLIC BOOL CkImap_CopySequence(HCkImap cHandle, int startSeqNum, int count, const char *copyToMailbox);

CK_C_VISIBLE_PUBLIC HCkTask
CkImap_CopySequenceAsync(HCkImap cHandle, int startSeqNum, int count, const char *copyToMailbox);
...
CK_C_VISIBLE_PUBLIC BOOL
CkImap_FetchAttachment(HCkImap cHandle, HCkEmail emailObject, int attachmentIndex, const char *saveToPath);

CK_C_VISIBLE_PUBLIC HCkTask
CkImap_FetchAttachmentAsync(HCkImap cHandle, HCkEmail emailObject, int attachmentIndex, const char *saveToPath);

CK_C_VISIBLE_PUBLIC BOOL
CkImap_FetchAttachmentBd(HCkImap cHandle, HCkEmail email, int attachmentIndex, HCkBinData binData);

CK_C_VISIBLE_PUBLIC HCkTask
CkImap_FetchAttachmentBdAsync(HCkImap cHandle, HCkEmail email, int attachmentIndex, HCkBinData binData);

CK_C_VISIBLE_PUBLIC BOOL
CkImap_FetchAttachmentBytes(HCkImap cHandle, HCkEmail email, int attachIndex, HCkByteData outBytes);

CK_C_VISIBLE_PUBLIC HCkTask CkImap_FetchAttachmentBytesAsync(HCkImap cHandle, HCkEmail email, int attachIndex);

CK_C_VISIBLE_PUBLIC BOOL
CkImap_FetchAttachmentSb(HCkImap cHandle, HCkEmail email, int attachmentIndex, const char *charset,
                         HCkStringBuilder sb);

CK_C_VISIBLE_PUBLIC HCkTask
CkImap_FetchAttachmentSbAsync(HCkImap cHandle, HCkEmail email, int attachmentIndex, const char *charset,
                              HCkStringBuilder sb);

CK_C_VISIBLE_PUBLIC BOOL
CkImap_FetchAttachmentString(HCkImap cHandle, HCkEmail emailObject, int attachmentIndex, const char *charset,
                             HCkString outStr);
...
CK_C_VISIBLE_PUBLIC HCkTask
CkImap_FetchAttachmentStringAsync(HCkImap cHandle, HCkEmail emailObject, int attachmentIndex, const char *charset);
...
CK_C_VISIBLE_PUBLIC HCkEmailBundle
CkImap_FetchChunk(HCkImap cHandle, int startSeqNum, int count, HCkMessageSet failedSet, HCkMessageSet fetchedSet);

CK_C_VISIBLE_PUBLIC HCkTask
CkImap_FetchChunkAsync(HCkImap cHandle, int startSeqNum, int count, HCkMessageSet failedSet, HCkMessageSet fetchedSet);
...
CK_C_VISIBLE_PUBLIC HCkTask
CkImap_FetchSingleAsMimeSbAsync(HCkImap cHandle, int msgId, BOOL bUid, HCkStringBuilder sbMime);
...
CK_C_VISIBLE_PUBLIC BOOL
CkImap_GetMailAttachFilename(HCkImap cHandle, HCkEmail email, int attachIndex, HCkString outStrFilename);
...
CK_C_VISIBLE_PUBLIC HCkMailboxes
CkImap_ListMailboxes(HCkImap cHandle, const char *reference, const char *wildcardedMailbox);

CK_C_VISIBLE_PUBLIC HCkTask
CkImap_ListMailboxesAsync(HCkImap cHandle, const char *reference, const char *wildcardedMailbox);

CK_C_VISIBLE_PUBLIC HCkMailboxes
CkImap_ListSubscribed(HCkImap cHandle, const char *reference, const char *wildcardedMailbox);

CK_C_VISIBLE_PUBLIC HCkTask
CkImap_ListSubscribedAsync(HCkImap cHandle, const char *reference, const char *wildcardedMailbox);
...
CK_C_VISIBLE_PUBLIC HCkTask
CkImap_LoginSecureAsync(HCkImap cHandle, HCkSecureString loginName, HCkSecureString password);
...
CK_C_VISIBLE_PUBLIC HCkTask
CkImap_SetFlagsAsync(HCkImap cHandle, HCkMessageSet messageSet, const char *flagName, int value);
...
CK_C_VISIBLE_PUBLIC HCkTask
CkImap_SetQuotaAsync(HCkImap cHandle, const char *quotaRoot, const char *resource, int quota);

CK_C_VISIBLE_PUBLIC BOOL CkImap_SetSslClientCert(HCkImap cHandle, HCkCert cert);

CK_C_VISIBLE_PUBLIC BOOL
CkImap_SetSslClientCertPem(HCkImap cHandle, const char *pemDataOrFilename, const char *pemPassword);

CK_C_VISIBLE_PUBLIC BOOL CkImap_SetSslClientCertPfx(HCkImap cHandle, const char *pfxFilename, const char *pfxPassword);

CK_C_VISIBLE_PUBLIC HCkMessageSet
CkImap_Sort(HCkImap cHandle, const char *sortCriteria, const char *charset, const char *searchCriteria, BOOL bUid);

CK_C_VISIBLE_PUBLIC HCkTask
CkImap_SortAsync(HCkImap cHandle, const char *sortCriteria, const char *charset, const char *searchCriteria, BOOL bUid);
...
CK_C_VISIBLE_PUBLIC HCkTask
CkImap_SshAuthenticatePwAsync(HCkImap cHandle, const char *sshLogin, const char *sshPassword);
...
CK_C_VISIBLE_PUBLIC HCkTask
CkImap_StoreFlagsAsync(HCkImap cHandle, int msgId, BOOL bUid, const char *flagNames, int value);
...
CkImap_ThreadCmd(HCkImap cHandle, const char *threadAlg, const char *charset, const char *searchCriteria, BOOL bUid);

CK_C_VISIBLE_PUBLIC HCkTask
CkImap_ThreadCmdAsync(HCkImap cHandle, const char *threadAlg, const char *charset, const char *searchCriteria,
                      BOOL bUid);
