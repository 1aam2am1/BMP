...
CkJavaKeyStoreW_AddPfx(HCkJavaKeyStoreW cHandle, HCkPfxW pfx, const wchar_t *alias, const wchar_t *password);

CK_C_VISIBLE_PUBLIC BOOL
CkJavaKeyStoreW_AddPrivateKey(HCkJavaKeyStoreW cHandle, HCkCertW cert, const wchar_t *alias, const wchar_t *password);

CK_C_VISIBLE_PUBLIC BOOL
CkJavaKeyStoreW_AddSecretKey(HCkJavaKeyStoreW cHandle, const wchar_t *encodedKeyBytes, const wchar_t *encoding,
                             const wchar_t *algorithm, const wchar_t *alias, const wchar_t *password);

CK_C_VISIBLE_PUBLIC BOOL CkJavaKeyStoreW_AddTrustedCert(HCkJavaKeyStoreW cHandle, HCkCertW cert, const wchar_t *alias);

CK_C_VISIBLE_PUBLIC BOOL CkJavaKeyStoreW_ChangePassword(HCkJavaKeyStoreW cHandle, int index, const wchar_t *oldPassword,
                                                        const wchar_t *newPassword);

CK_C_VISIBLE_PUBLIC HCkCertChainW
CkJavaKeyStoreW_FindCertChain(HCkJavaKeyStoreW cHandle, const wchar_t *alias, BOOL caseSensitive);

CK_C_VISIBLE_PUBLIC HCkPrivateKeyW
CkJavaKeyStoreW_FindPrivateKey(HCkJavaKeyStoreW cHandle, const wchar_t *password, const wchar_t *alias,
                               BOOL caseSensitive);

CK_C_VISIBLE_PUBLIC HCkCertW
CkJavaKeyStoreW_FindTrustedCert(HCkJavaKeyStoreW cHandle, const wchar_t *alias, BOOL caseSensitive);

CK_C_VISIBLE_PUBLIC HCkCertChainW CkJavaKeyStoreW_GetCertChain(HCkJavaKeyStoreW cHandle, int index);

CK_C_VISIBLE_PUBLIC HCkPrivateKeyW
CkJavaKeyStoreW_GetPrivateKey(HCkJavaKeyStoreW cHandle, const wchar_t *password, int index);
...
CK_C_VISIBLE_PUBLIC BOOL
CkJavaKeyStoreW_GetSecretKey(HCkJavaKeyStoreW cHandle, const wchar_t *password, int index, const wchar_t *encoding,
                             HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkJavaKeyStoreW_LoadBinary(HCkJavaKeyStoreW cHandle, const wchar_t *password, HCkByteData jksData);

CK_C_VISIBLE_PUBLIC BOOL
CkJavaKeyStoreW_LoadEncoded(HCkJavaKeyStoreW cHandle, const wchar_t *password, const wchar_t *jksEncData,
                            const wchar_t *encoding);

CK_C_VISIBLE_PUBLIC BOOL
CkJavaKeyStoreW_LoadFile(HCkJavaKeyStoreW cHandle, const wchar_t *password, const wchar_t *path);

CK_C_VISIBLE_PUBLIC BOOL
CkJavaKeyStoreW_LoadJwkSet(HCkJavaKeyStoreW cHandle, const wchar_t *password, HCkJsonObjectW jwkSet);
...
CK_C_VISIBLE_PUBLIC BOOL
CkJavaKeyStoreW_SetAlias(HCkJavaKeyStoreW cHandle, int entryType, int index, const wchar_t *alias);

CK_C_VISIBLE_PUBLIC BOOL
CkJavaKeyStoreW_ToBinary(HCkJavaKeyStoreW cHandle, const wchar_t *password, HCkByteData outBytes);

CK_C_VISIBLE_PUBLIC BOOL
CkJavaKeyStoreW_ToEncodedString(HCkJavaKeyStoreW cHandle, const wchar_t *password, const wchar_t *encoding,
                                HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkJavaKeyStoreW_ToJwkSet(HCkJavaKeyStoreW cHandle, const wchar_t *password, HCkStringBuilderW sbJwkSet);
