...
CkPfx_LoadPfxEncoded(HCkPfx cHandle, const char *encodedData, const char *encoding, const char *password);
...
CK_C_VISIBLE_PUBLIC BOOL
CkPfx_ToEncodedString(HCkPfx cHandle, const char *password, const char *encoding, HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkPfx_ToPemEx(HCkPfx cHandle, BOOL extendedAttrs, BOOL noKeys, BOOL noCerts, BOOL noCaCerts, const char *encryptAlg,
