...
public:
    ...
    //
    bool
    CreateTimestampRequest(const wchar_t *hashAlg, const wchar_t *hashVal, const wchar_t *reqPolicyOid, bool addNonce,
                           bool reqTsaCert, CkBinDataW &tmestampToken);
    ...
    //
    bool
    G_SvcOauthAccessToken(const wchar_t *iss, const wchar_t *scope, const wchar_t *subEmail, int numSec, CkCertW &cert,
                          CkString &outStr);
    ...
    // arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
    // The caller is responsible for deleting the object returned by this method.
    CkTaskW *G_SvcOauthAccessTokenAsync(const wchar_t *iss, const wchar_t *scope, const wchar_t *subEmail, int numSec,
                                        CkCertW &cert);
    ...
    // The caller is responsible for deleting the object returned by this method.
    CkHttpResponseW *
    PBinary(const wchar_t *verb, const wchar_t *url, CkByteData &byteData, const wchar_t *contentType, bool md5,
            bool gzip);
    ...
    // The caller is responsible for deleting the object returned by this method.
    CkTaskW *
    PBinaryAsync(const wchar_t *verb, const wchar_t *url, CkByteData &byteData, const wchar_t *contentType, bool md5,
                 bool gzip);

    // The same as PBinary, but the data to be uploaded is passed in data.
    // The caller is responsible for deleting the object returned by this method.
    CkHttpResponseW *
    PBinaryBd(const wchar_t *verb, const wchar_t *url, CkBinDataW &data, const wchar_t *contentType, bool md5,
              bool gzip);
    ...
    // The caller is responsible for deleting the object returned by this method.
    CkTaskW *
    PBinaryBdAsync(const wchar_t *verb, const wchar_t *url, CkBinDataW &data, const wchar_t *contentType, bool md5,
                   bool gzip);
    ...
    //
    bool PostBinary(const wchar_t *url, CkByteData &byteData, const wchar_t *contentType, bool md5, bool gzip,
                    CkString &outStr);
    ...
    //
    const wchar_t *
    postBinary(const wchar_t *url, CkByteData &byteData, const wchar_t *contentType, bool md5, bool gzip);
    ...
    // that the request data needs to be ungzipped when received (at the server).
    // The caller is responsible for deleting the object returned by this method.
    CkHttpResponseW *PText(const wchar_t *verb, const wchar_t *url, const wchar_t *textData, const wchar_t *charset,
                           const wchar_t *contentType, bool md5, bool gzip);

    // Creates an asynchronous task to call the PText method with the arguments
    // provided. (Async methods are available starting in Chilkat v9.5.0.52.)
    // The caller is responsible for deleting the object returned by this method.
    CkTaskW *PTextAsync(const wchar_t *verb, const wchar_t *url, const wchar_t *textData, const wchar_t *charset,
                        const wchar_t *contentType, bool md5, bool gzip);

    // The same as PText, but the data to be uploaded is passed in textData.
    // The caller is responsible for deleting the object returned by this method.
    CkHttpResponseW *
    PTextSb(const wchar_t *verb, const wchar_t *url, CkStringBuilderW &textData, const wchar_t *charset,
            const wchar_t *contentType, bool md5, bool gzip);

    // Creates an asynchronous task to call the PTextSb method with the arguments
    // provided. (Async methods are available starting in Chilkat v9.5.0.52.)
    // The caller is responsible for deleting the object returned by this method.
    CkTaskW *PTextSbAsync(const wchar_t *verb, const wchar_t *url, CkStringBuilderW &textData, const wchar_t *charset,
                          const wchar_t *contentType, bool md5, bool gzip);
    ...
    // response object).
    //
    bool PutBinary(const wchar_t *url, CkByteData &byteData, const wchar_t *contentType, bool md5, bool gzip,
                   CkString &outStr);
    ...
    //
    bool
    PutText(const wchar_t *url, const wchar_t *textData, const wchar_t *charset, const wchar_t *contentType, bool md5,
            bool gzip, CkString &outStr);
    ...
    // The caller is responsible for deleting the object returned by this method.
    CkTaskW *
    PutTextAsync(const wchar_t *url, const wchar_t *textData, const wchar_t *charset, const wchar_t *contentType,
                 bool md5, bool gzip);
    ...
    // remote text object.
    bool
    S3_DownloadString(const wchar_t *bucketPath, const wchar_t *objectName, const wchar_t *charset, CkString &outStr);
    ...
    //
    bool S3_GenerateUrlV4(bool useHttps, const wchar_t *bucketName, const wchar_t *path, int numSecondsValid,
                          const wchar_t *awsService, CkString &outStr);
    ...
    // Note: This method can only generate URLs that are for HTTP GET requests (i.e. URLs you can paste into a browser address bar).  This method does not generate URLs for POST, PUT, DELETE, etc.
    //
    const wchar_t *s3_GenerateUrlV4(bool useHttps, const wchar_t *bucketName, const wchar_t *path, int numSecondsValid,
                                    const wchar_t *awsService);
    ...
    // The caller is responsible for deleting the object returned by this method.
    CkTaskW *
    S3_UploadBdAsync(CkBinDataW &bd, const wchar_t *contentType, const wchar_t *bucketPath, const wchar_t *objectName);
    ...
    // methods, even if not explicitly stated.
    //
    bool S3_UploadBytes(CkByteData &contentBytes, const wchar_t *contentType, const wchar_t *bucketPath,
                        const wchar_t *objectName);

    // Creates an asynchronous task to call the S3_UploadBytes method with the
    // arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
    // The caller is responsible for deleting the object returned by this method.
    CkTaskW *S3_UploadBytesAsync(CkByteData &contentBytes, const wchar_t *contentType, const wchar_t *bucketPath,
                                 const wchar_t *objectName);
    ...
    // methods, even if not explicitly stated.
    //
    bool S3_UploadFile(const wchar_t *localFilePath, const wchar_t *contentType, const wchar_t *bucketPath,
                       const wchar_t *objectName);

    // Creates an asynchronous task to call the S3_UploadFile method with the arguments
    // provided. (Async methods are available starting in Chilkat v9.5.0.52.)
    // The caller is responsible for deleting the object returned by this method.
    CkTaskW *S3_UploadFileAsync(const wchar_t *localFilePath, const wchar_t *contentType, const wchar_t *bucketPath,
                                const wchar_t *objectName);
    ...
    // methods, even if not explicitly stated.
    //
    bool S3_UploadString(const wchar_t *objectContent, const wchar_t *charset, const wchar_t *contentType,
    ...
    // arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
    // The caller is responsible for deleting the object returned by this method.
    CkTaskW *S3_UploadStringAsync(const wchar_t *objectContent, const wchar_t *charset, const wchar_t *contentType,
                                  const wchar_t *bucketPath, const wchar_t *objectName);
    ...
    //
    bool SharePointOnlineAuth(const wchar_t *siteUrl, const wchar_t *username, CkSecureStringW &password,
                              CkJsonObjectW &extraInfo);

    // Creates an asynchronous task to call the SharePointOnlineAuth method with the
    // arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
    // The caller is responsible for deleting the object returned by this method.
    CkTaskW *SharePointOnlineAuthAsync(const wchar_t *siteUrl, const wchar_t *username, CkSecureStringW &password,
                                       CkJsonObjectW &extraInfo);
