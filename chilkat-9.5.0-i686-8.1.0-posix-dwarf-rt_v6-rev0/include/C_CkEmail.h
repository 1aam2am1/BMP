...
CkEmail_AddAttachmentBd(HCkEmail cHandle, const char *filename, HCkBinData binData, const char *contentType);

CK_C_VISIBLE_PUBLIC void
CkEmail_AddAttachmentHeader(HCkEmail cHandle, int index, const char *fieldName, const char *fieldValue);
...
CK_C_VISIBLE_PUBLIC BOOL
CkEmail_AddDataAttachment2(HCkEmail cHandle, const char *fileName, HCkByteData content, const char *contentType);
...
CK_C_VISIBLE_PUBLIC BOOL
CkEmail_AddiCalendarAlternativeBody(HCkEmail cHandle, const char *icalContent, const char *methodName);
...
CK_C_VISIBLE_PUBLIC BOOL
CkEmail_AddRelatedBd(HCkEmail cHandle, const char *filename, HCkBinData binData, HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkEmail_AddRelatedData(HCkEmail cHandle, const char *fileName, HCkByteData inData, HCkString outStr);
...
CK_C_VISIBLE_PUBLIC void
CkEmail_AddRelatedData2P(HCkEmail cHandle, const void *pBytes, unsigned long szBytes, const char *fileNameInHtml);

#endif
#if !defined(CHILKAT_MONO)

CK_C_VISIBLE_PUBLIC BOOL
CkEmail_AddRelatedDataP(HCkEmail cHandle, const char *nameInHtml, const void *pBytes, unsigned long szBytes,
...
CK_C_VISIBLE_PUBLIC BOOL
CkEmail_AddRelatedFile2(HCkEmail cHandle, const char *filenameOnDisk, const char *filenameInHtml);

CK_C_VISIBLE_PUBLIC void
CkEmail_AddRelatedHeader(HCkEmail cHandle, int index, const char *fieldName, const char *fieldValue);

CK_C_VISIBLE_PUBLIC BOOL
CkEmail_AddRelatedString(HCkEmail cHandle, const char *nameInHtml, const char *str, const char *charset,
                         HCkString outCid);
...
CK_C_VISIBLE_PUBLIC void
CkEmail_AddRelatedString2(HCkEmail cHandle, const char *fileNameInHtml, const char *content, const char *charset);

CK_C_VISIBLE_PUBLIC BOOL CkEmail_AddStringAttachment(HCkEmail cHandle, const char *path, const char *content);

CK_C_VISIBLE_PUBLIC BOOL
CkEmail_AddStringAttachment2(HCkEmail cHandle, const char *path, const char *content, const char *charset);
...
CK_C_VISIBLE_PUBLIC BOOL
CkEmail_AspUnpack(HCkEmail cHandle, const char *prefix, const char *saveDir, const char *urlPath, BOOL cleanFiles);

CK_C_VISIBLE_PUBLIC BOOL
CkEmail_AspUnpack2(HCkEmail cHandle, const char *prefix, const char *saveDir, const char *urlPath, BOOL cleanFiles,
                   HCkByteData outHtml);

CK_C_VISIBLE_PUBLIC BOOL CkEmail_AttachMessage(HCkEmail cHandle, HCkByteData mimeBytes);

CK_C_VISIBLE_PUBLIC BOOL
CkEmail_BEncodeBytes(HCkEmail cHandle, HCkByteData inData, const char *charset, HCkString outEncodedStr);

CK_C_VISIBLE_PUBLIC const char *CkEmail_bEncodeBytes(HCkEmail cHandle, HCkByteData inData, const char *charset);

CK_C_VISIBLE_PUBLIC BOOL
CkEmail_BEncodeString(HCkEmail cHandle, const char *str, const char *charset, HCkString outEncodedStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkEmail_ComputeGlobalKey2(HCkEmail cHandle, const char *encoding, BOOL bFold, HCkString outStr);
...
CK_C_VISIBLE_PUBLIC HCkEmail
CkEmail_CreateDsn(HCkEmail cHandle, const char *humanReadableMessage, const char *xmlStatusFields, BOOL bHeaderOnly);

CK_C_VISIBLE_PUBLIC HCkEmail CkEmail_CreateForward(HCkEmail cHandle);

CK_C_VISIBLE_PUBLIC HCkEmail
CkEmail_CreateMdn(HCkEmail cHandle, const char *humanReadableMessage, const char *xmlStatusFields, BOOL bHeaderOnly);
...
CK_C_VISIBLE_PUBLIC BOOL
CkEmail_GetAlternativeBodyByContentType(HCkEmail cHandle, const char *contentType, HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkEmail_GetAltHeaderField(HCkEmail cHandle, int index, const char *fieldName, HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkEmail_GetAttachedMessageAttr(HCkEmail cHandle, int index, const char *fieldName, const char *attrName,
                               HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkEmail_GetAttachmentAttr(HCkEmail cHandle, int index, const char *fieldName, const char *attrName, HCkString outStr);

CK_C_VISIBLE_PUBLIC const char *
CkEmail_getAttachmentAttr(HCkEmail cHandle, int index, const char *fieldName, const char *attrName);
...
CK_C_VISIBLE_PUBLIC BOOL
CkEmail_GetAttachmentHeader(HCkEmail cHandle, int attachIndex, const char *fieldName, HCkString outFieldValue);
...
CK_C_VISIBLE_PUBLIC BOOL
CkEmail_GetAttachmentString(HCkEmail cHandle, int index, const char *charset, HCkString outStr);

CK_C_VISIBLE_PUBLIC const char *CkEmail_getAttachmentString(HCkEmail cHandle, int index, const char *charset);

CK_C_VISIBLE_PUBLIC BOOL
CkEmail_GetAttachmentStringCrLf(HCkEmail cHandle, int index, const char *charset, HCkString outStrData);
...
CK_C_VISIBLE_PUBLIC BOOL
CkEmail_GetDeliveryStatusInfo(HCkEmail cHandle, const char *fieldName, HCkString outFieldValue);
...
CK_C_VISIBLE_PUBLIC BOOL
CkEmail_GetMbHeaderField(HCkEmail cHandle, const char *fieldName, const char *charset, HCkByteData outBytes);
...
CK_C_VISIBLE_PUBLIC BOOL
CkEmail_GetNthBinaryPartOfType(HCkEmail cHandle, int index, const char *contentType, BOOL inlineOnly,
                               BOOL excludeAttachments, HCkByteData outBytes);

CK_C_VISIBLE_PUBLIC BOOL
CkEmail_GetNthTextPartOfType(HCkEmail cHandle, int index, const char *contentType, BOOL inlineOnly,
...
CkEmail_GetNumPartsOfType(HCkEmail cHandle, const char *contentType, BOOL inlineOnly, BOOL excludeAttachments);
...
CK_C_VISIBLE_PUBLIC BOOL
CkEmail_GetRelatedAttr(HCkEmail cHandle, int index, const char *fieldName, const char *attrName, HCkString outStr);

CK_C_VISIBLE_PUBLIC const char *
CkEmail_getRelatedAttr(HCkEmail cHandle, int index, const char *fieldName, const char *attrName);
...
CK_C_VISIBLE_PUBLIC BOOL
CkEmail_GetRelatedString(HCkEmail cHandle, int index, const char *charset, HCkString outStrData);

CK_C_VISIBLE_PUBLIC const char *CkEmail_getRelatedString(HCkEmail cHandle, int index, const char *charset);

CK_C_VISIBLE_PUBLIC BOOL
CkEmail_GetRelatedStringCrLf(HCkEmail cHandle, int index, const char *charset, HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkEmail_HasHeaderMatching(HCkEmail cHandle, const char *fieldName, const char *valuePattern, BOOL caseSensitive);
...
CK_C_VISIBLE_PUBLIC BOOL
CkEmail_QEncodeBytes(HCkEmail cHandle, HCkByteData inData, const char *charset, HCkString outEncodedStr);

CK_C_VISIBLE_PUBLIC const char *CkEmail_qEncodeBytes(HCkEmail cHandle, HCkByteData inData, const char *charset);

CK_C_VISIBLE_PUBLIC BOOL
CkEmail_QEncodeString(HCkEmail cHandle, const char *str, const char *charset, HCkString outEncodedStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkEmail_SetBinaryBody(HCkEmail cHandle, HCkByteData byteData, const char *contentType, const char *disposition,
                      const char *filename);
...
CK_C_VISIBLE_PUBLIC void
CkEmail_SetEdifactBody(HCkEmail cHandle, const char *message, const char *name, const char *filename,
                       const char *charset);
...
CK_C_VISIBLE_PUBLIC BOOL
CkEmail_UnpackHtml(HCkEmail cHandle, const char *unpackDir, const char *htmlFilename, const char *partsSubdir);
