...
CkOAuth2W_setProgressInfo(HCkOAuth2W cHandle, void (*fnProgressInfo)(const wchar_t *name, const wchar_t *value));
...
CkOAuth2W_GetRedirectRequestParam(HCkOAuth2W cHandle, const wchar_t *paramName, HCkString outStr);
...
CkOAuth2W_SetRefreshHeaderAsync(HCkOAuth2W cHandle, const wchar_t *name, const wchar_t *value);
