...
CkJweW_DecryptSb(HCkJweW cHandle, int index, const wchar_t *charset, HCkStringBuilderW contentSb);

CK_C_VISIBLE_PUBLIC BOOL
CkJweW_Encrypt(HCkJweW cHandle, const wchar_t *content, const wchar_t *charset, HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkJweW_EncryptSb(HCkJweW cHandle, HCkStringBuilderW contentSb, const wchar_t *charset, HCkStringBuilderW jweSb);

CK_C_VISIBLE_PUBLIC int
CkJweW_FindRecipient(HCkJweW cHandle, const wchar_t *paramName, const wchar_t *paramValue, BOOL caseSensitive);
...
CK_C_VISIBLE_PUBLIC BOOL
CkJweW_SetWrappingKey(HCkJweW cHandle, int index, const wchar_t *encodedKey, const wchar_t *encoding);
