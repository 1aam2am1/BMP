...
CkEcc_GenEccKey2(HCkEcc cHandle, const char *curveName, const char *encodedK, const char *encoding);

CK_C_VISIBLE_PUBLIC BOOL CkEcc_SaveLastError(HCkEcc cHandle, const char *path);

CK_C_VISIBLE_PUBLIC BOOL
CkEcc_SharedSecretENC(HCkEcc cHandle, HCkPrivateKey privKey, HCkPublicKey pubKey, const char *encoding,
                      HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkEcc_SignHashENC(HCkEcc cHandle, const char *encodedHash, const char *encoding, HCkPrivateKey privkey, HCkPrng prng,
                  HCkString outStr);
...
CkEcc_VerifyHashENC(HCkEcc cHandle, const char *encodedHash, const char *encodedSig, const char *encoding,
                    HCkPublicKey pubkey);
