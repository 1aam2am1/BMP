...
CkAuthUtil_WalmartSignature(HCkAuthUtil cHandle, const char *requestUrl, const char *consumerId, const char *privateKey,
                            const char *requestMethod, HCkString outStr);
