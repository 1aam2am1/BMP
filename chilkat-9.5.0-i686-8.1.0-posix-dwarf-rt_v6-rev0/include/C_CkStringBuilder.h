...
CkStringBuilder_AppendBd(HCkStringBuilder cHandle, HCkBinData binData, const char *charset, int offset, int numBytes);

CK_C_VISIBLE_PUBLIC BOOL
CkStringBuilder_AppendEncoded(HCkStringBuilder cHandle, HCkByteData binaryData, const char *encoding);
...
CK_C_VISIBLE_PUBLIC BOOL
CkStringBuilder_ContentsEqualSb(HCkStringBuilder cHandle, HCkStringBuilder sb, BOOL caseSensitive);
...
CK_C_VISIBLE_PUBLIC BOOL
CkStringBuilder_GetAfterBetween(HCkStringBuilder cHandle, const char *searchAfter, const char *beginMark,
                                const char *endMark, HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkStringBuilder_GetAfterFinal(HCkStringBuilder cHandle, const char *marker, BOOL removeFlag, HCkString outStr);

CK_C_VISIBLE_PUBLIC const char *
CkStringBuilder_getAfterFinal(HCkStringBuilder cHandle, const char *marker, BOOL removeFlag);
...
CK_C_VISIBLE_PUBLIC BOOL
CkStringBuilder_GetBefore(HCkStringBuilder cHandle, const char *marker, BOOL removeFlag, HCkString outStr);

CK_C_VISIBLE_PUBLIC const char *
CkStringBuilder_getBefore(HCkStringBuilder cHandle, const char *marker, BOOL removeFlag);

CK_C_VISIBLE_PUBLIC BOOL
CkStringBuilder_GetBetween(HCkStringBuilder cHandle, const char *beginMark, const char *endMark, HCkString outStr);

CK_C_VISIBLE_PUBLIC const char *
CkStringBuilder_getBetween(HCkStringBuilder cHandle, const char *beginMark, const char *endMark);

CK_C_VISIBLE_PUBLIC BOOL
CkStringBuilder_GetDecoded(HCkStringBuilder cHandle, const char *encoding, HCkByteData outBytes);

CK_C_VISIBLE_PUBLIC BOOL
CkStringBuilder_GetEncoded(HCkStringBuilder cHandle, const char *encoding, const char *charset, HCkString outStr);

CK_C_VISIBLE_PUBLIC const char *
CkStringBuilder_getEncoded(HCkStringBuilder cHandle, const char *encoding, const char *charset);

CK_C_VISIBLE_PUBLIC BOOL
CkStringBuilder_GetNth(HCkStringBuilder cHandle, int index, const char *delimiterChar, BOOL exceptDoubleQuoted,
...
CK_C_VISIBLE_PUBLIC BOOL
CkStringBuilder_LastNLines(HCkStringBuilder cHandle, int numLines, BOOL bCrlf, HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkStringBuilder_ReplaceAfterFinal(HCkStringBuilder cHandle, const char *marker, const char *replacement);

CK_C_VISIBLE_PUBLIC BOOL
CkStringBuilder_ReplaceAllBetween(HCkStringBuilder cHandle, const char *beginMark, const char *endMark,
                                  const char *replacement, BOOL replaceMarks);

CK_C_VISIBLE_PUBLIC int
CkStringBuilder_ReplaceBetween(HCkStringBuilder cHandle, const char *beginMark, const char *endMark, const char *value,
                               const char *replacement);

CK_C_VISIBLE_PUBLIC BOOL
CkStringBuilder_ReplaceFirst(HCkStringBuilder cHandle, const char *value, const char *replacement);

CK_C_VISIBLE_PUBLIC int CkStringBuilder_ReplaceI(HCkStringBuilder cHandle, const char *value, int replacement);

CK_C_VISIBLE_PUBLIC int
CkStringBuilder_ReplaceNoCase(HCkStringBuilder cHandle, const char *value, const char *replacement);

CK_C_VISIBLE_PUBLIC int
CkStringBuilder_ReplaceWord(HCkStringBuilder cHandle, const char *value, const char *replacement);

CK_C_VISIBLE_PUBLIC void CkStringBuilder_SecureClear(HCkStringBuilder cHandle);

CK_C_VISIBLE_PUBLIC BOOL
CkStringBuilder_SetNth(HCkStringBuilder cHandle, int index, const char *value, const char *delimiterChar,
...
CK_C_VISIBLE_PUBLIC BOOL
CkStringBuilder_WriteFile(HCkStringBuilder cHandle, const char *path, const char *charset, BOOL emitBom);

CK_C_VISIBLE_PUBLIC BOOL
CkStringBuilder_WriteFileIfModified(HCkStringBuilder cHandle, const char *path, const char *charset, BOOL emitBom);
