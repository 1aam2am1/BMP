...
CkBz2W_setProgressInfo(HCkBz2W cHandle, void (*fnProgressInfo)(const wchar_t *name, const wchar_t *value));
...
CkBz2W_CompressFileAsync(HCkBz2W cHandle, const wchar_t *inFilename, const wchar_t *toPath);
...
CK_C_VISIBLE_PUBLIC HCkTaskW
CkBz2W_UncompressFileAsync(HCkBz2W cHandle, const wchar_t *inFilename, const wchar_t *toPath);
...
CK_C_VISIBLE_PUBLIC HCkTaskW
CkBz2W_UncompressMemToFileAsync(HCkBz2W cHandle, HCkByteData inData, const wchar_t *toPath);
