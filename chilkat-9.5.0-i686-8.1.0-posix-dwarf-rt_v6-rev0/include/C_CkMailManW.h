...
CkMailManW_setProgressInfo(HCkMailManW cHandle, void (*fnProgressInfo)(const wchar_t *name, const wchar_t *value));
...
CkMailManW_AddPfxSourceFile(HCkMailManW cHandle, const wchar_t *pfxFilePath, const wchar_t *password);
...
CkMailManW_FetchMimeBdAsync(HCkMailManW cHandle, const wchar_t *uidl, HCkBinDataW mimeData);
...
CkMailManW_FetchMultipleHeaders(HCkMailManW cHandle, HCkStringArrayW uidlArray, int numBodyLines);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkMailManW_FetchMultipleHeadersAsync(HCkMailManW cHandle, HCkStringArrayW uidlArray, int numBodyLines);
...
CK_C_VISIBLE_PUBLIC HCkTaskW
CkMailManW_FetchSingleHeaderAsync(HCkMailManW cHandle, int numBodyLines, int messageNumber);

CK_C_VISIBLE_PUBLIC HCkEmailW
CkMailManW_FetchSingleHeaderByUidl(HCkMailManW cHandle, int numBodyLines, const wchar_t *uidl);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkMailManW_FetchSingleHeaderByUidlAsync(HCkMailManW cHandle, int numBodyLines, const wchar_t *uidl);
...
CK_C_VISIBLE_PUBLIC HCkEmailBundleW
CkMailManW_GetHeaders(HCkMailManW cHandle, int numBodyLines, int fromIndex, int toIndex);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkMailManW_GetHeadersAsync(HCkMailManW cHandle, int numBodyLines, int fromIndex, int toIndex);
...
CK_C_VISIBLE_PUBLIC BOOL
CkMailManW_MxLookup(HCkMailManW cHandle, const wchar_t *emailAddress, HCkString outStrHostname);
...
CK_C_VISIBLE_PUBLIC BOOL
CkMailManW_Pop3SendRawCommand(HCkMailManW cHandle, const wchar_t *command, const wchar_t *charset, HCkString outStr);

CK_C_VISIBLE_PUBLIC const wchar_t *
CkMailManW_pop3SendRawCommand(HCkMailManW cHandle, const wchar_t *command, const wchar_t *charset);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkMailManW_Pop3SendRawCommandAsync(HCkMailManW cHandle, const wchar_t *command, const wchar_t *charset);

CK_C_VISIBLE_PUBLIC BOOL
CkMailManW_QuickSend(HCkMailManW cHandle, const wchar_t *fromAddr, const wchar_t *toAddr, const wchar_t *subject,
                     const wchar_t *body, const wchar_t *smtpServer);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkMailManW_QuickSendAsync(HCkMailManW cHandle, const wchar_t *fromAddr, const wchar_t *toAddr, const wchar_t *subject,
                          const wchar_t *body, const wchar_t *smtpServer);
...
CK_C_VISIBLE_PUBLIC BOOL
CkMailManW_RenderToMimeSb(HCkMailManW cHandle, HCkEmailW email, HCkStringBuilderW renderedMime);
...
CK_C_VISIBLE_PUBLIC BOOL
CkMailManW_SendMime(HCkMailManW cHandle, const wchar_t *fromAddr, const wchar_t *recipients, const wchar_t *mimeSource);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkMailManW_SendMimeAsync(HCkMailManW cHandle, const wchar_t *fromAddr, const wchar_t *recipients,
                         const wchar_t *mimeSource);

CK_C_VISIBLE_PUBLIC BOOL
CkMailManW_SendMimeBd(HCkMailManW cHandle, const wchar_t *fromAddr, const wchar_t *recipients, HCkBinDataW mimeData);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkMailManW_SendMimeBdAsync(HCkMailManW cHandle, const wchar_t *fromAddr, const wchar_t *recipients,
                           HCkBinDataW mimeData);

CK_C_VISIBLE_PUBLIC BOOL
CkMailManW_SendMimeBytes(HCkMailManW cHandle, const wchar_t *fromAddr, const wchar_t *recipients,
                         HCkByteData mimeSource);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkMailManW_SendMimeBytesAsync(HCkMailManW cHandle, const wchar_t *fromAddr, const wchar_t *recipients,
                              HCkByteData mimeSource);

#if defined(CK_SMTPQ_INCLUDED)

CK_C_VISIBLE_PUBLIC BOOL
CkMailManW_SendMimeBytesQ(HCkMailManW cHandle, const wchar_t *from, const wchar_t *recipients, HCkByteData mimeData);

#endif
#if defined(CK_SMTPQ_INCLUDED)

CK_C_VISIBLE_PUBLIC BOOL CkMailManW_SendMimeQ(HCkMailManW cHandle, const wchar_t *fromAddr, const wchar_t *recipients,
                                              const wchar_t *mimeSource);

#endif

CK_C_VISIBLE_PUBLIC BOOL
CkMailManW_SendMimeToList(HCkMailManW cHandle, const wchar_t *fromAddr, const wchar_t *distListFilename,
                          const wchar_t *mimeSource);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkMailManW_SendMimeToListAsync(HCkMailManW cHandle, const wchar_t *fromAddr, const wchar_t *distListFilename,
                               const wchar_t *mimeSource);
...
CK_C_VISIBLE_PUBLIC BOOL
CkMailManW_SendToDistributionList(HCkMailManW cHandle, HCkEmailW emailObj, HCkStringArrayW recipientList);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkMailManW_SendToDistributionListAsync(HCkMailManW cHandle, HCkEmailW emailObj, HCkStringArrayW recipientList);
...
CK_C_VISIBLE_PUBLIC BOOL
CkMailManW_SetPassword(HCkMailManW cHandle, const wchar_t *protocol, HCkSecureStringW password);

CK_C_VISIBLE_PUBLIC BOOL CkMailManW_SetSslClientCert(HCkMailManW cHandle, HCkCertW cert);

CK_C_VISIBLE_PUBLIC BOOL
CkMailManW_SetSslClientCertPem(HCkMailManW cHandle, const wchar_t *pemDataOrFilename, const wchar_t *pemPassword);

CK_C_VISIBLE_PUBLIC BOOL
CkMailManW_SetSslClientCertPfx(HCkMailManW cHandle, const wchar_t *pfxFilename, const wchar_t *pfxPassword);
...
CK_C_VISIBLE_PUBLIC BOOL
CkMailManW_SmtpSendRawCommand(HCkMailManW cHandle, const wchar_t *command, const wchar_t *charset, BOOL bEncodeBase64,
                              HCkString outStr);
...
CK_C_VISIBLE_PUBLIC HCkTaskW
CkMailManW_SmtpSendRawCommandAsync(HCkMailManW cHandle, const wchar_t *command, const wchar_t *charset,
                                   BOOL bEncodeBase64);

CK_C_VISIBLE_PUBLIC BOOL
CkMailManW_SshAuthenticatePk(HCkMailManW cHandle, const wchar_t *sshLogin, HCkSshKeyW sshUsername);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkMailManW_SshAuthenticatePkAsync(HCkMailManW cHandle, const wchar_t *sshLogin, HCkSshKeyW sshUsername);

CK_C_VISIBLE_PUBLIC BOOL
CkMailManW_SshAuthenticatePw(HCkMailManW cHandle, const wchar_t *sshLogin, const wchar_t *sshPassword);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkMailManW_SshAuthenticatePwAsync(HCkMailManW cHandle, const wchar_t *sshLogin, const wchar_t *sshPassword);
...
CK_C_VISIBLE_PUBLIC HCkTaskW
CkMailManW_SshOpenTunnelAsync(HCkMailManW cHandle, const wchar_t *sshHostname, int sshPort);
...
CK_C_VISIBLE_PUBLIC HCkTaskW
CkMailManW_VerifyRecipsAsync(HCkMailManW cHandle, HCkEmailW email, HCkStringArrayW badAddrs);
