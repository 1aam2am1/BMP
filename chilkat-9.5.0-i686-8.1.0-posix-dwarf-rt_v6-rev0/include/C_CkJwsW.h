...
CkJwsW_SetPayload(HCkJwsW cHandle, const wchar_t *payload, const wchar_t *charset, BOOL includeBom);

CK_C_VISIBLE_PUBLIC BOOL CkJwsW_SetPayloadBd(HCkJwsW cHandle, HCkBinDataW binData);

CK_C_VISIBLE_PUBLIC BOOL
CkJwsW_SetPayloadSb(HCkJwsW cHandle, HCkStringBuilderW sbPayload, const wchar_t *charset, BOOL includeBom);
