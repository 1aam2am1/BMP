...
CkJwt_CreateJwt(HCkJwt cHandle, const char *header, const char *payload, const char *password, HCkString outStr);

CK_C_VISIBLE_PUBLIC const char *
CkJwt_createJwt(HCkJwt cHandle, const char *header, const char *payload, const char *password);

CK_C_VISIBLE_PUBLIC BOOL
CkJwt_CreateJwtPk(HCkJwt cHandle, const char *header, const char *payload, HCkPrivateKey key, HCkString outStr);

CK_C_VISIBLE_PUBLIC const char *
CkJwt_createJwtPk(HCkJwt cHandle, const char *header, const char *payload, HCkPrivateKey key);
