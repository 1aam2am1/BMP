...
CkJwtW_CreateJwt(HCkJwtW cHandle, const wchar_t *header, const wchar_t *payload, const wchar_t *password,
                 HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkJwtW_CreateJwtPk(HCkJwtW cHandle, const wchar_t *header, const wchar_t *payload, HCkPrivateKeyW key,
                   HCkString outStr);
