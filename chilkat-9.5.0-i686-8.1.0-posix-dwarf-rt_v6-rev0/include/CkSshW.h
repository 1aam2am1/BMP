...
public:
    ...
    //
    bool
    ChannelReceiveUntilMatch(int channelNum, const wchar_t *matchPattern, const wchar_t *charset, bool caseSensitive);
    ...
    // v9.5.0.52.)
    // The caller is responsible for deleting the object returned by this method.
    CkTaskW *ChannelReceiveUntilMatchAsync(int channelNum, const wchar_t *matchPattern, const wchar_t *charset,
                                           bool caseSensitive);
    ...
    //
    bool ChannelReceiveUntilMatchN(int channelNum, CkStringArrayW &matchPatterns, const wchar_t *charset,
                                   bool caseSensitive);
    ...
    // v9.5.0.52.)
    // The caller is responsible for deleting the object returned by this method.
    CkTaskW *ChannelReceiveUntilMatchNAsync(int channelNum, CkStringArrayW &matchPatterns, const wchar_t *charset,
                                            bool caseSensitive);
    ...
    //
    bool SendReqPty(int channelNum, const wchar_t *termType, int widthInChars, int heightInChars, int widthInPixels,
                    int heightInPixels);
    ...
    // The caller is responsible for deleting the object returned by this method.
    CkTaskW *
    SendReqPtyAsync(int channelNum, const wchar_t *termType, int widthInChars, int heightInChars, int widthInPixels,
                    int heightInPixels);
    ...
    bool SendReqX11Forwarding(int channelNum, bool singleConnection, const wchar_t *authProt, const wchar_t *authCookie,
                              int screenNum);
    ...
    // The caller is responsible for deleting the object returned by this method.
    CkTaskW *
    SendReqX11ForwardingAsync(int channelNum, bool singleConnection, const wchar_t *authProt, const wchar_t *authCookie,
                              int screenNum);
