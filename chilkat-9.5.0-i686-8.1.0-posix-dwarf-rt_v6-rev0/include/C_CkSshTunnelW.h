...
CkSshTunnelW_setProgressInfo(HCkSshTunnelW cHandle, void (*fnProgressInfo)(const wchar_t *name, const wchar_t *value));
...
CkSshTunnelW_AuthenticatePk(HCkSshTunnelW cHandle, const wchar_t *username, HCkSshKeyW privateKey);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkSshTunnelW_AuthenticatePkAsync(HCkSshTunnelW cHandle, const wchar_t *username, HCkSshKeyW privateKey);

CK_C_VISIBLE_PUBLIC BOOL
CkSshTunnelW_AuthenticatePw(HCkSshTunnelW cHandle, const wchar_t *login, const wchar_t *password);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkSshTunnelW_AuthenticatePwAsync(HCkSshTunnelW cHandle, const wchar_t *login, const wchar_t *password);

CK_C_VISIBLE_PUBLIC BOOL
CkSshTunnelW_AuthenticatePwPk(HCkSshTunnelW cHandle, const wchar_t *username, const wchar_t *password,
                              HCkSshKeyW privateKey);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkSshTunnelW_AuthenticatePwPkAsync(HCkSshTunnelW cHandle, const wchar_t *username, const wchar_t *password,
                                   HCkSshKeyW privateKey);

CK_C_VISIBLE_PUBLIC BOOL
CkSshTunnelW_AuthenticateSecPw(HCkSshTunnelW cHandle, HCkSecureStringW login, HCkSecureStringW password);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkSshTunnelW_AuthenticateSecPwAsync(HCkSshTunnelW cHandle, HCkSecureStringW login, HCkSecureStringW password);

CK_C_VISIBLE_PUBLIC BOOL
CkSshTunnelW_AuthenticateSecPwPk(HCkSshTunnelW cHandle, HCkSecureStringW username, HCkSecureStringW password,
                                 HCkSshKeyW privateKey);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkSshTunnelW_AuthenticateSecPwPkAsync(HCkSshTunnelW cHandle, HCkSecureStringW username, HCkSecureStringW password,
                                      HCkSshKeyW privateKey);
...
CK_C_VISIBLE_PUBLIC BOOL
CkSshTunnelW_ConnectThroughSsh(HCkSshTunnelW cHandle, HCkSshW ssh, const wchar_t *hostname, int port);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkSshTunnelW_ConnectThroughSshAsync(HCkSshTunnelW cHandle, HCkSshW ssh, const wchar_t *hostname, int port);

CK_C_VISIBLE_PUBLIC BOOL
CkSshTunnelW_ContinueKeyboardAuth(HCkSshTunnelW cHandle, const wchar_t *response, HCkString outStr);
