...
CkCharset_GetHtmlFileCharset(HCkCharset cHandle, const char *htmlFilePath, HCkString outCharset);
...
CK_C_VISIBLE_PUBLIC BOOL
CkCharset_ReadFileToString(HCkCharset cHandle, const char *path, const char *charset, HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkCharset_WriteStringToFile(HCkCharset cHandle, const char *textData, const char *path, const char *charset);
