...
public:
    ...
    //
    CkTask *
    FullRequestBdAsync(const char *httpVerb, const char *uriPath, CkBinData &binData, CkStringBuilder &responseBody);
    ...
    // to sending or receiving.
    //
    bool FullRequestSb(const char *httpVerb, const char *uriPath, CkStringBuilder &requestBody,
    ...
    // to sending or receiving.
    //
    CkTask *FullRequestSbAsync(const char *httpVerb, const char *uriPath, CkStringBuilder &requestBody,
                               CkStringBuilder &responseBody);
