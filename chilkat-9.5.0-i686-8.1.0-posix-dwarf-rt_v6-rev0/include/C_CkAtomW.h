...
CkAtomW_setProgressInfo(HCkAtomW cHandle, void (*fnProgressInfo)(const wchar_t *name, const wchar_t *value));
...
CK_C_VISIBLE_PUBLIC void
CkAtomW_AddLink(HCkAtomW cHandle, const wchar_t *rel, const wchar_t *href, const wchar_t *title, const wchar_t *typ);

CK_C_VISIBLE_PUBLIC void
CkAtomW_AddPerson(HCkAtomW cHandle, const wchar_t *tag, const wchar_t *name, const wchar_t *uri, const wchar_t *email);

CK_C_VISIBLE_PUBLIC void CkAtomW_DeleteElement(HCkAtomW cHandle, const wchar_t *tag, int index);

CK_C_VISIBLE_PUBLIC void
CkAtomW_DeleteElementAttr(HCkAtomW cHandle, const wchar_t *tag, int index, const wchar_t *attrName);
...
CkAtomW_GetElementAttr(HCkAtomW cHandle, const wchar_t *tag, int index, const wchar_t *attrName, HCkString outStr);

CK_C_VISIBLE_PUBLIC const wchar_t *
CkAtomW_getElementAttr(HCkAtomW cHandle, const wchar_t *tag, int index, const wchar_t *attrName);

CK_C_VISIBLE_PUBLIC int CkAtomW_GetElementCount(HCkAtomW cHandle, const wchar_t *tag);

CK_C_VISIBLE_PUBLIC BOOL
CkAtomW_GetElementDate(HCkAtomW cHandle, const wchar_t *tag, int index, SYSTEMTIME *outSysTime);
...
CK_C_VISIBLE_PUBLIC BOOL
CkAtomW_GetPersonInfo(HCkAtomW cHandle, const wchar_t *tag, int index, const wchar_t *tag2, HCkString outStr);

CK_C_VISIBLE_PUBLIC const wchar_t *
CkAtomW_getPersonInfo(HCkAtomW cHandle, const wchar_t *tag, int index, const wchar_t *tag2);
...
CK_C_VISIBLE_PUBLIC void
CkAtomW_SetElementAttr(HCkAtomW cHandle, const wchar_t *tag, int index, const wchar_t *attrName,
...
CK_C_VISIBLE_PUBLIC void
CkAtomW_UpdateElementDate(HCkAtomW cHandle, const wchar_t *tag, int index, SYSTEMTIME *dateTime);

CK_C_VISIBLE_PUBLIC void
CkAtomW_UpdateElementDateStr(HCkAtomW cHandle, const wchar_t *tag, int index, const wchar_t *dateTimeStr);

CK_C_VISIBLE_PUBLIC void
CkAtomW_UpdateElementDt(HCkAtomW cHandle, const wchar_t *tag, int index, HCkDateTimeW dateTime);

CK_C_VISIBLE_PUBLIC void
CkAtomW_UpdateElementHtml(HCkAtomW cHandle, const wchar_t *tag, int index, const wchar_t *htmlStr);

CK_C_VISIBLE_PUBLIC void
CkAtomW_UpdateElementXHtml(HCkAtomW cHandle, const wchar_t *tag, int index, const wchar_t *xmlStr);

CK_C_VISIBLE_PUBLIC void
CkAtomW_UpdateElementXml(HCkAtomW cHandle, const wchar_t *tag, int index, const wchar_t *xmlStr);

CK_C_VISIBLE_PUBLIC void
CkAtomW_UpdatePerson(HCkAtomW cHandle, const wchar_t *tag, int index, const wchar_t *name, const wchar_t *uri,
                     const wchar_t *email);
