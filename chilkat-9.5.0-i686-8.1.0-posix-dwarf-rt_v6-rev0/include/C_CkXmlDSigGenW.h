...
CkXmlDSigGenW_AddEnvelopedRef(HCkXmlDSigGenW cHandle, const wchar_t *id, HCkStringBuilderW content,
                              const wchar_t *digestMethod, const wchar_t *canonMethod, const wchar_t *refType);

CK_C_VISIBLE_PUBLIC BOOL
CkXmlDSigGenW_AddExternalBinaryRef(HCkXmlDSigGenW cHandle, const wchar_t *uri, HCkBinDataW content,
                                   const wchar_t *digestMethod, const wchar_t *refType);

CK_C_VISIBLE_PUBLIC BOOL
CkXmlDSigGenW_AddExternalFileRef(HCkXmlDSigGenW cHandle, const wchar_t *uri, const wchar_t *localFilePath,
                                 const wchar_t *digestMethod, const wchar_t *refType);

CK_C_VISIBLE_PUBLIC BOOL
CkXmlDSigGenW_AddExternalTextRef(HCkXmlDSigGenW cHandle, const wchar_t *uri, HCkStringBuilderW content,
                                 const wchar_t *charset, BOOL includeBom, const wchar_t *digestMethod,
                                 const wchar_t *refType);

CK_C_VISIBLE_PUBLIC BOOL
CkXmlDSigGenW_AddExternalXmlRef(HCkXmlDSigGenW cHandle, const wchar_t *uri, HCkStringBuilderW content,
                                const wchar_t *digestMethod, const wchar_t *canonMethod, const wchar_t *refType);

CK_C_VISIBLE_PUBLIC BOOL
CkXmlDSigGenW_AddObject(HCkXmlDSigGenW cHandle, const wchar_t *id, const wchar_t *content, const wchar_t *mimeType,
                        const wchar_t *encoding);

CK_C_VISIBLE_PUBLIC BOOL
CkXmlDSigGenW_AddObjectRef(HCkXmlDSigGenW cHandle, const wchar_t *id, const wchar_t *digestMethod,
                           const wchar_t *canonMethod, const wchar_t *prefixList, const wchar_t *refType);

CK_C_VISIBLE_PUBLIC BOOL
CkXmlDSigGenW_AddSameDocRef(HCkXmlDSigGenW cHandle, const wchar_t *id, const wchar_t *digestMethod,
                            const wchar_t *canonMethod, const wchar_t *prefixList, const wchar_t *refType);

CK_C_VISIBLE_PUBLIC BOOL
CkXmlDSigGenW_AddSignatureNamespace(HCkXmlDSigGenW cHandle, const wchar_t *nsPrefix, const wchar_t *nsUri);

CK_C_VISIBLE_PUBLIC BOOL
CkXmlDSigGenW_ConstructSignedInfo(HCkXmlDSigGenW cHandle, HCkStringBuilderW sbXml, HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkXmlDSigGenW_SetRefIdAttr(HCkXmlDSigGenW cHandle, const wchar_t *uri_or_id, const wchar_t *value);
