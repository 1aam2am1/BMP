...
public:
    ...
    // only.
    //
    bool AddEnvelopedRef(const char *id, CkStringBuilder &content, const char *digestMethod, const char *canonMethod,
                         const char *refType);
    ...
    // only.
    //
    bool AddExternalTextRef(const char *uri, CkStringBuilder &content, const char *charset, bool includeBom,
    ...
    // only.
    //
    bool AddExternalXmlRef(const char *uri, CkStringBuilder &content, const char *digestMethod, const char *canonMethod,
                           const char *refType);
    ...
    //
    bool AddObjectRef(const char *id, const char *digestMethod, const char *canonMethod, const char *prefixList,
                      const char *refType);
    ...
    // only.
    //
    bool AddSameDocRef(const char *id, const char *digestMethod, const char *canonMethod, const char *prefixList,
                       const char *refType);
