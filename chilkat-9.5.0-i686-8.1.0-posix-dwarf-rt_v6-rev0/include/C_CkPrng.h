...
CkPrng_RandomPassword(HCkPrng cHandle, int length, BOOL mustIncludeDigit, BOOL upperAndLowercase,
                      const char *mustHaveOneOf, const char *excludeChars, HCkString outStr);

CK_C_VISIBLE_PUBLIC const char *
CkPrng_randomPassword(HCkPrng cHandle, int length, BOOL mustIncludeDigit, BOOL upperAndLowercase,
                      const char *mustHaveOneOf, const char *excludeChars);

CK_C_VISIBLE_PUBLIC BOOL
CkPrng_RandomString(HCkPrng cHandle, int length, BOOL bDigits, BOOL bLower, BOOL bUpper, HCkString outStr);

CK_C_VISIBLE_PUBLIC const char *
CkPrng_randomString(HCkPrng cHandle, int length, BOOL bDigits, BOOL bLower, BOOL bUpper);
