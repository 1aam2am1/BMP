...
CkPemW_setProgressInfo(HCkPemW cHandle, void (*fnProgressInfo)(const wchar_t *name, const wchar_t *value));
...
CkPemW_AddItem(HCkPemW cHandle, const wchar_t *itemType, const wchar_t *encoding, const wchar_t *itemData);
...
CK_C_VISIBLE_PUBLIC BOOL
CkPemW_GetEncodedItem(HCkPemW cHandle, const wchar_t *itemType, const wchar_t *itemSubType, const wchar_t *encoding,
                      int index, HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL CkPemW_ToPemEx(HCkPemW cHandle, BOOL extendedAttrs, BOOL noKeys, BOOL noCerts, BOOL noCaCerts,
                                        const wchar_t *encryptAlg, const wchar_t *password, HCkString outStr);

CK_C_VISIBLE_PUBLIC const wchar_t *
CkPemW_toPemEx(HCkPemW cHandle, BOOL extendedAttrs, BOOL noKeys, BOOL noCerts, BOOL noCaCerts,
