...
CkAuthAzureSASW_SetNonTokenParam(HCkAuthAzureSASW cHandle, const wchar_t *name, const wchar_t *value);

CK_C_VISIBLE_PUBLIC BOOL
CkAuthAzureSASW_SetTokenParam(HCkAuthAzureSASW cHandle, const wchar_t *name, const wchar_t *authParamName,
                              const wchar_t *value);
