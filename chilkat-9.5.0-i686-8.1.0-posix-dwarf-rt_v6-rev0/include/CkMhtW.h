...
public:
    ...
    // The caller is responsible for deleting the object returned by this method.
    CkTaskW *
    GetAndZipEMLAsync(const wchar_t *url_or_htmlFilepath, const wchar_t *zipEntryFilename, const wchar_t *zipFilename);
    ...
    // The caller is responsible for deleting the object returned by this method.
    CkTaskW *
    GetAndZipMHTAsync(const wchar_t *url_or_htmlFilepath, const wchar_t *zipEntryFilename, const wchar_t *zipFilename);
    ...
    bool UnpackMHT(const wchar_t *mhtFilename, const wchar_t *unpackDir, const wchar_t *htmlFilename,
                   const wchar_t *partsSubDir);

    // Same as UnpackMHT, except the MHT is passed in as an in-memory string.
    bool UnpackMHTString(const wchar_t *mhtString, const wchar_t *unpackDir, const wchar_t *htmlFilename,
                         const wchar_t *partsSubDir);
