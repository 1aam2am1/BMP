...
CK_C_VISIBLE_PUBLIC void CkAuthAzureADW_setProgressInfo(HCkAuthAzureADW cHandle,
                                                        void (*fnProgressInfo)(const wchar_t *name,
                                                                               const wchar_t *value));

CK_C_VISIBLE_PUBLIC void
CkAuthAzureADW_setTaskCompleted(HCkAuthAzureADW cHandle, void (*fnTaskCompleted)(HCkTaskW hTask));
