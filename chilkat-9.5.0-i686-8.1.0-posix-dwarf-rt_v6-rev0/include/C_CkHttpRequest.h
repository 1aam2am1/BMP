...
CkHttpRequest_AddBdForUpload(HCkHttpRequest cHandle, const char *name, const char *remoteFilename, HCkBinData byteData,
                             const char *contentType);

CK_C_VISIBLE_PUBLIC BOOL
CkHttpRequest_AddBytesForUpload(HCkHttpRequest cHandle, const char *name, const char *remoteFileName,
                                HCkByteData byteData);

CK_C_VISIBLE_PUBLIC BOOL
CkHttpRequest_AddBytesForUpload2(HCkHttpRequest cHandle, const char *name, const char *remoteFileName,
                                 HCkByteData byteData, const char *contentType);

CK_C_VISIBLE_PUBLIC BOOL CkHttpRequest_AddFileForUpload(HCkHttpRequest cHandle, const char *name, const char *filePath);

CK_C_VISIBLE_PUBLIC BOOL CkHttpRequest_AddFileForUpload2(HCkHttpRequest cHandle, const char *name, const char *filePath,
                                                         const char *contentType);

CK_C_VISIBLE_PUBLIC void CkHttpRequest_AddHeader(HCkHttpRequest cHandle, const char *name, const char *value);

CK_C_VISIBLE_PUBLIC BOOL
CkHttpRequest_AddMwsSignature(HCkHttpRequest cHandle, const char *domain, const char *mwsSecretKey);

CK_C_VISIBLE_PUBLIC void CkHttpRequest_AddParam(HCkHttpRequest cHandle, const char *name, const char *value);

CK_C_VISIBLE_PUBLIC BOOL
CkHttpRequest_AddStringForUpload(HCkHttpRequest cHandle, const char *name, const char *filename, const char *strData,
                                 const char *charset);

CK_C_VISIBLE_PUBLIC BOOL
CkHttpRequest_AddStringForUpload2(HCkHttpRequest cHandle, const char *name, const char *filename, const char *strData,
                                  const char *charset, const char *contentType);

CK_C_VISIBLE_PUBLIC BOOL
CkHttpRequest_AddSubHeader(HCkHttpRequest cHandle, int index, const char *name, const char *value);
...
CK_C_VISIBLE_PUBLIC BOOL
CkHttpRequest_LoadBodyFromSb(HCkHttpRequest cHandle, HCkStringBuilder requestBody, const char *charset);

CK_C_VISIBLE_PUBLIC BOOL
CkHttpRequest_LoadBodyFromString(HCkHttpRequest cHandle, const char *bodyStr, const char *charset);
...
CK_C_VISIBLE_PUBLIC BOOL
CkHttpRequest_StreamChunkFromFile(HCkHttpRequest cHandle, const char *path, const char *offset, const char *numBytes);
