...
CkXmlDSigGen_AddEnvelopedRef(HCkXmlDSigGen cHandle, const char *id, HCkStringBuilder content, const char *digestMethod,
                             const char *canonMethod, const char *refType);

CK_C_VISIBLE_PUBLIC BOOL
CkXmlDSigGen_AddExternalBinaryRef(HCkXmlDSigGen cHandle, const char *uri, HCkBinData content, const char *digestMethod,
                                  const char *refType);

CK_C_VISIBLE_PUBLIC BOOL
CkXmlDSigGen_AddExternalFileRef(HCkXmlDSigGen cHandle, const char *uri, const char *localFilePath,
                                const char *digestMethod, const char *refType);

CK_C_VISIBLE_PUBLIC BOOL
CkXmlDSigGen_AddExternalTextRef(HCkXmlDSigGen cHandle, const char *uri, HCkStringBuilder content, const char *charset,
                                BOOL includeBom, const char *digestMethod, const char *refType);

CK_C_VISIBLE_PUBLIC BOOL
CkXmlDSigGen_AddExternalXmlRef(HCkXmlDSigGen cHandle, const char *uri, HCkStringBuilder content,
                               const char *digestMethod, const char *canonMethod, const char *refType);

CK_C_VISIBLE_PUBLIC BOOL
CkXmlDSigGen_AddObject(HCkXmlDSigGen cHandle, const char *id, const char *content, const char *mimeType,
                       const char *encoding);

CK_C_VISIBLE_PUBLIC BOOL
CkXmlDSigGen_AddObjectRef(HCkXmlDSigGen cHandle, const char *id, const char *digestMethod, const char *canonMethod,
                          const char *prefixList, const char *refType);

CK_C_VISIBLE_PUBLIC BOOL
CkXmlDSigGen_AddSameDocRef(HCkXmlDSigGen cHandle, const char *id, const char *digestMethod, const char *canonMethod,
                           const char *prefixList, const char *refType);

CK_C_VISIBLE_PUBLIC BOOL
CkXmlDSigGen_AddSignatureNamespace(HCkXmlDSigGen cHandle, const char *nsPrefix, const char *nsUri);

CK_C_VISIBLE_PUBLIC BOOL
CkXmlDSigGen_ConstructSignedInfo(HCkXmlDSigGen cHandle, HCkStringBuilder sbXml, HCkString outStr);
