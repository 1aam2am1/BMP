...
CkHttpRequestW_AddBdForUpload(HCkHttpRequestW cHandle, const wchar_t *name, const wchar_t *remoteFilename,
                              HCkBinDataW byteData, const wchar_t *contentType);

CK_C_VISIBLE_PUBLIC BOOL
CkHttpRequestW_AddBytesForUpload(HCkHttpRequestW cHandle, const wchar_t *name, const wchar_t *remoteFileName,
                                 HCkByteData byteData);

CK_C_VISIBLE_PUBLIC BOOL
CkHttpRequestW_AddBytesForUpload2(HCkHttpRequestW cHandle, const wchar_t *name, const wchar_t *remoteFileName,
                                  HCkByteData byteData, const wchar_t *contentType);

CK_C_VISIBLE_PUBLIC BOOL
CkHttpRequestW_AddFileForUpload(HCkHttpRequestW cHandle, const wchar_t *name, const wchar_t *filePath);

CK_C_VISIBLE_PUBLIC BOOL
CkHttpRequestW_AddFileForUpload2(HCkHttpRequestW cHandle, const wchar_t *name, const wchar_t *filePath,
...
CK_C_VISIBLE_PUBLIC BOOL
CkHttpRequestW_AddMwsSignature(HCkHttpRequestW cHandle, const wchar_t *domain, const wchar_t *mwsSecretKey);

CK_C_VISIBLE_PUBLIC void CkHttpRequestW_AddParam(HCkHttpRequestW cHandle, const wchar_t *name, const wchar_t *value);

CK_C_VISIBLE_PUBLIC BOOL
CkHttpRequestW_AddStringForUpload(HCkHttpRequestW cHandle, const wchar_t *name, const wchar_t *filename,
                                  const wchar_t *strData, const wchar_t *charset);

CK_C_VISIBLE_PUBLIC BOOL
CkHttpRequestW_AddStringForUpload2(HCkHttpRequestW cHandle, const wchar_t *name, const wchar_t *filename,
                                   const wchar_t *strData, const wchar_t *charset, const wchar_t *contentType);

CK_C_VISIBLE_PUBLIC BOOL
CkHttpRequestW_AddSubHeader(HCkHttpRequestW cHandle, int index, const wchar_t *name, const wchar_t *value);
...
CK_C_VISIBLE_PUBLIC BOOL
CkHttpRequestW_LoadBodyFromSb(HCkHttpRequestW cHandle, HCkStringBuilderW requestBody, const wchar_t *charset);

CK_C_VISIBLE_PUBLIC BOOL
CkHttpRequestW_LoadBodyFromString(HCkHttpRequestW cHandle, const wchar_t *bodyStr, const wchar_t *charset);
...
CK_C_VISIBLE_PUBLIC BOOL
CkHttpRequestW_StreamChunkFromFile(HCkHttpRequestW cHandle, const wchar_t *path, const wchar_t *offset,
                                   const wchar_t *numBytes);
