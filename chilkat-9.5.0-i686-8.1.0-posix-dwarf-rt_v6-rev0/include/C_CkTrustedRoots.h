...
CkTrustedRoots_setProgressInfo(HCkTrustedRoots cHandle, void (*fnProgressInfo)(const char *name, const char *value));

CK_C_VISIBLE_PUBLIC void
CkTrustedRoots_setTaskCompleted(HCkTrustedRoots cHandle, void (*fnTaskCompleted)(HCkTask hTask));

CK_C_VISIBLE_PUBLIC void CkTrustedRoots_setAbortCheck2(HCkTrustedRoots cHandle, BOOL (*fnAbortCheck2)(void *pContext));

CK_C_VISIBLE_PUBLIC void
CkTrustedRoots_setPercentDone2(HCkTrustedRoots cHandle, BOOL (*fnPercentDone2)(int pctDone, void *pContext));

CK_C_VISIBLE_PUBLIC void CkTrustedRoots_setProgressInfo2(HCkTrustedRoots cHandle,
                                                         void (*fnProgressInfo2)(const char *name, const char *value,
                                                                                 void *pContext));

CK_C_VISIBLE_PUBLIC void
CkTrustedRoots_setTaskCompleted2(HCkTrustedRoots cHandle, void (*fnTaskCompleted2)(HCkTask hTask, void *pContext));
