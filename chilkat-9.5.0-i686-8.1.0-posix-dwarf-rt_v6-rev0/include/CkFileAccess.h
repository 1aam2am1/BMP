...
public:
    ...
    //
    bool
    FileOpen(const char *filePath, unsigned long accessMode, unsigned long shareMode, unsigned long createDisposition,
    ...
    //
    int ReadNextFragment(bool startAtBeginning, const char *beginMarker, const char *endMarker, const char *charset,
                         CkStringBuilder &sb);


    // Reassembles a file previously split by the SplitFile method.
    bool ReassembleFile(const char *partsDirPath, const char *partPrefix, const char *partExtension,
                        const char *reassembledFilename);
    ...
    int ReplaceStrings(const char *filePath, const char *charset, const char *existingString,
    ...
    bool
    SetFileTimes(const char *filePath, CkDateTime &createTime, CkDateTime &lastAccessTime, CkDateTime &lastModTime);
    ...
    bool SplitFile(const char *fileToSplit, const char *partPrefix, const char *partExtension, int partSize,
                   const char *destDir);
