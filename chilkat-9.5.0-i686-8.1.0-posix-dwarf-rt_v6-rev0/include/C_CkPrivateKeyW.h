...
CkPrivateKeyW_GetJwkThumbprint(HCkPrivateKeyW cHandle, const wchar_t *hashAlg, HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkPrivateKeyW_GetPkcs8Encrypted(HCkPrivateKeyW cHandle, const wchar_t *password, HCkByteData outBytes);

CK_C_VISIBLE_PUBLIC BOOL
CkPrivateKeyW_GetPkcs8EncryptedENC(HCkPrivateKeyW cHandle, const wchar_t *encoding, const wchar_t *password,
                                   HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkPrivateKeyW_GetPkcs8EncryptedPem(HCkPrivateKeyW cHandle, const wchar_t *password, HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkPrivateKeyW_LoadAnyFormat(HCkPrivateKeyW cHandle, HCkBinDataW privKeyData, const wchar_t *password);

CK_C_VISIBLE_PUBLIC BOOL
CkPrivateKeyW_LoadEncryptedPem(HCkPrivateKeyW cHandle, const wchar_t *pemStr, const wchar_t *password);

CK_C_VISIBLE_PUBLIC BOOL
CkPrivateKeyW_LoadEncryptedPemFile(HCkPrivateKeyW cHandle, const wchar_t *path, const wchar_t *password);
...
CK_C_VISIBLE_PUBLIC BOOL
CkPrivateKeyW_LoadPkcs8Encrypted(HCkPrivateKeyW cHandle, HCkByteData data, const wchar_t *password);

CK_C_VISIBLE_PUBLIC BOOL
CkPrivateKeyW_LoadPkcs8EncryptedFile(HCkPrivateKeyW cHandle, const wchar_t *path, const wchar_t *password);
...
CK_C_VISIBLE_PUBLIC BOOL
CkPrivateKeyW_LoadPvkFile(HCkPrivateKeyW cHandle, const wchar_t *path, const wchar_t *password);
...
CK_C_VISIBLE_PUBLIC BOOL
CkPrivateKeyW_SavePkcs8EncryptedFile(HCkPrivateKeyW cHandle, const wchar_t *password, const wchar_t *path);

CK_C_VISIBLE_PUBLIC BOOL
CkPrivateKeyW_SavePkcs8EncryptedPemFile(HCkPrivateKeyW cHandle, const wchar_t *password, const wchar_t *path);
