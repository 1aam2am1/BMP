...
CkMailMan_setProgressInfo(HCkMailMan cHandle, void (*fnProgressInfo)(const char *name, const char *value));
...
CK_C_VISIBLE_PUBLIC void
CkMailMan_setPercentDone2(HCkMailMan cHandle, BOOL (*fnPercentDone2)(int pctDone, void *pContext));

CK_C_VISIBLE_PUBLIC void CkMailMan_setProgressInfo2(HCkMailMan cHandle,
                                                    void (*fnProgressInfo2)(const char *name, const char *value,
                                                                            void *pContext));

CK_C_VISIBLE_PUBLIC void
CkMailMan_setTaskCompleted2(HCkMailMan cHandle, void (*fnTaskCompleted2)(HCkTask hTask, void *pContext));
...
CkMailMan_FetchMultipleHeaders(HCkMailMan cHandle, HCkStringArray uidlArray, int numBodyLines);

CK_C_VISIBLE_PUBLIC HCkTask
CkMailMan_FetchMultipleHeadersAsync(HCkMailMan cHandle, HCkStringArray uidlArray, int numBodyLines);
...
CK_C_VISIBLE_PUBLIC HCkTask
CkMailMan_FetchSingleHeaderByUidlAsync(HCkMailMan cHandle, int numBodyLines, const char *uidl);
...
CK_C_VISIBLE_PUBLIC HCkEmailBundle
CkMailMan_GetHeaders(HCkMailMan cHandle, int numBodyLines, int fromIndex, int toIndex);
...
CkMailMan_Pop3SendRawCommand(HCkMailMan cHandle, const char *command, const char *charset, HCkString outStr);

CK_C_VISIBLE_PUBLIC const char *
CkMailMan_pop3SendRawCommand(HCkMailMan cHandle, const char *command, const char *charset);

CK_C_VISIBLE_PUBLIC HCkTask
CkMailMan_Pop3SendRawCommandAsync(HCkMailMan cHandle, const char *command, const char *charset);

CK_C_VISIBLE_PUBLIC BOOL
CkMailMan_QuickSend(HCkMailMan cHandle, const char *fromAddr, const char *toAddr, const char *subject, const char *body,
                    const char *smtpServer);

CK_C_VISIBLE_PUBLIC HCkTask
CkMailMan_QuickSendAsync(HCkMailMan cHandle, const char *fromAddr, const char *toAddr, const char *subject,
                         const char *body, const char *smtpServer);
...
CK_C_VISIBLE_PUBLIC BOOL
CkMailMan_SendMime(HCkMailMan cHandle, const char *fromAddr, const char *recipients, const char *mimeSource);

CK_C_VISIBLE_PUBLIC HCkTask
CkMailMan_SendMimeAsync(HCkMailMan cHandle, const char *fromAddr, const char *recipients, const char *mimeSource);

CK_C_VISIBLE_PUBLIC BOOL
CkMailMan_SendMimeBd(HCkMailMan cHandle, const char *fromAddr, const char *recipients, HCkBinData mimeData);

CK_C_VISIBLE_PUBLIC HCkTask
CkMailMan_SendMimeBdAsync(HCkMailMan cHandle, const char *fromAddr, const char *recipients, HCkBinData mimeData);

CK_C_VISIBLE_PUBLIC BOOL
CkMailMan_SendMimeBytes(HCkMailMan cHandle, const char *fromAddr, const char *recipients, HCkByteData mimeSource);

CK_C_VISIBLE_PUBLIC HCkTask
CkMailMan_SendMimeBytesAsync(HCkMailMan cHandle, const char *fromAddr, const char *recipients, HCkByteData mimeSource);

#if defined(CK_SMTPQ_INCLUDED)

CK_C_VISIBLE_PUBLIC BOOL
CkMailMan_SendMimeBytesQ(HCkMailMan cHandle, const char *from, const char *recipients, HCkByteData mimeData);

#endif
#if defined(CK_SMTPQ_INCLUDED)

CK_C_VISIBLE_PUBLIC BOOL
CkMailMan_SendMimeQ(HCkMailMan cHandle, const char *fromAddr, const char *recipients, const char *mimeSource);

#endif

CK_C_VISIBLE_PUBLIC BOOL
CkMailMan_SendMimeToList(HCkMailMan cHandle, const char *fromAddr, const char *distListFilename,
                         const char *mimeSource);

CK_C_VISIBLE_PUBLIC HCkTask
CkMailMan_SendMimeToListAsync(HCkMailMan cHandle, const char *fromAddr, const char *distListFilename,
                              const char *mimeSource);
...
CK_C_VISIBLE_PUBLIC BOOL
CkMailMan_SendToDistributionList(HCkMailMan cHandle, HCkEmail emailObj, HCkStringArray recipientList);

CK_C_VISIBLE_PUBLIC HCkTask
CkMailMan_SendToDistributionListAsync(HCkMailMan cHandle, HCkEmail emailObj, HCkStringArray recipientList);
...
CK_C_VISIBLE_PUBLIC BOOL
CkMailMan_SetSslClientCertPem(HCkMailMan cHandle, const char *pemDataOrFilename, const char *pemPassword);

CK_C_VISIBLE_PUBLIC BOOL
CkMailMan_SetSslClientCertPfx(HCkMailMan cHandle, const char *pfxFilename, const char *pfxPassword);
...
CK_C_VISIBLE_PUBLIC BOOL
CkMailMan_SmtpSendRawCommand(HCkMailMan cHandle, const char *command, const char *charset, BOOL bEncodeBase64,
                             HCkString outStr);
...
CK_C_VISIBLE_PUBLIC HCkTask
CkMailMan_SmtpSendRawCommandAsync(HCkMailMan cHandle, const char *command, const char *charset, BOOL bEncodeBase64);

CK_C_VISIBLE_PUBLIC BOOL CkMailMan_SshAuthenticatePk(HCkMailMan cHandle, const char *sshLogin, HCkSshKey sshUsername);

CK_C_VISIBLE_PUBLIC HCkTask
CkMailMan_SshAuthenticatePkAsync(HCkMailMan cHandle, const char *sshLogin, HCkSshKey sshUsername);

CK_C_VISIBLE_PUBLIC BOOL CkMailMan_SshAuthenticatePw(HCkMailMan cHandle, const char *sshLogin, const char *sshPassword);

CK_C_VISIBLE_PUBLIC HCkTask
CkMailMan_SshAuthenticatePwAsync(HCkMailMan cHandle, const char *sshLogin, const char *sshPassword);
