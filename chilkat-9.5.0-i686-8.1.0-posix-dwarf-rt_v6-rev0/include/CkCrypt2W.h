...
public:
    ...
    // "410042004300".
    bool EncodeString(const wchar_t *strToEncode, const wchar_t *charsetName, const wchar_t *toEncodingName,
                      CkString &outStr);
    ...
    //     "sha256", "sha512", etc.
    bool
    Hotp(const wchar_t *secret, const wchar_t *secretEnc, const wchar_t *counterHex, int numDigits, int truncOffset,
         const wchar_t *hashAlg, CkString &outStr);
    ...
    // password.
    //
    bool Pbkdf1(const wchar_t *password, const wchar_t *charset, const wchar_t *hashAlg, const wchar_t *salt,
                int iterationCount, int outputKeyBitLen, const wchar_t *encoding, CkString &outStr);
    ...
    // password.
    //
    const wchar_t *pbkdf1(const wchar_t *password, const wchar_t *charset, const wchar_t *hashAlg, const wchar_t *salt,
                          int iterationCount, int outputKeyBitLen, const wchar_t *encoding);
    ...
    // password.
    //
    bool Pbkdf2(const wchar_t *password, const wchar_t *charset, const wchar_t *hashAlg, const wchar_t *salt,
                int iterationCount, int outputKeyBitLen, const wchar_t *encoding, CkString &outStr);
    ...
    // password.
    //
    const wchar_t *pbkdf2(const wchar_t *password, const wchar_t *charset, const wchar_t *hashAlg, const wchar_t *salt,
                          int iterationCount, int outputKeyBitLen, const wchar_t *encoding);
    ...
    //     hashAlg: Normally set to "sha1". Can be set to other hash algorithms such as
    //     "sha256", "sha512", etc.
    bool Totp(const wchar_t *secret, const wchar_t *secretEnc, const wchar_t *t0, const wchar_t *tNow, int tStep,
              int numDigits, int truncOffset, const wchar_t *hashAlg, CkString &outStr);
    ...
    //     "sha256", "sha512", etc.
    const wchar_t *
    totp(const wchar_t *secret, const wchar_t *secretEnc, const wchar_t *t0, const wchar_t *tNow, int tStep,
