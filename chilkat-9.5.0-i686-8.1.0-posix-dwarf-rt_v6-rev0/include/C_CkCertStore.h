...
CkCertStore_CreateRegistryStore(HCkCertStore cHandle, const char *regRoot, const char *regPath);
...
CK_C_VISIBLE_PUBLIC BOOL
CkCertStore_LoadPfxData2(HCkCertStore cHandle, const void *pByteData, unsigned long szByteData, const char *password);
...
CK_C_VISIBLE_PUBLIC BOOL
CkCertStore_OpenRegistryStore(HCkCertStore cHandle, const char *regRoot, const char *regPath, BOOL readOnly);
...
CK_C_VISIBLE_PUBLIC BOOL
CkCertStore_OpenWindowsStore(HCkCertStore cHandle, const char *storeLocation, const char *storeName, BOOL readOnly);
