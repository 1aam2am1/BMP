...
CkAuthGoogle_setProgressInfo(HCkAuthGoogle cHandle, void (*fnProgressInfo)(const char *name, const char *value));
...
CK_C_VISIBLE_PUBLIC void
CkAuthGoogle_setPercentDone2(HCkAuthGoogle cHandle, BOOL (*fnPercentDone2)(int pctDone, void *pContext));

CK_C_VISIBLE_PUBLIC void CkAuthGoogle_setProgressInfo2(HCkAuthGoogle cHandle,
                                                       void (*fnProgressInfo2)(const char *name, const char *value,
                                                                               void *pContext));

CK_C_VISIBLE_PUBLIC void
CkAuthGoogle_setTaskCompleted2(HCkAuthGoogle cHandle, void (*fnTaskCompleted2)(HCkTask hTask, void *pContext));
