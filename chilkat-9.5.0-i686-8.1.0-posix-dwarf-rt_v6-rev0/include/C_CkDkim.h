...
CkDkim_setProgressInfo(HCkDkim cHandle, void (*fnProgressInfo)(const char *name, const char *value));
...
CK_C_VISIBLE_PUBLIC void
CkDkim_setProgressInfo2(HCkDkim cHandle, void (*fnProgressInfo2)(const char *name, const char *value, void *pContext));

CK_C_VISIBLE_PUBLIC void
CkDkim_setTaskCompleted2(HCkDkim cHandle, void (*fnTaskCompleted2)(HCkTask hTask, void *pContext));
...
CkDkim_LoadDkimPkBytes(HCkDkim cHandle, HCkByteData privateKeyDer, const char *optionalPassword);

CK_C_VISIBLE_PUBLIC BOOL
CkDkim_LoadDkimPkFile(HCkDkim cHandle, const char *privateKeyFilePath, const char *optionalPassword);

CK_C_VISIBLE_PUBLIC BOOL CkDkim_LoadDomainKeyPk(HCkDkim cHandle, const char *privateKey, const char *optionalPassword);

CK_C_VISIBLE_PUBLIC BOOL
CkDkim_LoadDomainKeyPkBytes(HCkDkim cHandle, HCkByteData privateKeyDer, const char *optionalPassword);

CK_C_VISIBLE_PUBLIC BOOL
CkDkim_LoadDomainKeyPkFile(HCkDkim cHandle, const char *privateKeyFilePath, const char *optionalPassword);

CK_C_VISIBLE_PUBLIC BOOL
CkDkim_LoadPublicKey(HCkDkim cHandle, const char *selector, const char *domain, const char *publicKey);

CK_C_VISIBLE_PUBLIC BOOL
CkDkim_LoadPublicKeyFile(HCkDkim cHandle, const char *selector, const char *domain, const char *publicKeyFilepath);
