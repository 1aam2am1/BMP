...
CkStream_setProgressInfo(HCkStream cHandle, void (*fnProgressInfo)(const char *name, const char *value));
...
CK_C_VISIBLE_PUBLIC void
CkStream_setPercentDone2(HCkStream cHandle, BOOL (*fnPercentDone2)(int pctDone, void *pContext));

CK_C_VISIBLE_PUBLIC void CkStream_setProgressInfo2(HCkStream cHandle,
                                                   void (*fnProgressInfo2)(const char *name, const char *value,
                                                                           void *pContext));

CK_C_VISIBLE_PUBLIC void
CkStream_setTaskCompleted2(HCkStream cHandle, void (*fnTaskCompleted2)(HCkTask hTask, void *pContext));
...
CkStream_ReadNBytesENC(HCkStream cHandle, int numBytes, const char *encoding, HCkString outStr);
