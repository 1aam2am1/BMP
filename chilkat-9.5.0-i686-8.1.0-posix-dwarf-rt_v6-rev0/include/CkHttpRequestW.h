...
public:
    ...
    // filename extension.
    //
    bool AddBdForUpload(const wchar_t *name, const wchar_t *remoteFilename, CkBinDataW &byteData,
    ...
    bool AddBytesForUpload2(const wchar_t *name, const wchar_t *remoteFileName, CkByteData &byteData,
                            const wchar_t *contentType);
    ...
    // instead of a file.
    bool
    AddStringForUpload(const wchar_t *name, const wchar_t *filename, const wchar_t *strData, const wchar_t *charset);
    ...
    bool
    AddStringForUpload2(const wchar_t *name, const wchar_t *filename, const wchar_t *strData, const wchar_t *charset,
                        const wchar_t *contentType);
