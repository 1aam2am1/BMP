...
CkBinData_AppendPadded(HCkBinData cHandle, const char *str, const char *charset, BOOL padWithSpace, int fieldLen);
...
CK_C_VISIBLE_PUBLIC BOOL
CkBinData_GetEncodedChunk(HCkBinData cHandle, int offset, int numBytes, const char *encoding, HCkString outStr);

CK_C_VISIBLE_PUBLIC const char *
CkBinData_getEncodedChunk(HCkBinData cHandle, int offset, int numBytes, const char *encoding);
