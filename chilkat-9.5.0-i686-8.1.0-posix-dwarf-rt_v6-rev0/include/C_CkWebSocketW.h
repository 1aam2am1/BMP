...
CkWebSocketW_setProgressInfo(HCkWebSocketW cHandle, void (*fnProgressInfo)(const wchar_t *name, const wchar_t *value));
...
CkWebSocketW_SendClose(HCkWebSocketW cHandle, BOOL includeStatus, int statusCode, const wchar_t *reason);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkWebSocketW_SendCloseAsync(HCkWebSocketW cHandle, BOOL includeStatus, int statusCode, const wchar_t *reason);

CK_C_VISIBLE_PUBLIC BOOL CkWebSocketW_SendFrame(HCkWebSocketW cHandle, const wchar_t *stringToSend, BOOL finalFrame);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkWebSocketW_SendFrameAsync(HCkWebSocketW cHandle, const wchar_t *stringToSend, BOOL finalFrame);

CK_C_VISIBLE_PUBLIC BOOL CkWebSocketW_SendFrameBd(HCkWebSocketW cHandle, HCkBinDataW bdToSend, BOOL finalFrame);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkWebSocketW_SendFrameBdAsync(HCkWebSocketW cHandle, HCkBinDataW bdToSend, BOOL finalFrame);

CK_C_VISIBLE_PUBLIC BOOL CkWebSocketW_SendFrameSb(HCkWebSocketW cHandle, HCkStringBuilderW sbToSend, BOOL finalFrame);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkWebSocketW_SendFrameSbAsync(HCkWebSocketW cHandle, HCkStringBuilderW sbToSend, BOOL finalFrame);
