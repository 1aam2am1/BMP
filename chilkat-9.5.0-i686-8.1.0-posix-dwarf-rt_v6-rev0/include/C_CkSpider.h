...
CkSpider_setProgressInfo(HCkSpider cHandle, void (*fnProgressInfo)(const char *name, const char *value));
...
CK_C_VISIBLE_PUBLIC void
CkSpider_setPercentDone2(HCkSpider cHandle, BOOL (*fnPercentDone2)(int pctDone, void *pContext));

CK_C_VISIBLE_PUBLIC void CkSpider_setProgressInfo2(HCkSpider cHandle,
                                                   void (*fnProgressInfo2)(const char *name, const char *value,
                                                                           void *pContext));

CK_C_VISIBLE_PUBLIC void
CkSpider_setTaskCompleted2(HCkSpider cHandle, void (*fnTaskCompleted2)(HCkTask hTask, void *pContext));
