...
CK_C_VISIBLE_PUBLIC void CkTrustedRootsW_setProgressInfo(HCkTrustedRootsW cHandle,
                                                         void (*fnProgressInfo)(const wchar_t *name,
                                                                                const wchar_t *value));

CK_C_VISIBLE_PUBLIC void
CkTrustedRootsW_setTaskCompleted(HCkTrustedRootsW cHandle, void (*fnTaskCompleted)(HCkTaskW hTask));
