...
CkZipW_setProgressInfo(HCkZipW cHandle, void (*fnProgressInfo)(const wchar_t *name, const wchar_t *value));
...
CK_C_VISIBLE_PUBLIC BOOL CkZipW_AddEmbedded(HCkZipW cHandle, const wchar_t *exeFilename, const wchar_t *resourceName,
...
CK_C_VISIBLE_PUBLIC HCkZipEntryW
CkZipW_AppendBase64(HCkZipW cHandle, const wchar_t *fileName, const wchar_t *encodedCompressedData);
...
CK_C_VISIBLE_PUBLIC HCkZipEntryW
CkZipW_AppendDataEncoded(HCkZipW cHandle, const wchar_t *filename, const wchar_t *encoding, const wchar_t *data);
...
CkZipW_AppendFilesEx(HCkZipW cHandle, const wchar_t *filePattern, BOOL recurse, BOOL saveExtraPath, BOOL archiveOnly,
                     BOOL includeHidden, BOOL includeSystem);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkZipW_AppendFilesExAsync(HCkZipW cHandle, const wchar_t *filePattern, BOOL recurse, BOOL saveExtraPath,
                          BOOL archiveOnly, BOOL includeHidden, BOOL includeSystem);

CK_C_VISIBLE_PUBLIC HCkZipEntryW
CkZipW_AppendHex(HCkZipW cHandle, const wchar_t *fileName, const wchar_t *encodedCompressedData);
...
CK_C_VISIBLE_PUBLIC HCkTaskW
CkZipW_AppendOneFileOrDirAsync(HCkZipW cHandle, const wchar_t *fileOrDirPath, BOOL saveExtraPath);

CK_C_VISIBLE_PUBLIC HCkZipEntryW
CkZipW_AppendString(HCkZipW cHandle, const wchar_t *internalZipFilepath, const wchar_t *textData);

CK_C_VISIBLE_PUBLIC HCkZipEntryW
CkZipW_AppendString2(HCkZipW cHandle, const wchar_t *internalZipFilepath, const wchar_t *textData,
...
CK_C_VISIBLE_PUBLIC BOOL
CkZipW_RemoveEmbedded(HCkZipW cHandle, const wchar_t *exeFilename, const wchar_t *resourceName);
...
CK_C_VISIBLE_PUBLIC BOOL
CkZipW_ReplaceEmbedded(HCkZipW cHandle, const wchar_t *exeFilename, const wchar_t *resourceName,
                       const wchar_t *zipFilename);
...
CkZipW_UnzipMatching(HCkZipW cHandle, const wchar_t *dirPath, const wchar_t *pattern, BOOL verbose);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkZipW_UnzipMatchingAsync(HCkZipW cHandle, const wchar_t *dirPath, const wchar_t *pattern, BOOL verbose);

CK_C_VISIBLE_PUBLIC int
CkZipW_UnzipMatchingInto(HCkZipW cHandle, const wchar_t *dirPath, const wchar_t *pattern, BOOL verbose);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkZipW_UnzipMatchingIntoAsync(HCkZipW cHandle, const wchar_t *dirPath, const wchar_t *pattern, BOOL verbose);
...
CK_C_VISIBLE_PUBLIC BOOL
CkZipW_WriteExe2(HCkZipW cHandle, const wchar_t *exePath, const wchar_t *destExePath, BOOL bAesEncrypt, int keyLength,
