...
CkKeyContainerW_CreateContainer(HCkKeyContainerW cHandle, const wchar_t *name, BOOL machineKeyset);
...
CK_C_VISIBLE_PUBLIC BOOL
CkKeyContainerW_GenerateKeyPair(HCkKeyContainerW cHandle, BOOL bKeyExchangePair, int keyLengthInBits);
...
CK_C_VISIBLE_PUBLIC BOOL
CkKeyContainerW_GetNthContainerName(HCkKeyContainerW cHandle, BOOL bMachineKeyset, int index, HCkString outName);

CK_C_VISIBLE_PUBLIC const wchar_t *
CkKeyContainerW_getNthContainerName(HCkKeyContainerW cHandle, BOOL bMachineKeyset, int index);
...
CK_C_VISIBLE_PUBLIC BOOL
CkKeyContainerW_ImportPrivateKey(HCkKeyContainerW cHandle, HCkPrivateKeyW key, BOOL bKeyExchangePair);

#endif
#if defined(CK_CRYPTOAPI_INCLUDED)

CK_C_VISIBLE_PUBLIC BOOL
CkKeyContainerW_ImportPublicKey(HCkKeyContainerW cHandle, HCkPublicKeyW key, BOOL bKeyExchangePair);

#endif
#if defined(CK_CRYPTOAPI_INCLUDED)

CK_C_VISIBLE_PUBLIC BOOL
CkKeyContainerW_OpenContainer(HCkKeyContainerW cHandle, const wchar_t *name, BOOL needPrivateKeyAccess,
                              BOOL machineKeyset);
