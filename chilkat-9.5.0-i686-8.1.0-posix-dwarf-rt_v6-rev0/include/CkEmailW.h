...
public:
    ...
    bool
    AddRelatedDataP(const wchar_t *nameInHtml, const void *pBytes, unsigned long szBytes, CkString &outStrContentId);
    ...
    // Please see the examples at the following pages for detailed information:
    bool AspUnpack2(const wchar_t *prefix, const wchar_t *saveDir, const wchar_t *urlPath, bool cleanFiles,
                    CkByteData &outHtml);
    ...
    //
    bool GetNthBinaryPartOfType(int index, const wchar_t *contentType, bool inlineOnly, bool excludeAttachments,
                                CkByteData &outBytes);
    ...
    // those parts that are the attachments will (of course) be missing.
    //
    bool GetNthTextPartOfType(int index, const wchar_t *contentType, bool inlineOnly, bool excludeAttachments,
                              CkString &outStr);
    ...
    //
    const wchar_t *
    getNthTextPartOfType(int index, const wchar_t *contentType, bool inlineOnly, bool excludeAttachments);
    ...
    bool SetBinaryBody(CkByteData &byteData, const wchar_t *contentType, const wchar_t *disposition,
