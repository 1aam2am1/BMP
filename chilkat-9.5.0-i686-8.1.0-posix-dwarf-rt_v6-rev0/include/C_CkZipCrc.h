...
CkZipCrc_setProgressInfo(HCkZipCrc cHandle, void (*fnProgressInfo)(const char *name, const char *value));
...
CK_C_VISIBLE_PUBLIC void
CkZipCrc_setPercentDone2(HCkZipCrc cHandle, BOOL (*fnPercentDone2)(int pctDone, void *pContext));

CK_C_VISIBLE_PUBLIC void CkZipCrc_setProgressInfo2(HCkZipCrc cHandle,
                                                   void (*fnProgressInfo2)(const char *name, const char *value,
                                                                           void *pContext));

CK_C_VISIBLE_PUBLIC void
CkZipCrc_setTaskCompleted2(HCkZipCrc cHandle, void (*fnTaskCompleted2)(HCkTask hTask, void *pContext));
