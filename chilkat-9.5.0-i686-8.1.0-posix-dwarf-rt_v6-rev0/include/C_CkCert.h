...
CkCert_ExportToPfxBd(HCkCert cHandle, const char *password, BOOL includeCertChain, HCkBinData pfxData);

CK_C_VISIBLE_PUBLIC BOOL
CkCert_ExportToPfxData(HCkCert cHandle, const char *password, BOOL includeCertChain, HCkByteData outBytes);

CK_C_VISIBLE_PUBLIC BOOL
CkCert_ExportToPfxFile(HCkCert cHandle, const char *pfxFilename, const char *pfxPassword, BOOL bIncludeCertChain);
...
CK_C_VISIBLE_PUBLIC BOOL
CkCert_GetSpkiFingerprint(HCkCert cHandle, const char *hashAlg, const char *encoding, HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkCert_HashOf(HCkCert cHandle, const char *part, const char *hashAlg, const char *encoding, HCkString outStr);

CK_C_VISIBLE_PUBLIC const char *
CkCert_hashOf(HCkCert cHandle, const char *part, const char *hashAlg, const char *encoding);
...
CK_C_VISIBLE_PUBLIC BOOL
CkCert_LinkPrivateKey(HCkCert cHandle, const char *keyContainerName, BOOL bMachineKeyset, BOOL bForSigning);
...
CK_C_VISIBLE_PUBLIC BOOL
CkCert_LoadByIssuerAndSerialNumber(HCkCert cHandle, const char *issuerCN, const char *serialNumber);
...
CK_C_VISIBLE_PUBLIC BOOL
CkCert_LoadPfxData2(HCkCert cHandle, const void *pByteData, unsigned long szByteData, const char *password);
