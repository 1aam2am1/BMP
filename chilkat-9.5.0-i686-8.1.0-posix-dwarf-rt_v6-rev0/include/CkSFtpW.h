...
public:
    ...
    // all of the iso-8859-* encodings, or the Windows-* encodings.
    //
    bool ReadFileText64s(const wchar_t *handle, const wchar_t *offset, int numBytes, const wchar_t *charset,
                         CkString &outStr);
    ...
    // The caller is responsible for deleting the object returned by this method.
    CkTaskW *
    SetOwnerAndGroupAsync(const wchar_t *pathOrHandle, bool isHandle, const wchar_t *owner, const wchar_t *group);
    ...
    // The caller is responsible for deleting the object returned by this method.
    CkTaskW *
    UploadSbAsync(CkStringBuilderW &sb, const wchar_t *remoteFilePath, const wchar_t *charset, bool includeBom);
    ...
    // <http://www.chilkatsoft.com/p/p_463.asp> .
    bool
    WriteFileText64s(const wchar_t *handle, const wchar_t *offset64, const wchar_t *charset, const wchar_t *textData);
