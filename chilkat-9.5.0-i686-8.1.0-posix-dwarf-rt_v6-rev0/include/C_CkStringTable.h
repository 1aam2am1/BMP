...
CkStringTable_AppendFromFile(HCkStringTable cHandle, int maxLineLen, const char *charset, const char *path);
...
CkStringTable_FindSubstring(HCkStringTable cHandle, int startIndex, const char *substr, BOOL caseSensitive);
...
CK_C_VISIBLE_PUBLIC BOOL
CkStringTable_SaveToFile(HCkStringTable cHandle, const char *charset, BOOL bCrlf, const char *path);

CK_C_VISIBLE_PUBLIC BOOL
CkStringTable_SplitAndAppend(HCkStringTable cHandle, const char *inStr, const char *delimiterChar,
