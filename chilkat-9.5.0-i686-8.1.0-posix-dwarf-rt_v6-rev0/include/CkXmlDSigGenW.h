...
public:
    ...
    // only.
    //
    bool AddEnvelopedRef(const wchar_t *id, CkStringBuilderW &content, const wchar_t *digestMethod,
                         const wchar_t *canonMethod, const wchar_t *refType);
    ...
    //
    bool
    AddExternalBinaryRef(const wchar_t *uri, CkBinDataW &content, const wchar_t *digestMethod, const wchar_t *refType);
    ...
    // only.
    //
    bool AddExternalFileRef(const wchar_t *uri, const wchar_t *localFilePath, const wchar_t *digestMethod,
    ...
    // only.
    //
    bool AddExternalTextRef(const wchar_t *uri, CkStringBuilderW &content, const wchar_t *charset, bool includeBom,
    ...
    // only.
    //
    bool AddExternalXmlRef(const wchar_t *uri, CkStringBuilderW &content, const wchar_t *digestMethod,
                           const wchar_t *canonMethod, const wchar_t *refType);
    ...
    //
    bool
    AddObjectRef(const wchar_t *id, const wchar_t *digestMethod, const wchar_t *canonMethod, const wchar_t *prefixList,
                 const wchar_t *refType);
    ...
    //
    bool
    AddSameDocRef(const wchar_t *id, const wchar_t *digestMethod, const wchar_t *canonMethod, const wchar_t *prefixList,
                  const wchar_t *refType);
