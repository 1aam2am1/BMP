...
public:
    ...
    // The caller is responsible for deleting the object returned by this method.
    CkTaskW *
    AppendFileFromTextDataAsync(const wchar_t *remoteFilename, const wchar_t *textData, const wchar_t *charset);
    ...
    // The caller is responsible for deleting the object returned by this method.
    CkTaskW *
    PutFileSbAsync(CkStringBuilderW &sb, const wchar_t *charset, bool includeBom, const wchar_t *remoteFilePath);
