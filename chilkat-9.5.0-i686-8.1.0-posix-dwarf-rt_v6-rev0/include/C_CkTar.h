...
CkTar_setProgressInfo(HCkTar cHandle, void (*fnProgressInfo)(const char *name, const char *value));
...
CK_C_VISIBLE_PUBLIC void
CkTar_setProgressInfo2(HCkTar cHandle, void (*fnProgressInfo2)(const char *name, const char *value, void *pContext));

CK_C_VISIBLE_PUBLIC void
CkTar_setTaskCompleted2(HCkTar cHandle, void (*fnTaskCompleted2)(HCkTask hTask, void *pContext));
...
CkTar_CreateDeb(HCkTar cHandle, const char *controlPath, const char *dataPath, const char *debPath);
...
CK_C_VISIBLE_PUBLIC BOOL
CkTar_UntarFirstMatchingToBd(HCkTar cHandle, const char *tarPath, const char *matchPattern, HCkBinData bd);

CK_C_VISIBLE_PUBLIC BOOL
CkTar_UntarFirstMatchingToMemory(HCkTar cHandle, HCkByteData tarFileBytes, const char *matchPattern,
