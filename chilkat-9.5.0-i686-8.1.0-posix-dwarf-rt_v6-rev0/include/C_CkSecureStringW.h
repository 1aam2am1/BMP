...
CkSecureStringW_LoadFile(HCkSecureStringW cHandle, const wchar_t *path, const wchar_t *charset);

CK_C_VISIBLE_PUBLIC BOOL CkSecureStringW_SecStrEquals(HCkSecureStringW cHandle, HCkSecureStringW secStr);

CK_C_VISIBLE_PUBLIC BOOL
CkSecureStringW_VerifyHash(HCkSecureStringW cHandle, const wchar_t *hashVal, const wchar_t *encoding);
