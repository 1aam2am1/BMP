...
CkLogW_LogDataBase64_2(HCkLogW cHandle, const wchar_t *tag, const void *pByteData, unsigned long szByteData);

CK_C_VISIBLE_PUBLIC void CkLogW_LogDataHex(HCkLogW cHandle, const wchar_t *tag, HCkByteData data);

CK_C_VISIBLE_PUBLIC void
CkLogW_LogDataHex2(HCkLogW cHandle, const wchar_t *tag, const void *pByteData, unsigned long szByteData);

CK_C_VISIBLE_PUBLIC void
CkLogW_LogDataMax(HCkLogW cHandle, const wchar_t *tag, const wchar_t *message, int maxNumChars);
...
CK_C_VISIBLE_PUBLIC void
CkLogW_LogHash2(HCkLogW cHandle, const wchar_t *tag, const wchar_t *hashAlg, const void *pByteData,
