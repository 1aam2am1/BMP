...
CkDkimW_setProgressInfo(HCkDkimW cHandle, void (*fnProgressInfo)(const wchar_t *name, const wchar_t *value));
...
CkDkimW_LoadDkimPk(HCkDkimW cHandle, const wchar_t *privateKey, const wchar_t *optionalPassword);

CK_C_VISIBLE_PUBLIC BOOL
CkDkimW_LoadDkimPkBytes(HCkDkimW cHandle, HCkByteData privateKeyDer, const wchar_t *optionalPassword);

CK_C_VISIBLE_PUBLIC BOOL
CkDkimW_LoadDkimPkFile(HCkDkimW cHandle, const wchar_t *privateKeyFilePath, const wchar_t *optionalPassword);

CK_C_VISIBLE_PUBLIC BOOL
CkDkimW_LoadDomainKeyPk(HCkDkimW cHandle, const wchar_t *privateKey, const wchar_t *optionalPassword);

CK_C_VISIBLE_PUBLIC BOOL
CkDkimW_LoadDomainKeyPkBytes(HCkDkimW cHandle, HCkByteData privateKeyDer, const wchar_t *optionalPassword);

CK_C_VISIBLE_PUBLIC BOOL
CkDkimW_LoadDomainKeyPkFile(HCkDkimW cHandle, const wchar_t *privateKeyFilePath, const wchar_t *optionalPassword);

CK_C_VISIBLE_PUBLIC BOOL
CkDkimW_LoadPublicKey(HCkDkimW cHandle, const wchar_t *selector, const wchar_t *domain, const wchar_t *publicKey);

CK_C_VISIBLE_PUBLIC BOOL CkDkimW_LoadPublicKeyFile(HCkDkimW cHandle, const wchar_t *selector, const wchar_t *domain,
                                                   const wchar_t *publicKeyFilepath);
...
CkDkimW_PrefetchPublicKeyAsync(HCkDkimW cHandle, const wchar_t *selector, const wchar_t *domain);
...
CK_C_VISIBLE_PUBLIC HCkTaskW
CkDkimW_VerifyDomainKeySignatureAsync(HCkDkimW cHandle, int sigIndex, HCkByteData mimeData);
