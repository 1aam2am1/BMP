...
CkRss_setProgressInfo(HCkRss cHandle, void (*fnProgressInfo)(const char *name, const char *value));
...
CK_C_VISIBLE_PUBLIC void
CkRss_setProgressInfo2(HCkRss cHandle, void (*fnProgressInfo2)(const char *name, const char *value, void *pContext));

CK_C_VISIBLE_PUBLIC void
CkRss_setTaskCompleted2(HCkRss cHandle, void (*fnTaskCompleted2)(HCkTask hTask, void *pContext));
...
CkRss_MGetAttr(HCkRss cHandle, const char *tag, int index, const char *attrName, HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkRss_MSetAttr(HCkRss cHandle, const char *tag, int idx, const char *attrName, const char *value);
