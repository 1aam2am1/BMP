...
CkHttpResponse_GetHeaderField(HCkHttpResponse cHandle, const char *fieldName, HCkString outStr);

CK_C_VISIBLE_PUBLIC const char *CkHttpResponse_getHeaderField(HCkHttpResponse cHandle, const char *fieldName);

CK_C_VISIBLE_PUBLIC BOOL
CkHttpResponse_GetHeaderFieldAttr(HCkHttpResponse cHandle, const char *fieldName, const char *attrName,
                                  HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkHttpResponse_UrlEncParamValue(HCkHttpResponse cHandle, const char *encodedParamString, const char *paramName,
                                HCkString outStr);
