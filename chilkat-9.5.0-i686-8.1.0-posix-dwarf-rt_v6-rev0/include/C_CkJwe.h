...
CkJwe_EncryptSb(HCkJwe cHandle, HCkStringBuilder contentSb, const char *charset, HCkStringBuilder jweSb);

CK_C_VISIBLE_PUBLIC int
CkJwe_FindRecipient(HCkJwe cHandle, const char *paramName, const char *paramValue, BOOL caseSensitive);
