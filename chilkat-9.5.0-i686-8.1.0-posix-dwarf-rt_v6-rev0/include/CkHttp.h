...
public:
    ...
    //
    bool CreateTimestampRequest(const char *hashAlg, const char *hashVal, const char *reqPolicyOid, bool addNonce,
                                bool reqTsaCert, CkBinData &tmestampToken);
    ...
    // email address.
    //
    bool G_SvcOauthAccessToken(const char *iss, const char *scope, const char *subEmail, int numSec, CkCert &cert,
                               CkString &outStr);
    ...
    //
    const char *
    g_SvcOauthAccessToken(const char *iss, const char *scope, const char *subEmail, int numSec, CkCert &cert);
    ...
    //
    CkTask *
    G_SvcOauthAccessTokenAsync(const char *iss, const char *scope, const char *subEmail, int numSec, CkCert &cert);
    ...
    // The caller is responsible for deleting the object returned by this method.
    CkHttpResponse *
    PBinary(const char *verb, const char *url, CkByteData &byteData, const char *contentType, bool md5, bool gzip);
    ...
    // that the request data needs to be ungzipped when received (at the server).
    CkTask *
    PBinaryAsync(const char *verb, const char *url, CkByteData &byteData, const char *contentType, bool md5, bool gzip);


    // The same as PBinary, but the data to be uploaded is passed in data.
    // The caller is responsible for deleting the object returned by this method.
    CkHttpResponse *
    PBinaryBd(const char *verb, const char *url, CkBinData &data, const char *contentType, bool md5, bool gzip);

    // The same as PBinary, but the data to be uploaded is passed in data.
    CkTask *
    PBinaryBdAsync(const char *verb, const char *url, CkBinData &data, const char *contentType, bool md5, bool gzip);
    ...
    //
    bool
    PostBinary(const char *url, CkByteData &byteData, const char *contentType, bool md5, bool gzip, CkString &outStr);
    ...
    // The caller is responsible for deleting the object returned by this method.
    CkHttpResponse *
    PText(const char *verb, const char *url, const char *textData, const char *charset, const char *contentType,
          bool md5, bool gzip);
    ...
    // that the request data needs to be ungzipped when received (at the server).
    CkTask *
    PTextAsync(const char *verb, const char *url, const char *textData, const char *charset, const char *contentType,
               bool md5, bool gzip);
    ...
    // The caller is responsible for deleting the object returned by this method.
    CkHttpResponse *
    PTextSb(const char *verb, const char *url, CkStringBuilder &textData, const char *charset, const char *contentType,
            bool md5, bool gzip);

    // The same as PText, but the data to be uploaded is passed in textData.
    CkTask *PTextSbAsync(const char *verb, const char *url, CkStringBuilder &textData, const char *charset,
    ...
    //
    bool
    PutBinary(const char *url, CkByteData &byteData, const char *contentType, bool md5, bool gzip, CkString &outStr);
    ...
    //
    bool
    PutText(const char *url, const char *textData, const char *charset, const char *contentType, bool md5, bool gzip,
            CkString &outStr);
    ...
    // response object).
    //
    CkTask *PutTextAsync(const char *url, const char *textData, const char *charset, const char *contentType, bool md5,
                         bool gzip);
    ...
    //
    bool S3_GenerateUrlV4(bool useHttps, const char *bucketName, const char *path, int numSecondsValid,
                          const char *awsService, CkString &outStr);
    ...
    // Note: This method can only generate URLs that are for HTTP GET requests (i.e. URLs you can paste into a browser address bar).  This method does not generate URLs for POST, PUT, DELETE, etc.
    //
    const char *s3_GenerateUrlV4(bool useHttps, const char *bucketName, const char *path, int numSecondsValid,
    ...
    //
    bool
    S3_UploadBytes(CkByteData &contentBytes, const char *contentType, const char *bucketPath, const char *objectName);
    ...
    // methods, even if not explicitly stated.
    //
    CkTask *S3_UploadBytesAsync(CkByteData &contentBytes, const char *contentType, const char *bucketPath,
    ...
    //
    bool
    S3_UploadFile(const char *localFilePath, const char *contentType, const char *bucketPath, const char *objectName);
    ...
    // methods, even if not explicitly stated.
    //
    CkTask *S3_UploadFileAsync(const char *localFilePath, const char *contentType, const char *bucketPath,
                               const char *objectName);
    ...
    //
    bool
    S3_UploadString(const char *objectContent, const char *charset, const char *contentType, const char *bucketPath,
                    const char *objectName);
    ...
    // methods, even if not explicitly stated.
    //
    CkTask *S3_UploadStringAsync(const char *objectContent, const char *charset, const char *contentType,
    ...
    //
    bool
    SharePointOnlineAuth(const char *siteUrl, const char *username, CkSecureString &password, CkJsonObject &extraInfo);
    ...
    // providing additional information as needed in the future.
    //
    CkTask *SharePointOnlineAuthAsync(const char *siteUrl, const char *username, CkSecureString &password,
                                      CkJsonObject &extraInfo);
