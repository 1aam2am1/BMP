...
CkCompression_setProgressInfo(HCkCompression cHandle, void (*fnProgressInfo)(const char *name, const char *value));
...
CK_C_VISIBLE_PUBLIC void
CkCompression_setPercentDone2(HCkCompression cHandle, BOOL (*fnPercentDone2)(int pctDone, void *pContext));

CK_C_VISIBLE_PUBLIC void CkCompression_setProgressInfo2(HCkCompression cHandle,
                                                        void (*fnProgressInfo2)(const char *name, const char *value,
                                                                                void *pContext));

CK_C_VISIBLE_PUBLIC void
CkCompression_setTaskCompleted2(HCkCompression cHandle, void (*fnTaskCompleted2)(HCkTask hTask, void *pContext));
...
CkCompression_BeginCompressBytes(HCkCompression cHandle, HCkByteData data, HCkByteData outData);

CK_C_VISIBLE_PUBLIC HCkTask CkCompression_BeginCompressBytesAsync(HCkCompression cHandle, HCkByteData data);

CK_C_VISIBLE_PUBLIC BOOL
CkCompression_BeginCompressBytes2(HCkCompression cHandle, const void *pByteData, unsigned long szByteData,
                                  HCkByteData outBytes);

CK_C_VISIBLE_PUBLIC BOOL
CkCompression_BeginCompressBytesENC(HCkCompression cHandle, HCkByteData data, HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkCompression_BeginCompressString(HCkCompression cHandle, const char *str, HCkByteData outData);

CK_C_VISIBLE_PUBLIC HCkTask CkCompression_BeginCompressStringAsync(HCkCompression cHandle, const char *str);

CK_C_VISIBLE_PUBLIC BOOL
CkCompression_BeginCompressStringENC(HCkCompression cHandle, const char *str, HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkCompression_BeginDecompressBytes(HCkCompression cHandle, HCkByteData data, HCkByteData outData);

CK_C_VISIBLE_PUBLIC HCkTask CkCompression_BeginDecompressBytesAsync(HCkCompression cHandle, HCkByteData data);

CK_C_VISIBLE_PUBLIC BOOL
CkCompression_BeginDecompressBytes2(HCkCompression cHandle, const void *pByteData, unsigned long szByteData,
                                    HCkByteData outBytes);

CK_C_VISIBLE_PUBLIC BOOL
CkCompression_BeginDecompressBytesENC(HCkCompression cHandle, const char *str, HCkByteData outData);

CK_C_VISIBLE_PUBLIC HCkTask CkCompression_BeginDecompressBytesENCAsync(HCkCompression cHandle, const char *str);

CK_C_VISIBLE_PUBLIC BOOL
CkCompression_BeginDecompressString(HCkCompression cHandle, HCkByteData data, HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkCompression_BeginDecompressStringENC(HCkCompression cHandle, const char *str, HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkCompression_CompressBytes2(HCkCompression cHandle, const void *pByteData, unsigned long szByteData,
                             HCkByteData outBytes);
...
CkCompression_CompressFileAsync(HCkCompression cHandle, const char *srcPath, const char *destPath);

CK_C_VISIBLE_PUBLIC BOOL CkCompression_CompressSb(HCkCompression cHandle, HCkStringBuilder sb, HCkBinData binData);

CK_C_VISIBLE_PUBLIC HCkTask
CkCompression_CompressSbAsync(HCkCompression cHandle, HCkStringBuilder sb, HCkBinData binData);
...
CK_C_VISIBLE_PUBLIC BOOL
CkCompression_DecompressBytes2(HCkCompression cHandle, const void *pByteData, unsigned long szByteData,
                               HCkByteData outBytes);

CK_C_VISIBLE_PUBLIC BOOL
CkCompression_DecompressBytesENC(HCkCompression cHandle, const char *encodedCompressedData, HCkByteData outData);

CK_C_VISIBLE_PUBLIC HCkTask
CkCompression_DecompressBytesENCAsync(HCkCompression cHandle, const char *encodedCompressedData);

CK_C_VISIBLE_PUBLIC BOOL
CkCompression_DecompressFile(HCkCompression cHandle, const char *srcPath, const char *destPath);

CK_C_VISIBLE_PUBLIC HCkTask
CkCompression_DecompressFileAsync(HCkCompression cHandle, const char *srcPath, const char *destPath);

CK_C_VISIBLE_PUBLIC BOOL CkCompression_DecompressSb(HCkCompression cHandle, HCkBinData binData, HCkStringBuilder sb);

CK_C_VISIBLE_PUBLIC HCkTask
CkCompression_DecompressSbAsync(HCkCompression cHandle, HCkBinData binData, HCkStringBuilder sb);
...
CK_C_VISIBLE_PUBLIC BOOL
CkCompression_DecompressStringENC(HCkCompression cHandle, const char *encodedCompressedData, HCkString outStr);

CK_C_VISIBLE_PUBLIC const char *
CkCompression_decompressStringENC(HCkCompression cHandle, const char *encodedCompressedData);

CK_C_VISIBLE_PUBLIC HCkTask
CkCompression_DecompressStringENCAsync(HCkCompression cHandle, const char *encodedCompressedData);
...
CK_C_VISIBLE_PUBLIC BOOL
CkCompression_MoreCompressBytes2(HCkCompression cHandle, const void *pByteData, unsigned long szByteData,
                                 HCkByteData outBytes);
...
CK_C_VISIBLE_PUBLIC BOOL
CkCompression_MoreDecompressBytes(HCkCompression cHandle, HCkByteData data, HCkByteData outData);

CK_C_VISIBLE_PUBLIC HCkTask CkCompression_MoreDecompressBytesAsync(HCkCompression cHandle, HCkByteData data);

CK_C_VISIBLE_PUBLIC BOOL
CkCompression_MoreDecompressBytes2(HCkCompression cHandle, const void *pByteData, unsigned long szByteData,
                                   HCkByteData outBytes);

CK_C_VISIBLE_PUBLIC BOOL
CkCompression_MoreDecompressBytesENC(HCkCompression cHandle, const char *str, HCkByteData outData);
...
CK_C_VISIBLE_PUBLIC BOOL
CkCompression_MoreDecompressStringENC(HCkCompression cHandle, const char *str, HCkString outStr);
