...
CkStringBuilderW_AppendBd(HCkStringBuilderW cHandle, HCkBinDataW binData, const wchar_t *charset, int offset,
                          int numBytes);

CK_C_VISIBLE_PUBLIC BOOL
CkStringBuilderW_AppendEncoded(HCkStringBuilderW cHandle, HCkByteData binaryData, const wchar_t *encoding);
...
CK_C_VISIBLE_PUBLIC BOOL
CkStringBuilderW_ContainsWord(HCkStringBuilderW cHandle, const wchar_t *word, BOOL caseSensitive);

CK_C_VISIBLE_PUBLIC BOOL
CkStringBuilderW_ContentsEqual(HCkStringBuilderW cHandle, const wchar_t *str, BOOL caseSensitive);

CK_C_VISIBLE_PUBLIC BOOL
CkStringBuilderW_ContentsEqualSb(HCkStringBuilderW cHandle, HCkStringBuilderW sb, BOOL caseSensitive);

CK_C_VISIBLE_PUBLIC BOOL
CkStringBuilderW_Decode(HCkStringBuilderW cHandle, const wchar_t *encoding, const wchar_t *charset);

CK_C_VISIBLE_PUBLIC BOOL
CkStringBuilderW_Encode(HCkStringBuilderW cHandle, const wchar_t *encoding, const wchar_t *charset);

CK_C_VISIBLE_PUBLIC BOOL
CkStringBuilderW_EndsWith(HCkStringBuilderW cHandle, const wchar_t *substr, BOOL caseSensitive);

CK_C_VISIBLE_PUBLIC BOOL CkStringBuilderW_EntityDecode(HCkStringBuilderW cHandle);

CK_C_VISIBLE_PUBLIC BOOL
CkStringBuilderW_GetAfterBetween(HCkStringBuilderW cHandle, const wchar_t *searchAfter, const wchar_t *beginMark,
                                 const wchar_t *endMark, HCkString outStr);

CK_C_VISIBLE_PUBLIC const wchar_t *
CkStringBuilderW_getAfterBetween(HCkStringBuilderW cHandle, const wchar_t *searchAfter, const wchar_t *beginMark,
                                 const wchar_t *endMark);

CK_C_VISIBLE_PUBLIC BOOL
CkStringBuilderW_GetAfterFinal(HCkStringBuilderW cHandle, const wchar_t *marker, BOOL removeFlag, HCkString outStr);

CK_C_VISIBLE_PUBLIC const wchar_t *
CkStringBuilderW_getAfterFinal(HCkStringBuilderW cHandle, const wchar_t *marker, BOOL removeFlag);
...
CK_C_VISIBLE_PUBLIC BOOL
CkStringBuilderW_GetBefore(HCkStringBuilderW cHandle, const wchar_t *marker, BOOL removeFlag, HCkString outStr);

CK_C_VISIBLE_PUBLIC const wchar_t *
CkStringBuilderW_getBefore(HCkStringBuilderW cHandle, const wchar_t *marker, BOOL removeFlag);

CK_C_VISIBLE_PUBLIC BOOL
CkStringBuilderW_GetBetween(HCkStringBuilderW cHandle, const wchar_t *beginMark, const wchar_t *endMark,
                            HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkStringBuilderW_GetDecoded(HCkStringBuilderW cHandle, const wchar_t *encoding, HCkByteData outBytes);

CK_C_VISIBLE_PUBLIC BOOL
CkStringBuilderW_GetEncoded(HCkStringBuilderW cHandle, const wchar_t *encoding, const wchar_t *charset,
                            HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkStringBuilderW_GetNth(HCkStringBuilderW cHandle, int index, const wchar_t *delimiterChar, BOOL exceptDoubleQuoted,
                        BOOL exceptEscaped, HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkStringBuilderW_LastNLines(HCkStringBuilderW cHandle, int numLines, BOOL bCrlf, HCkString outStr);

CK_C_VISIBLE_PUBLIC const wchar_t *CkStringBuilderW_lastNLines(HCkStringBuilderW cHandle, int numLines, BOOL bCrlf);

CK_C_VISIBLE_PUBLIC BOOL
CkStringBuilderW_LoadFile(HCkStringBuilderW cHandle, const wchar_t *path, const wchar_t *charset);
...
CkStringBuilderW_Replace(HCkStringBuilderW cHandle, const wchar_t *value, const wchar_t *replacement);

CK_C_VISIBLE_PUBLIC BOOL
CkStringBuilderW_ReplaceAfterFinal(HCkStringBuilderW cHandle, const wchar_t *marker, const wchar_t *replacement);

CK_C_VISIBLE_PUBLIC BOOL
CkStringBuilderW_ReplaceAllBetween(HCkStringBuilderW cHandle, const wchar_t *beginMark, const wchar_t *endMark,
                                   const wchar_t *replacement, BOOL replaceMarks);

CK_C_VISIBLE_PUBLIC int
CkStringBuilderW_ReplaceBetween(HCkStringBuilderW cHandle, const wchar_t *beginMark, const wchar_t *endMark,
                                const wchar_t *value, const wchar_t *replacement);

CK_C_VISIBLE_PUBLIC BOOL
CkStringBuilderW_ReplaceFirst(HCkStringBuilderW cHandle, const wchar_t *value, const wchar_t *replacement);

CK_C_VISIBLE_PUBLIC int CkStringBuilderW_ReplaceI(HCkStringBuilderW cHandle, const wchar_t *value, int replacement);

CK_C_VISIBLE_PUBLIC int
CkStringBuilderW_ReplaceNoCase(HCkStringBuilderW cHandle, const wchar_t *value, const wchar_t *replacement);

CK_C_VISIBLE_PUBLIC int
CkStringBuilderW_ReplaceWord(HCkStringBuilderW cHandle, const wchar_t *value, const wchar_t *replacement);

CK_C_VISIBLE_PUBLIC void CkStringBuilderW_SecureClear(HCkStringBuilderW cHandle);

CK_C_VISIBLE_PUBLIC BOOL
CkStringBuilderW_SetNth(HCkStringBuilderW cHandle, int index, const wchar_t *value, const wchar_t *delimiterChar,
                        BOOL exceptDoubleQuoted, BOOL exceptEscaped);

CK_C_VISIBLE_PUBLIC BOOL CkStringBuilderW_SetString(HCkStringBuilderW cHandle, const wchar_t *value);

CK_C_VISIBLE_PUBLIC BOOL
CkStringBuilderW_StartsWith(HCkStringBuilderW cHandle, const wchar_t *substr, BOOL caseSensitive);
...
CK_C_VISIBLE_PUBLIC BOOL
CkStringBuilderW_WriteFile(HCkStringBuilderW cHandle, const wchar_t *path, const wchar_t *charset, BOOL emitBom);

CK_C_VISIBLE_PUBLIC BOOL
CkStringBuilderW_WriteFileIfModified(HCkStringBuilderW cHandle, const wchar_t *path, const wchar_t *charset,
                                     BOOL emitBom);
