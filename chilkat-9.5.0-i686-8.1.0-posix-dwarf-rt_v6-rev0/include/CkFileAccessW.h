...
public:
    ...
    //
    bool FileOpen(const wchar_t *filePath, unsigned long accessMode, unsigned long shareMode,
    ...
    //
    int ReadNextFragment(bool startAtBeginning, const wchar_t *beginMarker, const wchar_t *endMarker,
                         const wchar_t *charset, CkStringBuilderW &sb);

    // Reassembles a file previously split by the SplitFile method.
    bool ReassembleFile(const wchar_t *partsDirPath, const wchar_t *partPrefix, const wchar_t *partExtension,
    ...
    int ReplaceStrings(const wchar_t *filePath, const wchar_t *charset, const wchar_t *existingString,
                       const wchar_t *replacementString);
    ...
    bool SetFileTimes(const wchar_t *filePath, CkDateTimeW &createTime, CkDateTimeW &lastAccessTime,
                      CkDateTimeW &lastModTime);
    ...
    bool SplitFile(const wchar_t *fileToSplit, const wchar_t *partPrefix, const wchar_t *partExtension, int partSize,
    ...
    bool WriteEntireTextFile(const wchar_t *filePath, const wchar_t *textData, const wchar_t *charset,
