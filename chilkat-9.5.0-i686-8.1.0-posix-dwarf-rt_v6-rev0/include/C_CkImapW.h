...
CkImapW_setProgressInfo(HCkImapW cHandle, void (*fnProgressInfo)(const wchar_t *name, const wchar_t *value));
...
CkImapW_AddPfxSourceFile(HCkImapW cHandle, const wchar_t *pfxFilePath, const wchar_t *pfxPassword);
...
CK_C_VISIBLE_PUBLIC BOOL
CkImapW_AppendMimeWithDate(HCkImapW cHandle, const wchar_t *mailbox, const wchar_t *mimeText, SYSTEMTIME *internalDate);

CK_C_VISIBLE_PUBLIC BOOL
CkImapW_AppendMimeWithDateStr(HCkImapW cHandle, const wchar_t *mailbox, const wchar_t *mimeText,
                              const wchar_t *internalDateStr);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkImapW_AppendMimeWithDateStrAsync(HCkImapW cHandle, const wchar_t *mailbox, const wchar_t *mimeText,
                                   const wchar_t *internalDateStr);

CK_C_VISIBLE_PUBLIC BOOL
CkImapW_AppendMimeWithFlags(HCkImapW cHandle, const wchar_t *mailbox, const wchar_t *mimeText, BOOL seen, BOOL flagged,
                            BOOL answered, BOOL draft);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkImapW_AppendMimeWithFlagsAsync(HCkImapW cHandle, const wchar_t *mailbox, const wchar_t *mimeText, BOOL seen,
                                 BOOL flagged, BOOL answered, BOOL draft);

CK_C_VISIBLE_PUBLIC BOOL
CkImapW_AppendMimeWithFlagsSb(HCkImapW cHandle, const wchar_t *mailbox, HCkStringBuilderW sbMime, BOOL seen,
                              BOOL flagged, BOOL answered, BOOL draft);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkImapW_AppendMimeWithFlagsSbAsync(HCkImapW cHandle, const wchar_t *mailbox, HCkStringBuilderW sbMime, BOOL seen,
                                   BOOL flagged, BOOL answered, BOOL draft);
...
CK_C_VISIBLE_PUBLIC BOOL
CkImapW_CopyMultiple(HCkImapW cHandle, HCkMessageSetW messageSet, const wchar_t *copyToMailbox);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkImapW_CopyMultipleAsync(HCkImapW cHandle, HCkMessageSetW messageSet, const wchar_t *copyToMailbox);

CK_C_VISIBLE_PUBLIC BOOL
CkImapW_CopySequence(HCkImapW cHandle, int startSeqNum, int count, const wchar_t *copyToMailbox);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkImapW_CopySequenceAsync(HCkImapW cHandle, int startSeqNum, int count, const wchar_t *copyToMailbox);
...
CK_C_VISIBLE_PUBLIC BOOL
CkImapW_FetchAttachment(HCkImapW cHandle, HCkEmailW emailObject, int attachmentIndex, const wchar_t *saveToPath);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkImapW_FetchAttachmentAsync(HCkImapW cHandle, HCkEmailW emailObject, int attachmentIndex, const wchar_t *saveToPath);

CK_C_VISIBLE_PUBLIC BOOL
CkImapW_FetchAttachmentBd(HCkImapW cHandle, HCkEmailW email, int attachmentIndex, HCkBinDataW binData);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkImapW_FetchAttachmentBdAsync(HCkImapW cHandle, HCkEmailW email, int attachmentIndex, HCkBinDataW binData);

CK_C_VISIBLE_PUBLIC BOOL
CkImapW_FetchAttachmentBytes(HCkImapW cHandle, HCkEmailW email, int attachIndex, HCkByteData outBytes);

CK_C_VISIBLE_PUBLIC HCkTaskW CkImapW_FetchAttachmentBytesAsync(HCkImapW cHandle, HCkEmailW email, int attachIndex);

CK_C_VISIBLE_PUBLIC BOOL
CkImapW_FetchAttachmentSb(HCkImapW cHandle, HCkEmailW email, int attachmentIndex, const wchar_t *charset,
                          HCkStringBuilderW sb);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkImapW_FetchAttachmentSbAsync(HCkImapW cHandle, HCkEmailW email, int attachmentIndex, const wchar_t *charset,
                               HCkStringBuilderW sb);

CK_C_VISIBLE_PUBLIC BOOL
CkImapW_FetchAttachmentString(HCkImapW cHandle, HCkEmailW emailObject, int attachmentIndex, const wchar_t *charset,
                              HCkString outStr);
...
CK_C_VISIBLE_PUBLIC HCkTaskW
CkImapW_FetchAttachmentStringAsync(HCkImapW cHandle, HCkEmailW emailObject, int attachmentIndex,
...
CK_C_VISIBLE_PUBLIC HCkEmailBundleW
CkImapW_FetchChunk(HCkImapW cHandle, int startSeqNum, int count, HCkMessageSetW failedSet, HCkMessageSetW fetchedSet);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkImapW_FetchChunkAsync(HCkImapW cHandle, int startSeqNum, int count, HCkMessageSetW failedSet,
                        HCkMessageSetW fetchedSet);
...
CK_C_VISIBLE_PUBLIC HCkTaskW
CkImapW_FetchSingleAsMimeSbAsync(HCkImapW cHandle, int msgId, BOOL bUid, HCkStringBuilderW sbMime);
...
CK_C_VISIBLE_PUBLIC BOOL
CkImapW_GetMailAttachFilename(HCkImapW cHandle, HCkEmailW email, int attachIndex, HCkString outStrFilename);
...
CK_C_VISIBLE_PUBLIC BOOL
CkImapW_HasCapability(HCkImapW cHandle, const wchar_t *name, const wchar_t *capabilityResponse);
...
CK_C_VISIBLE_PUBLIC HCkMailboxesW
CkImapW_ListMailboxes(HCkImapW cHandle, const wchar_t *reference, const wchar_t *wildcardedMailbox);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkImapW_ListMailboxesAsync(HCkImapW cHandle, const wchar_t *reference, const wchar_t *wildcardedMailbox);

CK_C_VISIBLE_PUBLIC HCkMailboxesW
CkImapW_ListSubscribed(HCkImapW cHandle, const wchar_t *reference, const wchar_t *wildcardedMailbox);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkImapW_ListSubscribedAsync(HCkImapW cHandle, const wchar_t *reference, const wchar_t *wildcardedMailbox);
...
CK_C_VISIBLE_PUBLIC HCkTaskW
CkImapW_LoginSecureAsync(HCkImapW cHandle, HCkSecureStringW loginName, HCkSecureStringW password);
...
CK_C_VISIBLE_PUBLIC HCkTaskW
CkImapW_MoveMessagesAsync(HCkImapW cHandle, HCkMessageSetW messageSet, const wchar_t *destFolder);
...
CK_C_VISIBLE_PUBLIC HCkTaskW
CkImapW_RenameMailboxAsync(HCkImapW cHandle, const wchar_t *fromMailbox, const wchar_t *toMailbox);
...
CK_C_VISIBLE_PUBLIC HCkTaskW
CkImapW_SetFlagAsync(HCkImapW cHandle, int msgId, BOOL bUid, const wchar_t *flagName, int value);

CK_C_VISIBLE_PUBLIC BOOL
CkImapW_SetFlags(HCkImapW cHandle, HCkMessageSetW messageSet, const wchar_t *flagName, int value);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkImapW_SetFlagsAsync(HCkImapW cHandle, HCkMessageSetW messageSet, const wchar_t *flagName, int value);

CK_C_VISIBLE_PUBLIC BOOL CkImapW_SetMailFlag(HCkImapW cHandle, HCkEmailW email, const wchar_t *flagName, int value);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkImapW_SetMailFlagAsync(HCkImapW cHandle, HCkEmailW email, const wchar_t *flagName, int value);

CK_C_VISIBLE_PUBLIC BOOL
CkImapW_SetQuota(HCkImapW cHandle, const wchar_t *quotaRoot, const wchar_t *resource, int quota);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkImapW_SetQuotaAsync(HCkImapW cHandle, const wchar_t *quotaRoot, const wchar_t *resource, int quota);

CK_C_VISIBLE_PUBLIC BOOL CkImapW_SetSslClientCert(HCkImapW cHandle, HCkCertW cert);

CK_C_VISIBLE_PUBLIC BOOL
CkImapW_SetSslClientCertPem(HCkImapW cHandle, const wchar_t *pemDataOrFilename, const wchar_t *pemPassword);

CK_C_VISIBLE_PUBLIC BOOL
CkImapW_SetSslClientCertPfx(HCkImapW cHandle, const wchar_t *pfxFilename, const wchar_t *pfxPassword);

CK_C_VISIBLE_PUBLIC HCkMessageSetW
CkImapW_Sort(HCkImapW cHandle, const wchar_t *sortCriteria, const wchar_t *charset, const wchar_t *searchCriteria,
             BOOL bUid);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkImapW_SortAsync(HCkImapW cHandle, const wchar_t *sortCriteria, const wchar_t *charset, const wchar_t *searchCriteria,
                  BOOL bUid);

CK_C_VISIBLE_PUBLIC BOOL CkImapW_SshAuthenticatePk(HCkImapW cHandle, const wchar_t *sshLogin, HCkSshKeyW privateKey);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkImapW_SshAuthenticatePkAsync(HCkImapW cHandle, const wchar_t *sshLogin, HCkSshKeyW privateKey);

CK_C_VISIBLE_PUBLIC BOOL
CkImapW_SshAuthenticatePw(HCkImapW cHandle, const wchar_t *sshLogin, const wchar_t *sshPassword);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkImapW_SshAuthenticatePwAsync(HCkImapW cHandle, const wchar_t *sshLogin, const wchar_t *sshPassword);
...
CK_C_VISIBLE_PUBLIC BOOL
CkImapW_StoreFlags(HCkImapW cHandle, int msgId, BOOL bUid, const wchar_t *flagNames, int value);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkImapW_StoreFlagsAsync(HCkImapW cHandle, int msgId, BOOL bUid, const wchar_t *flagNames, int value);
...
CK_C_VISIBLE_PUBLIC HCkJsonObjectW
CkImapW_ThreadCmd(HCkImapW cHandle, const wchar_t *threadAlg, const wchar_t *charset, const wchar_t *searchCriteria,
                  BOOL bUid);

CK_C_VISIBLE_PUBLIC HCkTaskW CkImapW_ThreadCmdAsync(HCkImapW cHandle, const wchar_t *threadAlg, const wchar_t *charset,
                                                    const wchar_t *searchCriteria, BOOL bUid);
