...
CkZipEntry_setProgressInfo(HCkZipEntry cHandle, void (*fnProgressInfo)(const char *name, const char *value));
...
CK_C_VISIBLE_PUBLIC void
CkZipEntry_setPercentDone2(HCkZipEntry cHandle, BOOL (*fnPercentDone2)(int pctDone, void *pContext));

CK_C_VISIBLE_PUBLIC void CkZipEntry_setProgressInfo2(HCkZipEntry cHandle,
                                                     void (*fnProgressInfo2)(const char *name, const char *value,
                                                                             void *pContext));

CK_C_VISIBLE_PUBLIC void
CkZipEntry_setTaskCompleted2(HCkZipEntry cHandle, void (*fnTaskCompleted2)(HCkTask hTask, void *pContext));
...
CkZipEntry_AppendStringAsync(HCkZipEntry cHandle, const char *strContent, const char *charset);
...
CkZipEntry_UnzipToSb(HCkZipEntry cHandle, int lineEndingBehavior, const char *srcCharset, HCkStringBuilder sb);

CK_C_VISIBLE_PUBLIC HCkTask
CkZipEntry_UnzipToSbAsync(HCkZipEntry cHandle, int lineEndingBehavior, const char *srcCharset, HCkStringBuilder sb);
...
CK_C_VISIBLE_PUBLIC BOOL
CkZipEntry_UnzipToString(HCkZipEntry cHandle, int lineEndingBehavior, const char *srcCharset, HCkString outStr);

CK_C_VISIBLE_PUBLIC const char *
CkZipEntry_unzipToString(HCkZipEntry cHandle, int lineEndingBehavior, const char *srcCharset);

CK_C_VISIBLE_PUBLIC HCkTask
CkZipEntry_UnzipToStringAsync(HCkZipEntry cHandle, int lineEndingBehavior, const char *srcCharset);
