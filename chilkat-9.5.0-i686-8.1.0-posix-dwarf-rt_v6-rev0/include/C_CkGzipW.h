...
CkGzipW_setProgressInfo(HCkGzipW cHandle, void (*fnProgressInfo)(const wchar_t *name, const wchar_t *value));
...
CkGzipW_CompressFileAsync(HCkGzipW cHandle, const wchar_t *inFilename, const wchar_t *destPath);

CK_C_VISIBLE_PUBLIC BOOL
CkGzipW_CompressFile2(HCkGzipW cHandle, const wchar_t *inFilename, const wchar_t *embeddedFilename,
                      const wchar_t *destPath);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkGzipW_CompressFile2Async(HCkGzipW cHandle, const wchar_t *inFilename, const wchar_t *embeddedFilename,
                           const wchar_t *destPath);
...
CK_C_VISIBLE_PUBLIC HCkTaskW
CkGzipW_CompressMemToFileAsync(HCkGzipW cHandle, HCkByteData inData, const wchar_t *destPath);

CK_C_VISIBLE_PUBLIC BOOL
CkGzipW_CompressString(HCkGzipW cHandle, const wchar_t *inStr, const wchar_t *destCharset, HCkByteData outBytes);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkGzipW_CompressStringAsync(HCkGzipW cHandle, const wchar_t *inStr, const wchar_t *destCharset);

CK_C_VISIBLE_PUBLIC BOOL
CkGzipW_CompressStringENC(HCkGzipW cHandle, const wchar_t *inStr, const wchar_t *charset, const wchar_t *encoding,
                          HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkGzipW_CompressStringToFile(HCkGzipW cHandle, const wchar_t *inStr, const wchar_t *destCharset,
                             const wchar_t *destPath);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkGzipW_CompressStringToFileAsync(HCkGzipW cHandle, const wchar_t *inStr, const wchar_t *destCharset,
                                  const wchar_t *destPath);

CK_C_VISIBLE_PUBLIC BOOL
CkGzipW_Decode(HCkGzipW cHandle, const wchar_t *encodedStr, const wchar_t *encoding, HCkByteData outBytes);

CK_C_VISIBLE_PUBLIC BOOL CkGzipW_DeflateStringENC(HCkGzipW cHandle, const wchar_t *inString, const wchar_t *charsetName,
                                                  const wchar_t *outputEncoding, HCkString outStr);

CK_C_VISIBLE_PUBLIC const wchar_t *
CkGzipW_deflateStringENC(HCkGzipW cHandle, const wchar_t *inString, const wchar_t *charsetName,
                         const wchar_t *outputEncoding);

CK_C_VISIBLE_PUBLIC BOOL
CkGzipW_Encode(HCkGzipW cHandle, HCkByteData byteData, const wchar_t *encoding, HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkGzipW_InflateStringENC(HCkGzipW cHandle, const wchar_t *inString, const wchar_t *convertFromCharset,
                         const wchar_t *inputEncoding, HCkString outStr);

CK_C_VISIBLE_PUBLIC const wchar_t *
CkGzipW_inflateStringENC(HCkGzipW cHandle, const wchar_t *inString, const wchar_t *convertFromCharset,
                         const wchar_t *inputEncoding);
...
CK_C_VISIBLE_PUBLIC HCkTaskW
CkGzipW_UncompressFileAsync(HCkGzipW cHandle, const wchar_t *srcPath, const wchar_t *destPath);
...
CK_C_VISIBLE_PUBLIC BOOL
CkGzipW_UncompressFileToString(HCkGzipW cHandle, const wchar_t *gzFilename, const wchar_t *charset, HCkString outStr);

CK_C_VISIBLE_PUBLIC const wchar_t *
CkGzipW_uncompressFileToString(HCkGzipW cHandle, const wchar_t *gzFilename, const wchar_t *charset);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkGzipW_UncompressFileToStringAsync(HCkGzipW cHandle, const wchar_t *gzFilename, const wchar_t *charset);
...
CK_C_VISIBLE_PUBLIC HCkTaskW
CkGzipW_UncompressMemToFileAsync(HCkGzipW cHandle, HCkByteData inData, const wchar_t *destPath);

CK_C_VISIBLE_PUBLIC BOOL
CkGzipW_UncompressString(HCkGzipW cHandle, HCkByteData inData, const wchar_t *inCharset, HCkString outStr);

CK_C_VISIBLE_PUBLIC const wchar_t *
CkGzipW_uncompressString(HCkGzipW cHandle, HCkByteData inData, const wchar_t *inCharset);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkGzipW_UncompressStringAsync(HCkGzipW cHandle, HCkByteData inData, const wchar_t *inCharset);

CK_C_VISIBLE_PUBLIC BOOL
CkGzipW_UncompressStringENC(HCkGzipW cHandle, const wchar_t *inStr, const wchar_t *charset, const wchar_t *encoding,
                            HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkGzipW_UnTarGz(HCkGzipW cHandle, const wchar_t *tgzFilename, const wchar_t *destDir, BOOL bNoAbsolute);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkGzipW_UnTarGzAsync(HCkGzipW cHandle, const wchar_t *tgzFilename, const wchar_t *destDir, BOOL bNoAbsolute);
