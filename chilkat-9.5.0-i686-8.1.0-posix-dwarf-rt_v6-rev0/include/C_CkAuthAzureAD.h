...
CkAuthAzureAD_setProgressInfo(HCkAuthAzureAD cHandle, void (*fnProgressInfo)(const char *name, const char *value));
...
CK_C_VISIBLE_PUBLIC void
CkAuthAzureAD_setPercentDone2(HCkAuthAzureAD cHandle, BOOL (*fnPercentDone2)(int pctDone, void *pContext));

CK_C_VISIBLE_PUBLIC void CkAuthAzureAD_setProgressInfo2(HCkAuthAzureAD cHandle,
                                                        void (*fnProgressInfo2)(const char *name, const char *value,
                                                                                void *pContext));

CK_C_VISIBLE_PUBLIC void
CkAuthAzureAD_setTaskCompleted2(HCkAuthAzureAD cHandle, void (*fnTaskCompleted2)(HCkTask hTask, void *pContext));
