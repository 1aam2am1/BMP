...
public:
    ...
    //
    bool DeflateStringENC(const wchar_t *inString, const wchar_t *charsetName, const wchar_t *outputEncoding,
                          CkString &outStr);
    ...
    // string.
    //
    bool InflateStringENC(const wchar_t *inString, const wchar_t *convertFromCharset, const wchar_t *inputEncoding,
                          CkString &outStr);
    ...
    //
    const wchar_t *
    inflateStringENC(const wchar_t *inString, const wchar_t *convertFromCharset, const wchar_t *inputEncoding);
