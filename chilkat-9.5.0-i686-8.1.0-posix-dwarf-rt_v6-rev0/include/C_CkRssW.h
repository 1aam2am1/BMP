...
CkRssW_setProgressInfo(HCkRssW cHandle, void (*fnProgressInfo)(const wchar_t *name, const wchar_t *value));
...
CkRssW_MGetAttr(HCkRssW cHandle, const wchar_t *tag, int index, const wchar_t *attrName, HCkString outStr);

CK_C_VISIBLE_PUBLIC const wchar_t *
CkRssW_mGetAttr(HCkRssW cHandle, const wchar_t *tag, int index, const wchar_t *attrName);
...
CK_C_VISIBLE_PUBLIC BOOL
CkRssW_MSetAttr(HCkRssW cHandle, const wchar_t *tag, int idx, const wchar_t *attrName, const wchar_t *value);
...
CK_C_VISIBLE_PUBLIC void
CkRssW_SetAttr(HCkRssW cHandle, const wchar_t *tag, const wchar_t *attrName, const wchar_t *value);
