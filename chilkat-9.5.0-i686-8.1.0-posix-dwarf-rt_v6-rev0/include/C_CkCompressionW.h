...
CK_C_VISIBLE_PUBLIC void CkCompressionW_setProgressInfo(HCkCompressionW cHandle,
                                                        void (*fnProgressInfo)(const wchar_t *name,
                                                                               const wchar_t *value));

CK_C_VISIBLE_PUBLIC void
CkCompressionW_setTaskCompleted(HCkCompressionW cHandle, void (*fnTaskCompleted)(HCkTaskW hTask));
...
CkCompressionW_BeginCompressBytes(HCkCompressionW cHandle, HCkByteData data, HCkByteData outData);

CK_C_VISIBLE_PUBLIC HCkTaskW CkCompressionW_BeginCompressBytesAsync(HCkCompressionW cHandle, HCkByteData data);

CK_C_VISIBLE_PUBLIC BOOL
CkCompressionW_BeginCompressBytes2(HCkCompressionW cHandle, const void *pByteData, unsigned long szByteData,
                                   HCkByteData outBytes);

CK_C_VISIBLE_PUBLIC BOOL
CkCompressionW_BeginCompressBytesENC(HCkCompressionW cHandle, HCkByteData data, HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkCompressionW_BeginCompressString(HCkCompressionW cHandle, const wchar_t *str, HCkByteData outData);

CK_C_VISIBLE_PUBLIC HCkTaskW CkCompressionW_BeginCompressStringAsync(HCkCompressionW cHandle, const wchar_t *str);

CK_C_VISIBLE_PUBLIC BOOL
CkCompressionW_BeginCompressStringENC(HCkCompressionW cHandle, const wchar_t *str, HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkCompressionW_BeginDecompressBytes(HCkCompressionW cHandle, HCkByteData data, HCkByteData outData);

CK_C_VISIBLE_PUBLIC HCkTaskW CkCompressionW_BeginDecompressBytesAsync(HCkCompressionW cHandle, HCkByteData data);

CK_C_VISIBLE_PUBLIC BOOL
CkCompressionW_BeginDecompressBytes2(HCkCompressionW cHandle, const void *pByteData, unsigned long szByteData,
                                     HCkByteData outBytes);

CK_C_VISIBLE_PUBLIC BOOL
CkCompressionW_BeginDecompressBytesENC(HCkCompressionW cHandle, const wchar_t *str, HCkByteData outData);

CK_C_VISIBLE_PUBLIC HCkTaskW CkCompressionW_BeginDecompressBytesENCAsync(HCkCompressionW cHandle, const wchar_t *str);

CK_C_VISIBLE_PUBLIC BOOL
CkCompressionW_BeginDecompressString(HCkCompressionW cHandle, HCkByteData data, HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkCompressionW_BeginDecompressStringENC(HCkCompressionW cHandle, const wchar_t *str, HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkCompressionW_CompressBytes2(HCkCompressionW cHandle, const void *pByteData, unsigned long szByteData,
                              HCkByteData outBytes);
...
CK_C_VISIBLE_PUBLIC BOOL
CkCompressionW_CompressFile(HCkCompressionW cHandle, const wchar_t *srcPath, const wchar_t *destPath);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkCompressionW_CompressFileAsync(HCkCompressionW cHandle, const wchar_t *srcPath, const wchar_t *destPath);

CK_C_VISIBLE_PUBLIC BOOL CkCompressionW_CompressSb(HCkCompressionW cHandle, HCkStringBuilderW sb, HCkBinDataW binData);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkCompressionW_CompressSbAsync(HCkCompressionW cHandle, HCkStringBuilderW sb, HCkBinDataW binData);
...
CK_C_VISIBLE_PUBLIC BOOL
CkCompressionW_CompressString(HCkCompressionW cHandle, const wchar_t *str, HCkByteData outData);

CK_C_VISIBLE_PUBLIC HCkTaskW CkCompressionW_CompressStringAsync(HCkCompressionW cHandle, const wchar_t *str);

CK_C_VISIBLE_PUBLIC BOOL
CkCompressionW_CompressStringENC(HCkCompressionW cHandle, const wchar_t *str, HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkCompressionW_DecompressBytes2(HCkCompressionW cHandle, const void *pByteData, unsigned long szByteData,
                                HCkByteData outBytes);

CK_C_VISIBLE_PUBLIC BOOL
CkCompressionW_DecompressBytesENC(HCkCompressionW cHandle, const wchar_t *encodedCompressedData, HCkByteData outData);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkCompressionW_DecompressBytesENCAsync(HCkCompressionW cHandle, const wchar_t *encodedCompressedData);

CK_C_VISIBLE_PUBLIC BOOL
CkCompressionW_DecompressFile(HCkCompressionW cHandle, const wchar_t *srcPath, const wchar_t *destPath);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkCompressionW_DecompressFileAsync(HCkCompressionW cHandle, const wchar_t *srcPath, const wchar_t *destPath);

CK_C_VISIBLE_PUBLIC BOOL
CkCompressionW_DecompressSb(HCkCompressionW cHandle, HCkBinDataW binData, HCkStringBuilderW sb);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkCompressionW_DecompressSbAsync(HCkCompressionW cHandle, HCkBinDataW binData, HCkStringBuilderW sb);
...
CK_C_VISIBLE_PUBLIC BOOL
CkCompressionW_DecompressStringENC(HCkCompressionW cHandle, const wchar_t *encodedCompressedData, HCkString outStr);

CK_C_VISIBLE_PUBLIC const wchar_t *
CkCompressionW_decompressStringENC(HCkCompressionW cHandle, const wchar_t *encodedCompressedData);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkCompressionW_DecompressStringENCAsync(HCkCompressionW cHandle, const wchar_t *encodedCompressedData);
...
CK_C_VISIBLE_PUBLIC BOOL
CkCompressionW_MoreCompressBytes(HCkCompressionW cHandle, HCkByteData data, HCkByteData outData);

CK_C_VISIBLE_PUBLIC HCkTaskW CkCompressionW_MoreCompressBytesAsync(HCkCompressionW cHandle, HCkByteData data);

CK_C_VISIBLE_PUBLIC BOOL
CkCompressionW_MoreCompressBytes2(HCkCompressionW cHandle, const void *pByteData, unsigned long szByteData,
                                  HCkByteData outBytes);

CK_C_VISIBLE_PUBLIC BOOL
CkCompressionW_MoreCompressBytesENC(HCkCompressionW cHandle, HCkByteData data, HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkCompressionW_MoreCompressString(HCkCompressionW cHandle, const wchar_t *str, HCkByteData outData);

CK_C_VISIBLE_PUBLIC HCkTaskW CkCompressionW_MoreCompressStringAsync(HCkCompressionW cHandle, const wchar_t *str);

CK_C_VISIBLE_PUBLIC BOOL
CkCompressionW_MoreCompressStringENC(HCkCompressionW cHandle, const wchar_t *str, HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkCompressionW_MoreDecompressBytes(HCkCompressionW cHandle, HCkByteData data, HCkByteData outData);

CK_C_VISIBLE_PUBLIC HCkTaskW CkCompressionW_MoreDecompressBytesAsync(HCkCompressionW cHandle, HCkByteData data);

CK_C_VISIBLE_PUBLIC BOOL
CkCompressionW_MoreDecompressBytes2(HCkCompressionW cHandle, const void *pByteData, unsigned long szByteData,
                                    HCkByteData outBytes);

CK_C_VISIBLE_PUBLIC BOOL
CkCompressionW_MoreDecompressBytesENC(HCkCompressionW cHandle, const wchar_t *str, HCkByteData outData);

CK_C_VISIBLE_PUBLIC HCkTaskW CkCompressionW_MoreDecompressBytesENCAsync(HCkCompressionW cHandle, const wchar_t *str);

CK_C_VISIBLE_PUBLIC BOOL
CkCompressionW_MoreDecompressString(HCkCompressionW cHandle, HCkByteData data, HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkCompressionW_MoreDecompressStringENC(HCkCompressionW cHandle, const wchar_t *str, HCkString outStr);
