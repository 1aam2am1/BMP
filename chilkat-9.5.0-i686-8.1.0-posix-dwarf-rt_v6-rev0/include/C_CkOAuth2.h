...
CkOAuth2_setProgressInfo(HCkOAuth2 cHandle, void (*fnProgressInfo)(const char *name, const char *value));
...
CK_C_VISIBLE_PUBLIC void
CkOAuth2_setPercentDone2(HCkOAuth2 cHandle, BOOL (*fnPercentDone2)(int pctDone, void *pContext));

CK_C_VISIBLE_PUBLIC void CkOAuth2_setProgressInfo2(HCkOAuth2 cHandle,
                                                   void (*fnProgressInfo2)(const char *name, const char *value,
                                                                           void *pContext));

CK_C_VISIBLE_PUBLIC void
CkOAuth2_setTaskCompleted2(HCkOAuth2 cHandle, void (*fnTaskCompleted2)(HCkTask hTask, void *pContext));
