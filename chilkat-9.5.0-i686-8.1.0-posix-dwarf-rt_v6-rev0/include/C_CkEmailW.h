...
CkEmailW_AddAttachmentBd(HCkEmailW cHandle, const wchar_t *filename, HCkBinDataW binData, const wchar_t *contentType);

CK_C_VISIBLE_PUBLIC void
CkEmailW_AddAttachmentHeader(HCkEmailW cHandle, int index, const wchar_t *fieldName, const wchar_t *fieldValue);
...
CK_C_VISIBLE_PUBLIC BOOL CkEmailW_AddDataAttachment2(HCkEmailW cHandle, const wchar_t *fileName, HCkByteData content,
                                                     const wchar_t *contentType);

CK_C_VISIBLE_PUBLIC BOOL CkEmailW_AddEncryptCert(HCkEmailW cHandle, HCkCertW cert);

CK_C_VISIBLE_PUBLIC BOOL
CkEmailW_AddFileAttachment(HCkEmailW cHandle, const wchar_t *path, HCkString outStrContentType);

CK_C_VISIBLE_PUBLIC const wchar_t *CkEmailW_addFileAttachment(HCkEmailW cHandle, const wchar_t *path);

CK_C_VISIBLE_PUBLIC BOOL
CkEmailW_AddFileAttachment2(HCkEmailW cHandle, const wchar_t *path, const wchar_t *contentType);

CK_C_VISIBLE_PUBLIC void
CkEmailW_AddHeaderField(HCkEmailW cHandle, const wchar_t *fieldName, const wchar_t *fieldValue);

CK_C_VISIBLE_PUBLIC void
CkEmailW_AddHeaderField2(HCkEmailW cHandle, const wchar_t *fieldName, const wchar_t *fieldValue);

CK_C_VISIBLE_PUBLIC BOOL CkEmailW_AddHtmlAlternativeBody(HCkEmailW cHandle, const wchar_t *body);

CK_C_VISIBLE_PUBLIC BOOL
CkEmailW_AddiCalendarAlternativeBody(HCkEmailW cHandle, const wchar_t *icalContent, const wchar_t *methodName);
...
CK_C_VISIBLE_PUBLIC BOOL
CkEmailW_AddPfxSourceFile(HCkEmailW cHandle, const wchar_t *pfxFilePath, const wchar_t *pfxPassword);

CK_C_VISIBLE_PUBLIC BOOL CkEmailW_AddPlainTextAlternativeBody(HCkEmailW cHandle, const wchar_t *body);

CK_C_VISIBLE_PUBLIC BOOL
CkEmailW_AddRelatedBd(HCkEmailW cHandle, const wchar_t *filename, HCkBinDataW binData, HCkString outStr);

CK_C_VISIBLE_PUBLIC const wchar_t *
CkEmailW_addRelatedBd(HCkEmailW cHandle, const wchar_t *filename, HCkBinDataW binData);

CK_C_VISIBLE_PUBLIC BOOL CkEmailW_AddRelatedBd2(HCkEmailW cHandle, HCkBinDataW binData, const wchar_t *fileNameInHtml);

CK_C_VISIBLE_PUBLIC BOOL
CkEmailW_AddRelatedData(HCkEmailW cHandle, const wchar_t *fileName, HCkByteData inData, HCkString outStr);

CK_C_VISIBLE_PUBLIC const wchar_t *
CkEmailW_addRelatedData(HCkEmailW cHandle, const wchar_t *fileName, HCkByteData inData);
...
CK_C_VISIBLE_PUBLIC void
CkEmailW_AddRelatedData2P(HCkEmailW cHandle, const void *pBytes, unsigned long szBytes, const wchar_t *fileNameInHtml);

#endif
#if !defined(CHILKAT_MONO)

CK_C_VISIBLE_PUBLIC BOOL
CkEmailW_AddRelatedDataP(HCkEmailW cHandle, const wchar_t *nameInHtml, const void *pBytes, unsigned long szBytes,
                         HCkString outStrContentId);
...
CK_C_VISIBLE_PUBLIC BOOL
CkEmailW_AddRelatedFile2(HCkEmailW cHandle, const wchar_t *filenameOnDisk, const wchar_t *filenameInHtml);

CK_C_VISIBLE_PUBLIC void
CkEmailW_AddRelatedHeader(HCkEmailW cHandle, int index, const wchar_t *fieldName, const wchar_t *fieldValue);

CK_C_VISIBLE_PUBLIC BOOL
CkEmailW_AddRelatedString(HCkEmailW cHandle, const wchar_t *nameInHtml, const wchar_t *str, const wchar_t *charset,
                          HCkString outCid);
...
CK_C_VISIBLE_PUBLIC void
CkEmailW_AddRelatedString2(HCkEmailW cHandle, const wchar_t *fileNameInHtml, const wchar_t *content,
                           const wchar_t *charset);

CK_C_VISIBLE_PUBLIC BOOL CkEmailW_AddStringAttachment(HCkEmailW cHandle, const wchar_t *path, const wchar_t *content);

CK_C_VISIBLE_PUBLIC BOOL
CkEmailW_AddStringAttachment2(HCkEmailW cHandle, const wchar_t *path, const wchar_t *content, const wchar_t *charset);
...
CK_C_VISIBLE_PUBLIC BOOL
CkEmailW_AspUnpack(HCkEmailW cHandle, const wchar_t *prefix, const wchar_t *saveDir, const wchar_t *urlPath,
                   BOOL cleanFiles);

CK_C_VISIBLE_PUBLIC BOOL
CkEmailW_AspUnpack2(HCkEmailW cHandle, const wchar_t *prefix, const wchar_t *saveDir, const wchar_t *urlPath,
                    BOOL cleanFiles, HCkByteData outHtml);

CK_C_VISIBLE_PUBLIC BOOL CkEmailW_AttachMessage(HCkEmailW cHandle, HCkByteData mimeBytes);

CK_C_VISIBLE_PUBLIC BOOL
CkEmailW_BEncodeBytes(HCkEmailW cHandle, HCkByteData inData, const wchar_t *charset, HCkString outEncodedStr);

CK_C_VISIBLE_PUBLIC const wchar_t *CkEmailW_bEncodeBytes(HCkEmailW cHandle, HCkByteData inData, const wchar_t *charset);

CK_C_VISIBLE_PUBLIC BOOL
CkEmailW_BEncodeString(HCkEmailW cHandle, const wchar_t *str, const wchar_t *charset, HCkString outEncodedStr);

CK_C_VISIBLE_PUBLIC const wchar_t *
CkEmailW_bEncodeString(HCkEmailW cHandle, const wchar_t *str, const wchar_t *charset);
...
CK_C_VISIBLE_PUBLIC BOOL
CkEmailW_ComputeGlobalKey(HCkEmailW cHandle, const wchar_t *encoding, BOOL bFold, HCkString outStr);

CK_C_VISIBLE_PUBLIC const wchar_t *CkEmailW_computeGlobalKey(HCkEmailW cHandle, const wchar_t *encoding, BOOL bFold);

CK_C_VISIBLE_PUBLIC BOOL
CkEmailW_ComputeGlobalKey2(HCkEmailW cHandle, const wchar_t *encoding, BOOL bFold, HCkString outStr);
...
CK_C_VISIBLE_PUBLIC HCkEmailW
CkEmailW_CreateDsn(HCkEmailW cHandle, const wchar_t *humanReadableMessage, const wchar_t *xmlStatusFields,
                   BOOL bHeaderOnly);

CK_C_VISIBLE_PUBLIC HCkEmailW CkEmailW_CreateForward(HCkEmailW cHandle);

CK_C_VISIBLE_PUBLIC HCkEmailW
CkEmailW_CreateMdn(HCkEmailW cHandle, const wchar_t *humanReadableMessage, const wchar_t *xmlStatusFields,
                   BOOL bHeaderOnly);
...
CK_C_VISIBLE_PUBLIC BOOL
CkEmailW_GetAlternativeBodyByContentType(HCkEmailW cHandle, const wchar_t *contentType, HCkString outStr);

CK_C_VISIBLE_PUBLIC const wchar_t *
CkEmailW_getAlternativeBodyByContentType(HCkEmailW cHandle, const wchar_t *contentType);
...
CK_C_VISIBLE_PUBLIC BOOL
CkEmailW_GetAltHeaderField(HCkEmailW cHandle, int index, const wchar_t *fieldName, HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkEmailW_GetAttachedMessageAttr(HCkEmailW cHandle, int index, const wchar_t *fieldName, const wchar_t *attrName,
                                HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkEmailW_GetAttachmentAttr(HCkEmailW cHandle, int index, const wchar_t *fieldName, const wchar_t *attrName,
                           HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkEmailW_GetAttachmentHeader(HCkEmailW cHandle, int attachIndex, const wchar_t *fieldName, HCkString outFieldValue);

CK_C_VISIBLE_PUBLIC const wchar_t *
CkEmailW_getAttachmentHeader(HCkEmailW cHandle, int attachIndex, const wchar_t *fieldName);

CK_C_VISIBLE_PUBLIC int CkEmailW_GetAttachmentSize(HCkEmailW cHandle, int index);

CK_C_VISIBLE_PUBLIC BOOL
CkEmailW_GetAttachmentString(HCkEmailW cHandle, int index, const wchar_t *charset, HCkString outStr);

CK_C_VISIBLE_PUBLIC const wchar_t *CkEmailW_getAttachmentString(HCkEmailW cHandle, int index, const wchar_t *charset);

CK_C_VISIBLE_PUBLIC BOOL
CkEmailW_GetAttachmentStringCrLf(HCkEmailW cHandle, int index, const wchar_t *charset, HCkString outStrData);

CK_C_VISIBLE_PUBLIC const wchar_t *
CkEmailW_getAttachmentStringCrLf(HCkEmailW cHandle, int index, const wchar_t *charset);
...
CK_C_VISIBLE_PUBLIC BOOL
CkEmailW_GetDeliveryStatusInfo(HCkEmailW cHandle, const wchar_t *fieldName, HCkString outFieldValue);
...
CK_C_VISIBLE_PUBLIC BOOL
CkEmailW_GetHeaderField(HCkEmailW cHandle, const wchar_t *fieldName, HCkString outStrFieldData);
...
CK_C_VISIBLE_PUBLIC BOOL
CkEmailW_GetMbHeaderField(HCkEmailW cHandle, const wchar_t *fieldName, const wchar_t *charset, HCkByteData outBytes);
...
CK_C_VISIBLE_PUBLIC BOOL
CkEmailW_GetNthBinaryPartOfType(HCkEmailW cHandle, int index, const wchar_t *contentType, BOOL inlineOnly,
                                BOOL excludeAttachments, HCkByteData outBytes);

CK_C_VISIBLE_PUBLIC BOOL
CkEmailW_GetNthTextPartOfType(HCkEmailW cHandle, int index, const wchar_t *contentType, BOOL inlineOnly,
                              BOOL excludeAttachments, HCkString outStr);
...
CkEmailW_GetNumPartsOfType(HCkEmailW cHandle, const wchar_t *contentType, BOOL inlineOnly, BOOL excludeAttachments);
...
CK_C_VISIBLE_PUBLIC BOOL
CkEmailW_GetRelatedAttr(HCkEmailW cHandle, int index, const wchar_t *fieldName, const wchar_t *attrName,
                        HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkEmailW_GetRelatedString(HCkEmailW cHandle, int index, const wchar_t *charset, HCkString outStrData);

CK_C_VISIBLE_PUBLIC const wchar_t *CkEmailW_getRelatedString(HCkEmailW cHandle, int index, const wchar_t *charset);

CK_C_VISIBLE_PUBLIC BOOL
CkEmailW_GetRelatedStringCrLf(HCkEmailW cHandle, int index, const wchar_t *charset, HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkEmailW_HasHeaderMatching(HCkEmailW cHandle, const wchar_t *fieldName, const wchar_t *valuePattern,
                           BOOL caseSensitive);
...
CK_C_VISIBLE_PUBLIC BOOL
CkEmailW_QEncodeBytes(HCkEmailW cHandle, HCkByteData inData, const wchar_t *charset, HCkString outEncodedStr);

CK_C_VISIBLE_PUBLIC const wchar_t *CkEmailW_qEncodeBytes(HCkEmailW cHandle, HCkByteData inData, const wchar_t *charset);

CK_C_VISIBLE_PUBLIC BOOL
CkEmailW_QEncodeString(HCkEmailW cHandle, const wchar_t *str, const wchar_t *charset, HCkString outEncodedStr);

CK_C_VISIBLE_PUBLIC const wchar_t *
CkEmailW_qEncodeString(HCkEmailW cHandle, const wchar_t *str, const wchar_t *charset);
...
CK_C_VISIBLE_PUBLIC BOOL
CkEmailW_SetBinaryBody(HCkEmailW cHandle, HCkByteData byteData, const wchar_t *contentType, const wchar_t *disposition,
...
CK_C_VISIBLE_PUBLIC void
CkEmailW_SetEdifactBody(HCkEmailW cHandle, const wchar_t *message, const wchar_t *name, const wchar_t *filename,
                        const wchar_t *charset);
...
CK_C_VISIBLE_PUBLIC BOOL
CkEmailW_SetReplacePattern(HCkEmailW cHandle, const wchar_t *pattern, const wchar_t *replaceString);
...
CK_C_VISIBLE_PUBLIC BOOL CkEmailW_UnpackHtml(HCkEmailW cHandle, const wchar_t *unpackDir, const wchar_t *htmlFilename,
