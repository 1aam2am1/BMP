...
CkBz2_setProgressInfo(HCkBz2 cHandle, void (*fnProgressInfo)(const char *name, const char *value));
...
CK_C_VISIBLE_PUBLIC void
CkBz2_setProgressInfo2(HCkBz2 cHandle, void (*fnProgressInfo2)(const char *name, const char *value, void *pContext));

CK_C_VISIBLE_PUBLIC void
CkBz2_setTaskCompleted2(HCkBz2 cHandle, void (*fnTaskCompleted2)(HCkTask hTask, void *pContext));
