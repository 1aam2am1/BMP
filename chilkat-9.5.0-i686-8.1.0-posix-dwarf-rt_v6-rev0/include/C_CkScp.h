...
CkScp_setProgressInfo(HCkScp cHandle, void (*fnProgressInfo)(const char *name, const char *value));
...
CK_C_VISIBLE_PUBLIC void
CkScp_setProgressInfo2(HCkScp cHandle, void (*fnProgressInfo2)(const char *name, const char *value, void *pContext));

CK_C_VISIBLE_PUBLIC void
CkScp_setTaskCompleted2(HCkScp cHandle, void (*fnTaskCompleted2)(HCkTask hTask, void *pContext));
...
CkScp_DownloadBinaryEncoded(HCkScp cHandle, const char *remotePath, const char *encoding, HCkString outStr);

CK_C_VISIBLE_PUBLIC const char *
CkScp_downloadBinaryEncoded(HCkScp cHandle, const char *remotePath, const char *encoding);

CK_C_VISIBLE_PUBLIC HCkTask
CkScp_DownloadBinaryEncodedAsync(HCkScp cHandle, const char *remotePath, const char *encoding);
...
CK_C_VISIBLE_PUBLIC BOOL
CkScp_DownloadString(HCkScp cHandle, const char *remotePath, const char *charset, HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkScp_SyncTreeDownload(HCkScp cHandle, const char *remoteRoot, const char *localRoot, int mode, BOOL bRecurse);

CK_C_VISIBLE_PUBLIC HCkTask
CkScp_SyncTreeDownloadAsync(HCkScp cHandle, const char *remoteRoot, const char *localRoot, int mode, BOOL bRecurse);

CK_C_VISIBLE_PUBLIC BOOL
CkScp_SyncTreeUpload(HCkScp cHandle, const char *localBaseDir, const char *remoteBaseDir, int mode, BOOL bRecurse);

CK_C_VISIBLE_PUBLIC HCkTask
CkScp_SyncTreeUploadAsync(HCkScp cHandle, const char *localBaseDir, const char *remoteBaseDir, int mode, BOOL bRecurse);
...
CK_C_VISIBLE_PUBLIC BOOL
CkScp_UploadBinaryEncoded(HCkScp cHandle, const char *remotePath, const char *encodedData, const char *encoding);

CK_C_VISIBLE_PUBLIC HCkTask
CkScp_UploadBinaryEncodedAsync(HCkScp cHandle, const char *remotePath, const char *encodedData, const char *encoding);
...
CK_C_VISIBLE_PUBLIC BOOL
CkScp_UploadString(HCkScp cHandle, const char *remotePath, const char *textData, const char *charset);

CK_C_VISIBLE_PUBLIC HCkTask
CkScp_UploadStringAsync(HCkScp cHandle, const char *remotePath, const char *textData, const char *charset);
