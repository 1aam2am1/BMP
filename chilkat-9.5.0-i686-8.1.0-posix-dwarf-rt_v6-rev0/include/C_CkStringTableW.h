...
CkStringTableW_AppendFromFile(HCkStringTableW cHandle, int maxLineLen, const wchar_t *charset, const wchar_t *path);
...
CkStringTableW_FindSubstring(HCkStringTableW cHandle, int startIndex, const wchar_t *substr, BOOL caseSensitive);
...
CK_C_VISIBLE_PUBLIC BOOL
CkStringTableW_SaveToFile(HCkStringTableW cHandle, const wchar_t *charset, BOOL bCrlf, const wchar_t *path);

CK_C_VISIBLE_PUBLIC BOOL
CkStringTableW_SplitAndAppend(HCkStringTableW cHandle, const wchar_t *inStr, const wchar_t *delimiterChar,
