...
public:
    ...
    //
    bool CanonicalizeFragment(const char *xml, const char *fragmentId, const char *version, const char *prefixList,
                              bool withComments, CkString &outStr);
    ...
    //
    const char *
    canonicalizeFragment(const char *xml, const char *fragmentId, const char *version, const char *prefixList,
                         bool withComments);
