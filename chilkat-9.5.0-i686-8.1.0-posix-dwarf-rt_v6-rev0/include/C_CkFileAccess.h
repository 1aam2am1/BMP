...
CkFileAccess_FileContentsEqual(HCkFileAccess cHandle, const char *filePath1, const char *filePath2);

CK_C_VISIBLE_PUBLIC BOOL
CkFileAccess_FileCopy(HCkFileAccess cHandle, const char *existingFilepath, const char *newFilepath, BOOL failIfExists);
...
CK_C_VISIBLE_PUBLIC BOOL
CkFileAccess_FileOpen(HCkFileAccess cHandle, const char *filePath, unsigned long accessMode, unsigned long shareMode,
                      unsigned long createDisposition, unsigned long attributes);
...
CK_C_VISIBLE_PUBLIC BOOL
CkFileAccess_FileRename(HCkFileAccess cHandle, const char *existingFilepath, const char *newFilepath);
...
CK_C_VISIBLE_PUBLIC BOOL
CkFileAccess_FileWrite2(HCkFileAccess cHandle, const void *pByteData, unsigned long szByteData);

CK_C_VISIBLE_PUBLIC BOOL CkFileAccess_FileWriteBd(HCkFileAccess cHandle, HCkBinData binData, int offset, int numBytes);

CK_C_VISIBLE_PUBLIC BOOL
CkFileAccess_GenBlockId(HCkFileAccess cHandle, int index, int length, const char *encoding, HCkString outStr);

CK_C_VISIBLE_PUBLIC const char *
CkFileAccess_genBlockId(HCkFileAccess cHandle, int index, int length, const char *encoding);
...
CK_C_VISIBLE_PUBLIC BOOL
CkFileAccess_GetFileNameWithoutExtension(HCkFileAccess cHandle, const char *path, HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkFileAccess_GetTempFilename(HCkFileAccess cHandle, const char *dirPath, const char *prefix, HCkString outStr);

CK_C_VISIBLE_PUBLIC const char *
CkFileAccess_getTempFilename(HCkFileAccess cHandle, const char *dirPath, const char *prefix);
...
CK_C_VISIBLE_PUBLIC BOOL
CkFileAccess_ReadBinaryToEncoded(HCkFileAccess cHandle, const char *filePath, const char *encoding, HCkString outStr);

CK_C_VISIBLE_PUBLIC const char *
CkFileAccess_readBinaryToEncoded(HCkFileAccess cHandle, const char *filePath, const char *encoding);

CK_C_VISIBLE_PUBLIC BOOL
CkFileAccess_ReadBlock(HCkFileAccess cHandle, int blockIndex, int blockSize, HCkByteData outBytes);
...
CK_C_VISIBLE_PUBLIC BOOL
CkFileAccess_ReadEntireTextFile(HCkFileAccess cHandle, const char *filePath, const char *charset,
...
CkFileAccess_ReadNextFragment(HCkFileAccess cHandle, BOOL startAtBeginning, const char *beginMarker,
                              const char *endMarker, const char *charset, HCkStringBuilder sb);

CK_C_VISIBLE_PUBLIC BOOL
CkFileAccess_ReassembleFile(HCkFileAccess cHandle, const char *partsDirPath, const char *partPrefix,
                            const char *partExtension, const char *reassembledFilename);

CK_C_VISIBLE_PUBLIC int CkFileAccess_ReplaceStrings(HCkFileAccess cHandle, const char *filePath, const char *charset,
                                                    const char *existingString, const char *replacementString);
...
CK_C_VISIBLE_PUBLIC BOOL CkFileAccess_SetFileTimes(HCkFileAccess cHandle, const char *filePath, HCkDateTime createTime,
                                                   HCkDateTime lastAccessTime, HCkDateTime lastModTime);

CK_C_VISIBLE_PUBLIC BOOL
CkFileAccess_SetLastModified(HCkFileAccess cHandle, const char *filePath, HCkDateTime lastModified);

CK_C_VISIBLE_PUBLIC BOOL CkFileAccess_SplitFile(HCkFileAccess cHandle, const char *fileToSplit, const char *partPrefix,
                                                const char *partExtension, int partSize, const char *destDir);

CK_C_VISIBLE_PUBLIC BOOL
CkFileAccess_SymlinkCreate(HCkFileAccess cHandle, const char *targetPath, const char *linkPath);
...
CK_C_VISIBLE_PUBLIC BOOL
CkFileAccess_WriteEntireFile(HCkFileAccess cHandle, const char *filePath, HCkByteData fileData);

CK_C_VISIBLE_PUBLIC BOOL
CkFileAccess_WriteEntireTextFile(HCkFileAccess cHandle, const char *filePath, const char *textData, const char *charset,
