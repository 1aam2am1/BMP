...
public:
    ...
    //
    CkTask *
    ChannelReceiveUntilMatchAsync(int channelNum, const char *matchPattern, const char *charset, bool caseSensitive);
    ...
    //
    bool
    ChannelReceiveUntilMatchN(int channelNum, CkStringArray &matchPatterns, const char *charset, bool caseSensitive);
    ...
    // prevent an infinite wait if of the matchPatterns ever arrives.
    //
    CkTask *ChannelReceiveUntilMatchNAsync(int channelNum, CkStringArray &matchPatterns, const char *charset,
                                           bool caseSensitive);
    ...
    //
    bool SendReqPty(int channelNum, const char *termType, int widthInChars, int heightInChars, int widthInPixels,
                    int heightInPixels);
    ...
    //
    CkTask *
    SendReqPtyAsync(int channelNum, const char *termType, int widthInChars, int heightInChars, int widthInPixels,
                    int heightInPixels);
    ...
    bool SendReqX11Forwarding(int channelNum, bool singleConnection, const char *authProt, const char *authCookie,
                              int screenNum);
    ...
    // connection protocol. Chilkat has no advice for when or why it would be needed.
    CkTask *
    SendReqX11ForwardingAsync(int channelNum, bool singleConnection, const char *authProt, const char *authCookie,
                              int screenNum);
