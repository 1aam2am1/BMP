...
public:
    ...
    bool
    AddBytesForUpload2(const char *name, const char *remoteFileName, CkByteData &byteData, const char *contentType);
    ...
    bool AddStringForUpload2(const char *name, const char *filename, const char *strData, const char *charset,
