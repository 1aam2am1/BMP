...
CkPfxW_LoadPfxEncoded(HCkPfxW cHandle, const wchar_t *encodedData, const wchar_t *encoding, const wchar_t *password);
...
CK_C_VISIBLE_PUBLIC BOOL
CkPfxW_ToEncodedString(HCkPfxW cHandle, const wchar_t *password, const wchar_t *encoding, HCkString outStr);

CK_C_VISIBLE_PUBLIC const wchar_t *
CkPfxW_toEncodedString(HCkPfxW cHandle, const wchar_t *password, const wchar_t *encoding);

CK_C_VISIBLE_PUBLIC BOOL CkPfxW_ToFile(HCkPfxW cHandle, const wchar_t *password, const wchar_t *path);

CK_C_VISIBLE_PUBLIC HCkJavaKeyStoreW
CkPfxW_ToJavaKeyStore(HCkPfxW cHandle, const wchar_t *alias, const wchar_t *password);
...
CK_C_VISIBLE_PUBLIC BOOL CkPfxW_ToPemEx(HCkPfxW cHandle, BOOL extendedAttrs, BOOL noKeys, BOOL noCerts, BOOL noCaCerts,
                                        const wchar_t *encryptAlg, const wchar_t *password, HCkString outStr);

CK_C_VISIBLE_PUBLIC const wchar_t *
CkPfxW_toPemEx(HCkPfxW cHandle, BOOL extendedAttrs, BOOL noKeys, BOOL noCerts, BOOL noCaCerts,
               const wchar_t *encryptAlg, const wchar_t *password);
