...
CkCacheW_SaveText(HCkCacheW cHandle, const wchar_t *key, SYSTEMTIME *expireDateTime, const wchar_t *eTag,
                  const wchar_t *itemTextData);

CK_C_VISIBLE_PUBLIC BOOL
CkCacheW_SaveTextDt(HCkCacheW cHandle, const wchar_t *key, HCkDateTimeW expireDateTime, const wchar_t *eTag,
                    const wchar_t *itemTextData);

CK_C_VISIBLE_PUBLIC BOOL
CkCacheW_SaveTextNoExpire(HCkCacheW cHandle, const wchar_t *key, const wchar_t *eTag, const wchar_t *itemTextData);

CK_C_VISIBLE_PUBLIC BOOL
CkCacheW_SaveTextStr(HCkCacheW cHandle, const wchar_t *key, const wchar_t *expireDateTime, const wchar_t *eTag,
                     const wchar_t *itemTextData);

CK_C_VISIBLE_PUBLIC BOOL
CkCacheW_SaveToCache(HCkCacheW cHandle, const wchar_t *key, SYSTEMTIME *expireDateTime, const wchar_t *eTag,
                     HCkByteData itemData);

CK_C_VISIBLE_PUBLIC BOOL
CkCacheW_SaveToCacheDt(HCkCacheW cHandle, const wchar_t *key, HCkDateTimeW expireDateTime, const wchar_t *eTag,
                       HCkByteData itemData);

CK_C_VISIBLE_PUBLIC BOOL
CkCacheW_SaveToCacheNoExpire(HCkCacheW cHandle, const wchar_t *key, const wchar_t *eTag, HCkByteData itemData);

CK_C_VISIBLE_PUBLIC BOOL
CkCacheW_SaveToCacheStr(HCkCacheW cHandle, const wchar_t *key, const wchar_t *expireDateTime, const wchar_t *eTag,
                        HCkByteData itemData);

CK_C_VISIBLE_PUBLIC BOOL CkCacheW_UpdateExpiration(HCkCacheW cHandle, const wchar_t *key, SYSTEMTIME *expireDateTime);

CK_C_VISIBLE_PUBLIC BOOL
CkCacheW_UpdateExpirationDt(HCkCacheW cHandle, const wchar_t *key, HCkDateTimeW expireDateTime);

CK_C_VISIBLE_PUBLIC BOOL
CkCacheW_UpdateExpirationStr(HCkCacheW cHandle, const wchar_t *key, const wchar_t *expireDateTime);
