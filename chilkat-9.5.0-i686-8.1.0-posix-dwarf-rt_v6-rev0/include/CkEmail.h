...
public:
    ...
    //
    bool GetNthBinaryPartOfType(int index, const char *contentType, bool inlineOnly, bool excludeAttachments,
                                CkByteData &outBytes);
    ...
    // those parts that are the attachments will (of course) be missing.
    //
    bool GetNthTextPartOfType(int index, const char *contentType, bool inlineOnly, bool excludeAttachments,
                              CkString &outStr);
