...
CkZipEntryW_setProgressInfo(HCkZipEntryW cHandle, void (*fnProgressInfo)(const wchar_t *name, const wchar_t *value));
...
CkZipEntryW_AppendString(HCkZipEntryW cHandle, const wchar_t *strContent, const wchar_t *charset);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkZipEntryW_AppendStringAsync(HCkZipEntryW cHandle, const wchar_t *strContent, const wchar_t *charset);
...
CK_C_VISIBLE_PUBLIC BOOL
CkZipEntryW_ReplaceString(HCkZipEntryW cHandle, const wchar_t *strContent, const wchar_t *charset);
...
CK_C_VISIBLE_PUBLIC BOOL
CkZipEntryW_UnzipToSb(HCkZipEntryW cHandle, int lineEndingBehavior, const wchar_t *srcCharset, HCkStringBuilderW sb);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkZipEntryW_UnzipToSbAsync(HCkZipEntryW cHandle, int lineEndingBehavior, const wchar_t *srcCharset,
...
CK_C_VISIBLE_PUBLIC BOOL
CkZipEntryW_UnzipToString(HCkZipEntryW cHandle, int lineEndingBehavior, const wchar_t *srcCharset, HCkString outStr);

CK_C_VISIBLE_PUBLIC const wchar_t *
CkZipEntryW_unzipToString(HCkZipEntryW cHandle, int lineEndingBehavior, const wchar_t *srcCharset);

CK_C_VISIBLE_PUBLIC HCkTaskW
CkZipEntryW_UnzipToStringAsync(HCkZipEntryW cHandle, int lineEndingBehavior, const wchar_t *srcCharset);
