...
CkFileAccessW_FileContentsEqual(HCkFileAccessW cHandle, const wchar_t *filePath1, const wchar_t *filePath2);

CK_C_VISIBLE_PUBLIC BOOL
CkFileAccessW_FileCopy(HCkFileAccessW cHandle, const wchar_t *existingFilepath, const wchar_t *newFilepath,
                       BOOL failIfExists);
...
CK_C_VISIBLE_PUBLIC BOOL
CkFileAccessW_FileOpen(HCkFileAccessW cHandle, const wchar_t *filePath, unsigned long accessMode,
                       unsigned long shareMode, unsigned long createDisposition, unsigned long attributes);
...
CK_C_VISIBLE_PUBLIC BOOL
CkFileAccessW_FileRename(HCkFileAccessW cHandle, const wchar_t *existingFilepath, const wchar_t *newFilepath);
...
CK_C_VISIBLE_PUBLIC BOOL
CkFileAccessW_FileWrite2(HCkFileAccessW cHandle, const void *pByteData, unsigned long szByteData);

CK_C_VISIBLE_PUBLIC BOOL
CkFileAccessW_FileWriteBd(HCkFileAccessW cHandle, HCkBinDataW binData, int offset, int numBytes);

CK_C_VISIBLE_PUBLIC BOOL
CkFileAccessW_GenBlockId(HCkFileAccessW cHandle, int index, int length, const wchar_t *encoding, HCkString outStr);

CK_C_VISIBLE_PUBLIC const wchar_t *
CkFileAccessW_genBlockId(HCkFileAccessW cHandle, int index, int length, const wchar_t *encoding);
...
CK_C_VISIBLE_PUBLIC BOOL
CkFileAccessW_GetFileNameWithoutExtension(HCkFileAccessW cHandle, const wchar_t *path, HCkString outStr);

CK_C_VISIBLE_PUBLIC const wchar_t *
CkFileAccessW_getFileNameWithoutExtension(HCkFileAccessW cHandle, const wchar_t *path);
...
CK_C_VISIBLE_PUBLIC BOOL
CkFileAccessW_GetTempFilename(HCkFileAccessW cHandle, const wchar_t *dirPath, const wchar_t *prefix, HCkString outStr);

CK_C_VISIBLE_PUBLIC const wchar_t *
CkFileAccessW_getTempFilename(HCkFileAccessW cHandle, const wchar_t *dirPath, const wchar_t *prefix);
...
CK_C_VISIBLE_PUBLIC BOOL
CkFileAccessW_ReadBinaryToEncoded(HCkFileAccessW cHandle, const wchar_t *filePath, const wchar_t *encoding,
                                  HCkString outStr);
...
CK_C_VISIBLE_PUBLIC BOOL
CkFileAccessW_ReadBlock(HCkFileAccessW cHandle, int blockIndex, int blockSize, HCkByteData outBytes);

CK_C_VISIBLE_PUBLIC BOOL
CkFileAccessW_ReadBlockBd(HCkFileAccessW cHandle, int blockIndex, int blockSize, HCkBinDataW bd);

CK_C_VISIBLE_PUBLIC BOOL
CkFileAccessW_ReadEntireFile(HCkFileAccessW cHandle, const wchar_t *filePath, HCkByteData outBytes);

CK_C_VISIBLE_PUBLIC BOOL
CkFileAccessW_ReadEntireTextFile(HCkFileAccessW cHandle, const wchar_t *filePath, const wchar_t *charset,
                                 HCkString outStrFileContents);

CK_C_VISIBLE_PUBLIC const wchar_t *
CkFileAccessW_readEntireTextFile(HCkFileAccessW cHandle, const wchar_t *filePath, const wchar_t *charset);

CK_C_VISIBLE_PUBLIC int
CkFileAccessW_ReadNextFragment(HCkFileAccessW cHandle, BOOL startAtBeginning, const wchar_t *beginMarker,
                               const wchar_t *endMarker, const wchar_t *charset, HCkStringBuilderW sb);

CK_C_VISIBLE_PUBLIC BOOL
CkFileAccessW_ReassembleFile(HCkFileAccessW cHandle, const wchar_t *partsDirPath, const wchar_t *partPrefix,
                             const wchar_t *partExtension, const wchar_t *reassembledFilename);

CK_C_VISIBLE_PUBLIC int
CkFileAccessW_ReplaceStrings(HCkFileAccessW cHandle, const wchar_t *filePath, const wchar_t *charset,
                             const wchar_t *existingString, const wchar_t *replacementString);
...
CK_C_VISIBLE_PUBLIC BOOL
CkFileAccessW_SetFileTimes(HCkFileAccessW cHandle, const wchar_t *filePath, HCkDateTimeW createTime,
                           HCkDateTimeW lastAccessTime, HCkDateTimeW lastModTime);

CK_C_VISIBLE_PUBLIC BOOL
CkFileAccessW_SetLastModified(HCkFileAccessW cHandle, const wchar_t *filePath, HCkDateTimeW lastModified);

CK_C_VISIBLE_PUBLIC BOOL
CkFileAccessW_SplitFile(HCkFileAccessW cHandle, const wchar_t *fileToSplit, const wchar_t *partPrefix,
                        const wchar_t *partExtension, int partSize, const wchar_t *destDir);

CK_C_VISIBLE_PUBLIC BOOL
CkFileAccessW_SymlinkCreate(HCkFileAccessW cHandle, const wchar_t *targetPath, const wchar_t *linkPath);
...
CK_C_VISIBLE_PUBLIC BOOL
CkFileAccessW_WriteEntireFile(HCkFileAccessW cHandle, const wchar_t *filePath, HCkByteData fileData);

CK_C_VISIBLE_PUBLIC BOOL
CkFileAccessW_WriteEntireTextFile(HCkFileAccessW cHandle, const wchar_t *filePath, const wchar_t *textData,
                                  const wchar_t *charset, BOOL includedPreamble);
