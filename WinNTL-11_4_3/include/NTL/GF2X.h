...
// mainly for internal consumption by GF2XWatcher
    ...
    inline void clear(GF2X &x) { x.xrep.ZeroLength(); }
    ...
    inline long operator!=(const GF2X &a, const GF2X &b) { return !(a == b); }
...
// c[0..hi] = reverse(a[0..hi]), with zero fill as necessary
    ...
    inline void reverse(GF2X &c, const GF2X &a, long hi) { CopyReverse(c, a, hi); }
    ...
    inline void reverse(GF2X &c, const GF2X &a) { CopyReverse(c, a, deg(a)); }
    ...
    inline long InvModStatus(GF2X &c, const GF2X &a, const GF2XModulus &F) { return InvModStatus(c, a, F.f); }


    void PowerMod(GF2X &h, const GF2X &g, const ZZ &e, const GF2XModulus &F);

    inline void PowerMod(GF2X &x, const GF2X &g, long e, const GF2XModulus &F) { PowerMod(x, g, ZZ_expo(e), F); }

    void PowerXMod(GF2X &hh, const ZZ &e, const GF2XModulus &F);

    inline void PowerXMod(GF2X &x, long e, const GF2XModulus &F) { PowerXMod(x, ZZ_expo(e), F); }
    ...
    inline void conv(GF2X &x, const ZZ &a) { conv(x, to_GF2(a)); }
...
/* additional legacy conversions for v6 conversion regime */
    ...
    inline void conv(GF2X &x, const GF2X &a) { x = a; }
...
// undocumented stuff:
    ...
    inline void project(ref_GF2 x, const vec_GF2 &a, const GF2X &b) { x = to_GF2(InnerProduct(a.rep, b.xrep)); }

    inline GF2 project(const vec_GF2 &a, const GF2X &b) { return to_GF2(InnerProduct(a.rep, b.xrep)); }
    ...
    inline long NumBits(const GF2X &a) { return deg(a) + 1; }

    inline long NumBytes(const GF2X &a) { return (NumBits(a) + 7) / 8; }
