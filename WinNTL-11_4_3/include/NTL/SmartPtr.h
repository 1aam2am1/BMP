...
// usage: SmartPtr<T> p(r, ChoosePolicy<MyDeleterPolicy>());
    ...
    template<class T>
    NTL_DECLARE_RELOCATABLE((SmartPtr<T> * ))
...
**********************************************************************************/
    ...
    template<class T>
    NTL_DECLARE_RELOCATABLE((CloneablePtr<T> * ))
...
#define NTL_DEFINE_UNIQUE_MAKE(n) \
   ...
   {\
    ...
    NTL_DECLARE_RELOCATABLE((UniquePtr<T, P> * ))
...
#define NTL_DEFINE_COPIED_MAKE(n) \
   ...
   {\
    ...
    template<class T, class P>
    NTL_DECLARE_RELOCATABLE((CopiedPtr<T, P> * ))
...
\
   ...
   {\
    ...
    template<class T>
    NTL_DECLARE_RELOCATABLE((OptionalVal<T> * ))
...
**********************************************************************/
    ...
    template<class T>
    NTL_DECLARE_RELOCATABLE((UniqueArray<T> * ))
...
**********************************************************************/
    ...
    template<class T>
    NTL_DECLARE_RELOCATABLE((Unique2DArray<T> * ))
...
// way of doing this.
    ...
    public:
        ...
        AlignedArray &operator=(fake_null_type1) {
            reset();
            return *this;
        }
