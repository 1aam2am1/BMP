...
// x = derivative of a
    ...
    inline void reverse(zz_pEX &c, const zz_pEX &a) { reverse(c, a, deg(a)); }
    ...
    inline void VectorCopy(vec_zz_pE &x, const zz_pEX &a, long n) { VectorCopy(x, a.rep, n); }

    inline vec_zz_pE VectorCopy(const zz_pEX &a, long n) { return VectorCopy(a.rep, n); }
...
/* additional legacy conversions for v6 conversion regime */
    ...
    inline void conv(zz_pEX &x, const zz_pEX &a) { x = a; }

    inline void conv(vec_zz_pE &x, const zz_pEX &a) { x = a.rep; }
...
**************************************************************/
    ...
    inline long operator==(const zz_pEX &a, const zz_pEX &b) { return a.rep == b.rep; }
    ...
    inline long operator==(long a, const zz_pEX &b) { return (b == a); }

    inline long operator==(const zz_p &a, const zz_pEX &b) { return (b == a); }

    inline long operator==(const zz_pE &a, const zz_pEX &b) { return (b == a); }

    inline long operator!=(const zz_pEX &a, const zz_pEX &b) { return !(a == b); }

    inline long operator!=(const zz_pEX &a, long b) { return !(a == b); }

    inline long operator!=(const zz_pEX &a, const zz_p &b) { return !(a == b); }

    inline long operator!=(const zz_pEX &a, const zz_pE &b) { return !(a == b); }

    inline long operator!=(const long a, const zz_pEX &b) { return !(a == b); }

    inline long operator!=(const zz_p &a, const zz_pEX &b) { return !(a == b); }

    inline long operator!=(const zz_pE &a, const zz_pEX &b) { return !(a == b); }
...
// scalar versions
    ...
    inline void add(zz_pEX &x, const zz_pE &a, const zz_pEX &b) { add(x, b, a); }

    inline void add(zz_pEX &x, const zz_p &a, const zz_pEX &b) { add(x, b, a); }

    inline void add(zz_pEX &x, long a, const zz_pEX &b) { add(x, b, a); }
    ...
    inline zz_pEX &operator++(zz_pEX &x) {
        add(x, x, 1);
        return x;
    }
...
// x = a^2
    ...
    inline void mul(zz_pEX &x, long a, const zz_pEX &b) { mul(x, b, a); }

    inline void mul(zz_pEX &x, const zz_p &a, const zz_pEX &b) { mul(x, b, a); }

    inline void mul(zz_pEX &x, const zz_pE &a, const zz_pEX &b) { mul(x, b, a); }
...
// that speeds up the computation a great deal.
    ...
    inline void PowerMod(zz_pEX &h, const zz_pEX &g, long e,
                         const zz_pEXModulus &F) { PowerMod(h, g, ZZ_expo(e), F); }
    ...
    inline void PowerXMod(zz_pEX &h, long e, const zz_pEXModulus &F) { PowerXMod(h, ZZ_expo(e), F); }
...
// b = f(a)
    ...
    inline vec_zz_pE eval(const zz_pEX &f, const vec_zz_pE &a) {
        vec_zz_pE x;
        eval(x, f, a);
        NTL_OPT_RETURN(vec_zz_pE, x);
    }
//  b[i] = f(a[i])

    inline void eval(zz_pE &b, const zz_pX &f, const zz_pE &a) { conv(b, CompMod(f, rep(a), zz_pE::modulus())); }
...
// m must be > 0, otherwise an error is raised
    ...
    inline void project(zz_pE &x, const vec_zz_pE &a, const zz_pEX &b) { InnerProduct(x, a, b.rep); }
...
// prob min poly
    ...
    inline zz_pX ProbMinPolyTower(const zz_pEX &g, const zz_pEXModulus &F,
                                  long m) {
        zz_pX x;
        ProbMinPolyTower(x, g, F, m);
        NTL_OPT_RETURN(zz_pX, x);
    }

    inline void ProbMinPolyTower(zz_pX &h, const zz_pEX &g,
                                 const zz_pEXModulus &F) { ProbMinPolyTower(h, g, F, deg(F) * zz_pE::degree()); }

    inline zz_pX ProbMinPolyTower(const zz_pEX &g, const zz_pEXModulus &F) {
        zz_pX x;
        ProbMinPolyTower(x, g, F);
        NTL_OPT_RETURN(zz_pX, x);
    }
...
// min poly
    ...
    inline zz_pX MinPolyTower(const zz_pEX &g, const zz_pEXModulus &F,
                              long m) {
        zz_pX x;
        MinPolyTower(x, g, F, m);
        NTL_OPT_RETURN(zz_pX, x);
    }

    inline void MinPolyTower(zz_pX &h, const zz_pEX &g,
                             const zz_pEXModulus &F) { MinPolyTower(h, g, F, deg(F) * zz_pE::degree()); }
...
// irred poly
    ...
    inline zz_pX IrredPolyTower(const zz_pEX &g, const zz_pEXModulus &F,
                                long m) {
        zz_pX x;
        IrredPolyTower(x, g, F, m);
        NTL_OPT_RETURN(zz_pX, x);
    }

    inline void IrredPolyTower(zz_pX &h, const zz_pEX &g,
                               const zz_pEXModulus &F) { IrredPolyTower(h, g, F, deg(F) * zz_pE::degree()); }

    inline zz_pX IrredPolyTower(const zz_pEX &g, const zz_pEXModulus &F) {
        zz_pX x;
        IrredPolyTower(x, g, F);
        NTL_OPT_RETURN(zz_pX, x);
    }
