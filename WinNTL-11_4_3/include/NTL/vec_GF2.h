...
//the following are "really" public
        ...
        ref_GF2 operator()(long i) { return (*this)[i - 1]; }

        const GF2 operator()(long i) const { return (*this)[i - 1]; }
...
// will unfortunately allow elements of vec to be modified 
        ...
        struct proxy_iterator_impl {
            ...
            bool eq(const proxy_iterator_impl &other) const { return ptr == other.ptr && idx == other.idx; }
        ...
        struct const_proxy_iterator {
            ...
            const_proxy_iterator &operator+=(long x) {
                rep.add(x);
                return *this;
            }
        ...
        struct proxy_iterator {
            ...
            proxy_iterator &operator+=(long x) {
                rep.add(x);
                return *this;
            }
    ...
    vec_GF2::const_proxy_iterator operator+(const vec_GF2::const_proxy_iterator &a, long x) {
        vec_GF2::const_proxy_iterator t = a;
        t.rep.add(x);
        return t;
    }

    inline
    vec_GF2::const_proxy_iterator operator+(long x, const vec_GF2::const_proxy_iterator &a) { return a + x; }
    ...
    inline
    bool operator==(const vec_GF2::proxy_iterator &a, const vec_GF2::proxy_iterator &b) { return a.rep.eq(b.rep); }

    inline
    bool operator!=(const vec_GF2::proxy_iterator &a, const vec_GF2::proxy_iterator &b) { return !(a == b); }

    inline
    vec_GF2::proxy_iterator operator+(const vec_GF2::proxy_iterator &a, long x) {
        vec_GF2::proxy_iterator t = a;
        t.rep.add(x);
        return t;
    }

    inline
    vec_GF2::proxy_iterator operator+(long x, const vec_GF2::proxy_iterator &a) { return a + x; }
    ...
    inline
    long operator-(const vec_GF2::proxy_iterator &a, const vec_GF2::proxy_iterator &b) { return a.rep.diff(b.rep); }


// sepcialized conversion
    inline void conv(vec_GF2 &x, const vec_GF2 &a) { x = a; }
    ...
    inline long operator!=(const vec_GF2 &a, const vec_GF2 &b) { return !(a == b); }
...
//    and x[i] = 0 for all other i such that 0 <= i < l.
    ...
    inline void mul(vec_GF2 &x, GF2 a, const vec_GF2 &b) { mul(x, b, a); }

    inline void mul(vec_GF2 &x, const vec_GF2 &a, long b) { mul(x, a, to_GF2(b)); }

    inline void mul(vec_GF2 &x, long a, const vec_GF2 &b) { mul(x, b, a); }

    void add(vec_GF2 &x, const vec_GF2 &a, const vec_GF2 &b);

    inline void sub(vec_GF2 &x, const vec_GF2 &a, const vec_GF2 &b) { add(x, a, b); }

    void clear(vec_GF2 &x);

    inline void negate(vec_GF2 &x, const vec_GF2 &a) { x = a; }

    inline void InnerProduct(ref_GF2 x, const vec_GF2 &a, const vec_GF2 &b) { x = to_GF2(InnerProduct(a.rep, b.rep)); }
    ...
    inline vec_GF2 operator-(const vec_GF2 &a) { return a; }
    ...
    inline GF2 operator*(const vec_GF2 &a, const vec_GF2 &b) { return to_GF2(InnerProduct(a.rep, b.rep)); }
