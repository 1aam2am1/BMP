...
// x = a^2 % X^n
    ...
    inline void reverse(ZZX &c, const ZZX &a) { reverse(c, a, deg(a)); }
    ...
    inline void VectorCopy(vec_ZZ &x, const ZZX &a, long n) { VectorCopy(x, a.rep, n); }

    inline vec_ZZ VectorCopy(const ZZX &a, long n) { return VectorCopy(a.rep, n); }
...
/* additional legacy conversions for v6 conversion regime */
    ...
    inline void conv(ZZX &x, const ZZX &a) { x = a; }

    inline void conv(vec_ZZ &x, const ZZX &a) { x = a.rep; }
...
// current implementation always defaults to "plain"
    ...
    inline void PseudoDiv(ZZX &q, const ZZX &a, const ZZX &b) { PlainPseudoDiv(q, a, b); }

    inline void PseudoRem(ZZX &r, const ZZX &a, const ZZX &b) { PlainPseudoRem(r, a, b); }
...
//    that errs with probability no more than 2^{-80}.
    ...
    inline ZZ discriminant(const ZZX &a, long deterministic = 0) {
        ZZ x;
        discriminant(x, a, deterministic);
        NTL_OPT_RETURN(ZZ, x);
    }
// d = discriminant of a
...
//    that errs with probability no more than 2^{-80}.
    ...
    inline ZZX CharPolyMod(const ZZX &a, const ZZX &f, long deterministic = 0) {
        ZZX x;
        CharPolyMod(x, a, f, deterministic);
        NTL_OPT_RETURN(ZZX, x);
    }
