...
// x = derivative of a
    ...
    inline void reverse(GF2EX &c, const GF2EX &a) { reverse(c, a, deg(a)); }
    ...
    inline void VectorCopy(vec_GF2E &x, const GF2EX &a, long n) { VectorCopy(x, a.rep, n); }

    inline vec_GF2E VectorCopy(const GF2EX &a, long n) { return VectorCopy(a.rep, n); }
...
********************************************************************/
    ...
    inline GF2EX &GF2EX::operator=(const GF2E &a) {
        conv(*this, a);
        return *this;
    }

    inline GF2EX &GF2EX::operator=(GF2 a) {
        conv(*this, a);
        return *this;
    }

    inline GF2EX &GF2EX::operator=(long a) {
        conv(*this, a);
        return *this;
    }
...
/* additional legacy conversions for v6 conversion regime */
    ...
    inline void conv(GF2EX &x, const GF2EX &a) { x = a; }

    inline void conv(vec_GF2E &x, const GF2EX &a) { x = a.rep; }
...
**************************************************************/
    ...
    inline long operator==(const GF2EX &a, const GF2EX &b) { return a.rep == b.rep; }
...
// that speeds up the computation a great deal.
    ...
    inline void PowerMod(GF2EX &h, const GF2EX &g, long e, const GF2EXModulus &F) { PowerMod(h, g, ZZ_expo(e), F); }
    ...
    inline void PowerXMod(GF2EX &h, long e, const GF2EXModulus &F) { PowerXMod(h, ZZ_expo(e), F); }
...
// b = f(a)
    ...
    inline vec_GF2E eval(const GF2EX &f, const vec_GF2E &a) {
        vec_GF2E x;
        eval(x, f, a);
        NTL_OPT_RETURN(vec_GF2E, x);
    }
//  b[i] = f(a[i])

    inline void eval(GF2E &b, const GF2X &f, const GF2E &a) { conv(b, CompMod(f, rep(a), GF2E::modulus())); }
...
// m must be > 0, otherwise an error is raised
    ...
    inline void project(GF2E &x, const vec_GF2E &a, const GF2EX &b) { InnerProduct(x, a, b.rep); }
...
// prob min poly
    ...
    inline GF2X ProbMinPolyTower(const GF2EX &g, const GF2EXModulus &F,
        ...
        NTL_OPT_RETURN(GF2X, x);
    }

    inline void ProbMinPolyTower(GF2X &h, const GF2EX &g,
                                 const GF2EXModulus &F) { ProbMinPolyTower(h, g, F, deg(F) * GF2E::degree()); }
...
// min poly
    ...
    inline void MinPolyTower(GF2X &h, const GF2EX &g,
                             const GF2EXModulus &F) { MinPolyTower(h, g, F, deg(F) * GF2E::degree()); }
...
// irred poly
    ...
    inline void IrredPolyTower(GF2X &h, const GF2EX &g,
                               const GF2EXModulus &F) { IrredPolyTower(h, g, F, deg(F) * GF2E::degree()); }
