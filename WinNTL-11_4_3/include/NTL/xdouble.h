...
#define NTL_XD_BOUND_INV (double(1)/NTL_XD_BOUND)
    ...
    inline xdouble operator+(const xdouble &a, double b) { return a + to_xdouble(b); }

    inline xdouble operator+(double a, const xdouble &b) { return to_xdouble(a) + b; }
    ...
    inline xdouble &operator++(xdouble &a) {
        a = a + to_xdouble(1);
        return a;
    }
    ...
    inline long compare(const xdouble &a, double b) { return compare(a, to_xdouble(b)); }

    inline long compare(double a, const xdouble &b) { return compare(to_xdouble(a), b); }

    long sign(const xdouble &a);

    inline long operator==(const xdouble &a, const xdouble &b) { return compare(a, b) == 0; }
    ...
    inline long operator==(const xdouble &a, double b) { return compare(a, b) == 0; }
    ...
    inline long operator==(double a, const xdouble &b) { return compare(a, b) == 0; }
...
// x = floor(a);
    ...
    inline void conv(xdouble &z, const ZZ &a) { z = to_xdouble(a); }
    ...
    inline void conv(xdouble &x, const xdouble &a) { x = a; }

    inline xdouble to_xdouble(const xdouble &a) { return a; }
