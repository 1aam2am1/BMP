...
NTL_OPEN_NNS
    ...
    inline void sub(mat_GF2E &X, const mat_GF2E &A, const mat_GF2E &B) { add(X, A, B); }

    inline void negate(mat_GF2E &X, const mat_GF2E &A) { X = A; }
    ...
    inline void mul(mat_GF2E &X, const GF2E &a, const mat_GF2E &B) { mul(X, B, a); }

    void mul(mat_GF2E &X, const mat_GF2E &A, GF2 b);

    inline void mul(mat_GF2E &X, GF2 a, const mat_GF2E &B) { mul(X, B, a); }

    inline void mul(mat_GF2E &X, const mat_GF2E &A, long b) { mul(X, A, to_GF2(b)); }

    inline void mul(mat_GF2E &X, long a, const mat_GF2E &B) { mul(X, B, a); }
    ...
    inline void sqr(mat_GF2E &X, const mat_GF2E &A) { mul(X, A, A); }
    ...
    inline void power(mat_GF2E &X, const mat_GF2E &A, long e) { power(X, A, ZZ_expo(e)); }
