...
// routines with a precision parameter
    ...
    inline RR InputPrec(NTL_SNS istream &s, long p) {
        RR z;
        NTL_INPUT_CHECK_ERR(InputPrec(z, s, p));
        NTL_OPT_RETURN(RR, z);
    }
    ...
    inline RR::RR(INIT_VAL_TYPE, int a) {
        e = 0;
        conv(*this, a);
    }

    inline RR::RR(INIT_VAL_TYPE, long a) {
        e = 0;
        conv(*this, a);
    }

    inline RR::RR(INIT_VAL_TYPE, unsigned int a) {
        e = 0;
        conv(*this, a);
    }

    inline RR::RR(INIT_VAL_TYPE, unsigned long a) {
        e = 0;
        conv(*this, a);
    }

    inline RR::RR(INIT_VAL_TYPE, float a) {
        e = 0;
        conv(*this, a);
    }

    inline RR::RR(INIT_VAL_TYPE, double a) {
        e = 0;
        conv(*this, a);
    }

    inline RR::RR(INIT_VAL_TYPE, const RR &a) {
        e = 0;
        conv(*this, a);
    }

    inline RR::RR(INIT_VAL_TYPE, const ZZ &a) {
        e = 0;
        conv(*this, a);
    }

    inline RR::RR(INIT_VAL_TYPE, const xdouble &a) {
        e = 0;
        conv(*this, a);
    }

    inline RR::RR(INIT_VAL_TYPE, const quad_float &a) {
        e = 0;
        conv(*this, a);
    }

    inline RR::RR(INIT_VAL_TYPE, const char *a) {
        e = 0;
        conv(*this, a);
    }
    ...
    inline RR &RR::operator=(double a) {
        conv(*this, a);
        return *this;
    }
    ...
    inline int to_int(const RR &a) {
        int z;
        conv(z, a);
        return z;
    }

    inline long to_long(const RR &a) {
        long z;
        conv(z, a);
        return z;
    }

    inline float to_float(const RR &a) {
        float z;
        conv(z, a);
        return z;
    }

    inline double to_double(const RR &a) {
        double z;
        conv(z, a);
        return z;
    }
