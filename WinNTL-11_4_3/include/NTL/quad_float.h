...
// should remove it
    ...
    inline quad_float to_quad_float(float x) { return to_quad_float(double(x)); }

    inline quad_float &quad_float::operator=(double x) {
        *this = to_quad_float(x);
        return *this;
    }


    inline quad_float &operator+=(quad_float &x, const quad_float &y) {
        quad_float_in_place_add(x, y);
        return x;
    }

    inline quad_float &operator-=(quad_float &x, const quad_float &y) {
        quad_float_in_place_sub(x, y);
        return x;
    }

    inline quad_float &operator*=(quad_float &x, const quad_float &y) {
        quad_float_in_place_mul(x, y);
        return x;
    }

    inline quad_float &operator/=(quad_float &x, const quad_float &y) {
        quad_float_in_place_div(x, y);
        return x;
    }

    inline quad_float operator-(const quad_float &x) {
        quad_float xx = x;
        quad_float_in_place_negate(xx);
        return xx;
    }
    ...
    inline quad_float operator+(const quad_float &x, double y) { return x + to_quad_float(y); }

    inline quad_float operator+(double x, const quad_float &y) { return to_quad_float(x) + y; }
    ...
    inline quad_float &operator++(quad_float &a) {
        a += 1.0;
        return a;
    }
    ...
    inline long operator>(const quad_float &x, double y) { return x > to_quad_float(y); }

    inline long operator>(double x, const quad_float &y) { return to_quad_float(x) > y; }
    ...
    inline long compare(const quad_float &x, double y) { return compare(x, to_quad_float(y)); }

    inline long compare(double x, const quad_float &y) { return compare(to_quad_float(x), y); }
    ...
    inline void conv(quad_float &x, const quad_float &a) { x = a; }

    inline quad_float to_quad_float(const quad_float &a) { return a; }
