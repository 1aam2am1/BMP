...
************************************************************/
    ...
    inline vec_pair_GF2EX_long SquareFreeDecomp(const GF2EX &f) {
        vec_pair_GF2EX_long x;
        SquareFreeDecomp(x, f);
        return x;
    }
