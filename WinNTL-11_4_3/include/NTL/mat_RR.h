...
NTL_OPEN_NNS
    ...
    inline void mul(mat_RR &X, const RR &a, const mat_RR &B) { mul(X, B, a); }

    inline void mul(mat_RR &X, double a, const mat_RR &B) { mul(X, B, a); }
    ...
    inline void sqr(mat_RR &X, const mat_RR &A) { mul(X, A, A); }
    ...
    inline void power(mat_RR &X, const mat_RR &A, long e) { power(X, A, ZZ_expo(e)); }
