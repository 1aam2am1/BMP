...
NTL_OPEN_NNS
    ...
    inline void mul(mat_ZZ_pE &X, const ZZ_pE &a, const mat_ZZ_pE &B) { mul(X, B, a); }

    inline void mul(mat_ZZ_pE &X, const ZZ_p &a, const mat_ZZ_pE &B) { mul(X, B, a); }

    inline void mul(mat_ZZ_pE &X, long a, const mat_ZZ_pE &B) { mul(X, B, a); }
    ...
    inline void sqr(mat_ZZ_pE &X, const mat_ZZ_pE &A) { mul(X, A, A); }
    ...
    inline void power(mat_ZZ_pE &X, const mat_ZZ_pE &A, long e) { power(X, A, ZZ_expo(e)); }
