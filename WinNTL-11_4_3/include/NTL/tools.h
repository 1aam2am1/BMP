...
#define NTL_OPT_RETURN(t, x) return t(x, INIT_TRANS)
    ...
    inline unsigned int max(unsigned int a, unsigned int b) { return (a < b) ? b : a; }

    inline unsigned long min(unsigned long a, unsigned long b) { return (a < b) ? a : b; }

    inline unsigned long max(unsigned long a, unsigned long b) { return (a < b) ? b : a; }

    inline unsigned long min(unsigned int a, unsigned long b) { return (a < b) ? (unsigned long) (a) : b; }

    inline unsigned long max(unsigned int a, unsigned long b) { return (a < b) ? b : (unsigned long) (a); }

    inline unsigned long min(unsigned long a, unsigned int b) { return (a < b) ? a : (unsigned long) (b); }

    inline unsigned long max(unsigned long a, unsigned int b) { return (a < b) ? (unsigned long) (b) : a; }
...
// This is really an academic exercise...
    ...
    inline void conv(int &x, unsigned a) { x = cast_signed(a); }
    ...
    inline int to_int(unsigned a) { return cast_signed(a); }
    ...
    inline void conv(long &x, unsigned long a) { x = cast_signed(a); }
    ...
    inline long to_long(unsigned long a) { return cast_signed(a); }
